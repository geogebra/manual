...
*Example:* The input `y = 2 x + 3` gives you the linear equation in the image:16px-Menu_view_algebra.svg.png[Menu view
...
*Example:* Create two points _A_ and _B_, whose coordinates are displayed in the
image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] _Algebra View_. Select the
image:16px-Mode_join.svg.png[Mode join.svg,width=16,height=16] _xref:/tools/Line_Tool.adoc[Line Tool]_ from the
_Graphics View Toolbar_ and click on both points in the image:16px-Menu_view_algebra.svg.png[Menu view
algebra.svg,width=16,height=16] _Algebra View_ in order to create a line through points _A_ and _B_.
