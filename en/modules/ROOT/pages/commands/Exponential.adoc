...
Exponential( <Lambda>, x, <Boolean Cumulative> )::
  If _Cumulative = true_, creates the cumulative density function (cdf) of an Exponential distribution with given _lambda_, otherwise it creates the probability density function (pdf) of the distribution.
