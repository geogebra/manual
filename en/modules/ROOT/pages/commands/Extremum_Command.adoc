...
`Extremum((x⁴ - 3x³ - 4x² + 4) / 2, 0, 5)` creates local extremum _(2.93, -16.05)_ in the given interval and shows it in
...
3}\{3}, \frac\{10 \; \sqrt\{15} + 45}\{9} \right), \left(\frac\{\sqrt\{15} - 3}\{3}, \frac\{-10 \; \sqrt\{15} + 45}\{9}
\right) \right\}]_.
