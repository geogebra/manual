...
AttachCopyToView( <Object>, <View 0|1|2> )::
  ...
  of given object whose size in given image:16px-Menu_view_graphics.svg.png[Menu view
...
given object whose size in given image:16px-Menu_view_graphics.svg.png[Menu view
