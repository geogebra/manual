...
BinomialDist( <Number of Trials>, <Probability of Success> )::
  Returns a histogram of a https://en.wikipedia.org/wiki/Binomial_distribution[Binomial distribution].
...
BinomialDist( <Number of Trials>, <Probability of Success>, <Boolean Cumulative> )::
  Returns a histogram of a Binomial distribution when _Cumulative_ = false.
...
becomes corrupted is stem:[\frac{1}{10}], hence the probability of transferring an arbitrary packet successfully is
stem:[\frac{9}{10}].
