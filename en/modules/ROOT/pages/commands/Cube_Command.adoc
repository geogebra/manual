...
*Note:* See also xref:/commands/Tetrahedron_Command.adoc[Tetrahedron],
xref:/commands/Octahedron_Command.adoc[Octahedron], xref:/commands/Icosahedron_Command.adoc[Icosahedron],
xref:/commands/Dodecahedron_Command.adoc[Dodecahedron] commands.
