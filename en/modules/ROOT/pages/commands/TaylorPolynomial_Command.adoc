...
*Example:* `TaylorPolynomial(x^2, 3, 1)` gives _9 + 6 (x - 3)_, the power series expansion of _x^2^_ at _x = 3_ to order
_1_.
...
*Example:* `TaylorPolynomial(x^2, a, 1)` gives _a^2^ + 2a (x - a)_, the power series expansion of _x^2^_ at _x = a_ to
order _1_.
