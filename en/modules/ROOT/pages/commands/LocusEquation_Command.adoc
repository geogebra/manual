...
`LocusEquation(AreCollinear(A, B, C), A)` for free points _A_, _B_, _C_ calculates the set of positions of _A_ that make
_A_, _B_ and _C_ collinear—i.e. a line through _B_ and C__.__
