...
2.1) using the image:20px-Mode_move.svg.png[Mode move.svg,width=20,height=20]xref:/tools/Move_Tool.adoc[Move Tool],
point _A_ becomes (1.3, 2.1) and _B_ appears at (1,2).
