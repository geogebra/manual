...
xref:/tools/Show___Hide_Object_Tool.adoc[Show_/_Hide Object Tool] to show or hide objects.
...
_Algebra View_, make it xref:/Free,_Dependent_and_Auxiliary_Objects.adoc[Auxiliary].
