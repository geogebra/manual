...
*Note:* When you select the tooltip in the
...
*Note:* You can restore the default _Toolbar_ using the button Restore Default Toolbar in the right lower corner of the
dialog window.
