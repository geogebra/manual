...
*Example:* Let A be a point and (1,2) be its coordinates. Setting the caption to "Point %n has coordinates %v" results
in caption "Point A has coordinates (1,2)"
...
*Example:* If you want to display a nicely formatted math text, use LaTeX in captions, e.g. to display a fraction like
