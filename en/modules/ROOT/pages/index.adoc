= GeoGebra Manual
:description: Explore the GeoGebra Online Manual and Reference Guide. Easily navigate to detailed help pages for every GeoGebra command and tool, providing step-by-step instructions and examples for enhancing your math learning and teaching experience
:page-en: index
