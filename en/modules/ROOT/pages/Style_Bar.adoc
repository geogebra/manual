...
xref:/GeoGebra_5_0_Desktop_vs_Web_and_Tablet_App.adoc[GeoGebra Web and Tablet App], depending on the _View_ you select,
...
=== image:24px-Stylingbar_icon_graphics.svg.png[Stylingbar icon graphics.svg,width=24,height=17] Graphics View Style Bar
...
=== image:24px-Stylingbar_icon_graphics3D.svg.png[Stylingbar icon graphics3D.svg,width=24,height=17] 3D Graphics View Style Bar
...
=== image:24px-Stylingbar_icon_cas.svg.png[Stylingbar icon cas.svg,width=24,height=17] CAS View Style Bar
...
=== image:24px-Stylingbar_icon_spreadsheet.svg.png[Stylingbar icon spreadsheet.svg,width=24,height=17] Spreadsheet View Style Bar
