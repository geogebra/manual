...
*Note:* You may specify the position of a text as absolute on screen or relative to the coordinate system on tab _Basic_
of the image:18px-Menu-options.svg.png[Menu-options.svg,width=18,height=18] xref:/Properties_Dialog.adoc[Properties
Dialog].
