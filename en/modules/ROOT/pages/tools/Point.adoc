...
mouse button is released or the finger is lifted in the tablet app.

[NOTE]
====

* By clicking (or tapping in the tablet app) on a segment (or interval), straight line, polygon, conic section, function, or curve you can create a
