...
Drag and drop xref:/Free,_Dependent_and_Auxiliary_Objects.adoc[Free Objects].
...
xref:/Free,_Dependent_and_Auxiliary_Objects.adoc[free points]. In order to move a point in the three-dimensional
