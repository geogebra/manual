...
_Tools_. You will find _Tools_ that create different types of points in the _xref:/tools/Point_Tools.adoc[Points Toolbox]_
...
Via Keyboard Shortcut [.kcode]#Ctrl# + [.kcode]#C# and [.kcode]#Ctrl# + [.kcode]#V# (Mac OS:[.kcode]#Ctrl# + [.kcode]#C#
