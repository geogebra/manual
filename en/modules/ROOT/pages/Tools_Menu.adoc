...
== image:24px-Menu-tools-new.svg.png[Menu-tools-new.svg,width=24,height=24] Create New Tool
...
== image:24px-Menu-tools.svg.png[Menu-tools.svg,width=24,height=24] Manage Tools
...
== image:24px-Menu-tools-customize.svg.png[Menu-tools-customize.svg,width=24,height=24] Customize Toolbar
