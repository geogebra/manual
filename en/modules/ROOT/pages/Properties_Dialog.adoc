...
* Select the image:20px-Mode_move.svg.png[Mode move.svg,width=20,height=20]xref:/tools/Move.adoc[Move Tool] and double
click on an object in the image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]
