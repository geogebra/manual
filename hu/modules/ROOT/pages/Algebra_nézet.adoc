...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Szabad alakzatra_] az
...
Ha kétszer kattintunk egy xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Függő
...
xref:/Redefine_Dialog.adoc[Újradefiniálhatjuk] az alakzatot.
...
gépes változatánál a xref:/Algebra_View.adoc[_Formázóléc_ opció]
...
=== xref:/Style_Bar.adoc[Algebra nézet formázóléce]
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Auxiliary Objects_]
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Auxiliary Object_]. Open the
tab _Basic_ of the image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16]
xref:/Properties_Dialog.adoc[Properties Dialog] and check _Auxiliary Object_.
...
_xref:/Context_Menu.adoc[Context Menu]_ (right-click or Mac OS
[.kcode]#Ctrl#-click), or by selecting on the appropriate icon in the
xref:/Algebra_View.adoc[_Algebra View Style Bar_].
