...
xref:/GeoGebra_Desktop_vs_Web_and_Tablet_App.adoc[testre szabhatjuk] a GeoGebra
...
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Szabad alakzatra_] az
...
_xref:/Geometria_ablakban.adoc[Geometria ablakban]_ átveszik a változásokat.

Ha kétszer kattintunk egy xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Függő
...
xref:/Újradefiniálás_párdbeszédablak.adoc[Újradefiniálhatjuk] az alakzatot.

== Matematikai alakzatok megjelenítése
...
gépes változatánál a xref:/Algebra_nézet.adoc[_Formázóléc_ opció]
...
=== xref:/Formázóléc.adoc[Algebra nézet formázóléce]

The xref:/Formázóléc.adoc[_Algebra View Style Bar_] provides buttons to
...
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Auxiliary Objects_]
...
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Auxiliary Object_]. Open the
tab _Basic_ of the image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16]
xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog] and check _Auxiliary Object_.
...
_xref:/Helyi_menü.adoc[Context Menu]_ (right-click or Mac OS
[.kcode]#Ctrl#-click), or by selecting on the appropriate icon in the
xref:/Algebra_nézet.adoc[_Algebra View Style Bar_].
