...
*Jegyzet:* See also xref:/Payment_Command.adoc[Payment],
xref:/Rate_Command.adoc[Rate],
xref:/PresentValue_Command.adoc[Present Value] and
xref:/FutureValue_Command.adoc[Future Value] commands.
