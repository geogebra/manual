...
*Jegyzet:* See also xref:/commands/TörlesztőRészlet.adoc[Payment],
xref:/commands/Kamatráta.adoc[Rate],
xref:/commands/JelenÉrték.adoc[Present Value] and
xref:/commands/JövőbeliÉrték.adoc[Future Value] commands.
