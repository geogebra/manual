...
View,title="Algebra View",width=16,height=16] _xref:/Algebra_nézet.adoc[Algebra
View]_. In addition, either the _xref:/Parancssor.adoc[Input Bar]_ is displayed
at the bottom of the GeoGebra window (GeoGebra Desktop), or an
_xref:/Input_Field.adoc[Input Field]_ is integrated directly in the
image:16px-Menu_view_algebra.svg.png[Algebra View,title="Algebra View",width=16,height=16]
_xref:/Algebra_nézet.adoc[Algebra View]_ (GeoGebra Web and Tablet Apps). The
xref:/3D_Graphics_Tools.adoc[_3D Graphics View Toolbar_] is displayed at the top
...
3Dgraphics.svg,width=16,height=16] xref:/Munkaasztalok.adoc[_3D Graphics
...
basic setup can be changed using the xref:/Formázóléc.adoc[_3D Graphics View
Style Bar_] (e.g. display of coordinate axes, _xOy_-plane, grid). In addition, the
_xref:/Preferences_Dialog.adoc[Preferences Dialog]_ provides more options to
...
xref:/GeoGebra_5_0_asztali_gépes_kontra_webes_és_tablet_alkalmazás.adoc[change the layout] of
...
Using the xref:/3D_Graphics_Tools.adoc[construction _Tools_] available in the
xref:/3D_s_grafika_nézet.adoc[_3D Graphics View Toolbar_] you can create geometric
...
xref:/3D_Graphics_Tools.adoc[_Tool_].
...
image:16px-Menu_view_algebra.svg.png[Algebra View,title="Algebra View",width=16,height=16]
_xref:/Algebra_nézet.adoc[Algebra View]_.
...
_xref:/tools/Gömb_középponttal_és_felszíni_pontjával.adoc[Sphere with Center through
...
The xref:/3D_Graphics_Tools.adoc[_3D Graphics View Toolbar_] provides a wide
range of _xref:/Eszközök.adoc[Tools]_ that can be operated with the mouse and allow
...
View_. Every icon in the _xref:/Eszköztár.adoc[Toolbar]_ represents a
xref:/Eszközök.adoc[_Toolbox_] that contains a selection of related
xref:/Eszközök.adoc[construction _Tools_]. In order to open a _Toolbox_, you need
...
_xref:/3D_Graphics_Tools.adoc[Planes Toolbox]_ or _Tools_ that allow you to
create geometric solids in the image:16px-Mode_pyramid.svg.png[Mode pyramid.svg,width=16,height=16]
xref:/3D_Graphics_Tools.adoc[Geometric Solids Toolbox].
...
coordinate system. You may either use the _xref:/Eszközök.adoc[Tools]_ provided in
the xref:/3D_s_grafika_nézet.adoc[_3D Graphics View Toolbar_], or directly enter
the algebraic representation of these objects in the _xref:/Parancssor.adoc[Input
Bar]_ or xref:/Parancssor.adoc[_Input Field_] of the
image:16px-Menu_view_algebra.svg.png[Algebra View,title="Algebra View",width=16,height=16]
_xref:/Algebra_nézet.adoc[Algebra View]_ (GeoGebra Web and Tablet Apps).
...
In addition to the wide range of xref:/Kategória__Commands.adoc[_Commands_] available
for the other _xref:/Nézetek.adoc[Views]_ of GeoGebra, there also is a selection
...
_xref:/tools/Mozgatás.adoc[Move Tool]_ you may drag and drop
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Free Points_] in the
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _3D Graphics
...
translateview.svg,width=16,height=16] _xref:/tools/Rajzlap_mozgatása.adoc[Move
...
_Back to Default View_ in the xref:/Formázóléc.adoc[_3D Graphics View Style
Bar_].
...
_xref:/tools/3D_s_nézet_forgatása.adoc[Rotate 3D Graphics View Tool]_ and
...
xref:/Formázóléc.adoc[_3D Graphics View Style Bar_].
...
_xref:/tools/Nézet_szemből.adoc[View in front of Tool]_ in order to view the
...
_xref:/tools/Nagyítás.adoc[Zoom In Tool]_ and image:16px-Mode_zoomout.svg.png[Mode
zoomout.svg,width=16,height=16] _xref:/tools/Kicsinyítés.adoc[Zoom Out Tool]_ in
order to zoom in the image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra
3Dgraphics.svg,width=16,height=16] _3D Graphics View_.
xref:/Sablon__Hint.adoc[Sablon:Hint]

=== 3D-s grafika nézet formázóléce

The xref:/Formázóléc.adoc[_3D Graphics View Style Bar_] contains buttons to
...
capturing.svg,width=16,height=16] _xref:/Point_Capturing.adoc[Point Capturing]_
settings
* image:16px-Stylingbar_graphics3D_rotateview_play.svg.png[Stylingbar graphics3D rotateview play.svg,width=16,height=16]
...
_xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog]_ (GeoGebra Web and Tablet Apps)
* display additional image:16px-Stylingbar_dots.svg.png[Stylingbar dots.svg,width=16,height=16]
_xref:/Nézetek.adoc[Views]_ in the GeoGebra window (GeoGebra Web and Tablet Apps)

=== Eszközök és alakzatok formázóléce

Depending on the xref:/Eszközök.adoc[_Tool_] or object you select, the buttons in
the _xref:/Formázóléc.adoc[Style Bar]_ adapt to your selection. Please see
xref:/Formázóléc.adoc[Style Bar Options for Tools and Objects] for more
information.
