...
View,title="Algebra View",width=16,height=16] _xref:/Algebra_View.adoc[Algebra
View]_. In addition, either the _xref:/Input_Bar.adoc[Input Bar]_ is displayed
...
_xref:/Algebra_View.adoc[Algebra View]_ (GeoGebra Web and Tablet Apps). The
...
3Dgraphics.svg,width=16,height=16] xref:/Perspectives.adoc[_3D Graphics
...
xref:/Perspectives.adoc[_Perspective_] at any time by using the
image:16px-Menu-view.svg.png[Menu-view.svg,width=16,height=16]
_xref:/View_Menu.adoc[View Menu]_ or the
...
basic setup can be changed using the xref:/Style_Bar.adoc[_3D Graphics View
...
xref:/GeoGebra_5_0_Desktop_vs_Web_and_Tablet_App.adoc[change the layout] of
...
xref:/3D_Graphics_View.adoc[_3D Graphics View Toolbar_] you can create geometric
...
_xref:/Sphere_with_Center_through_Point_Tool.adoc[Sphere with Center through
...
range of _xref:/Tools.adoc[Tools]_ that can be operated with the mouse and allow
...
View_. Every icon in the _xref:/Toolbar.adoc[Toolbar]_ represents a
xref:/Tools.adoc[_Toolbox_] that contains a selection of related
xref:/Tools.adoc[construction _Tools_]. In order to open a _Toolbox_, you need
...
coordinate system. You may either use the _xref:/Tools.adoc[Tools]_ provided in
the xref:/3D_Graphics_View.adoc[_3D Graphics View Toolbar_], or directly enter
the algebraic representation of these objects in the _xref:/Input_Bar.adoc[Input
Bar]_ or xref:/Input_Bar.adoc[_Input Field_] of the
image:16px-Menu_view_algebra.svg.png[Algebra View,title="Algebra View",width=16,height=16]
...
for the other _xref:/Views.adoc[Views]_ of GeoGebra, there also is a selection
...
_xref:/Move_Tool.adoc[Move Tool]_ you may drag and drop
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Free Points_] in the
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _3D Graphics
...
translateview.svg,width=16,height=16] _xref:/Move_Graphics_View_Tool.adoc[Move
...
_Back to Default View_ in the xref:/Style_Bar.adoc[_3D Graphics View Style
Bar_].
...
_xref:/Rotate_3D_Graphics_View_Tool.adoc[Rotate 3D Graphics View Tool]_ and
...
xref:/Style_Bar.adoc[_3D Graphics View Style Bar_].
...
_xref:/View_in_front_of_Tool.adoc[View in front of Tool]_ in order to view the
...
_xref:/Zoom_In_Tool.adoc[Zoom In Tool]_ and image:16px-Mode_zoomout.svg.png[Mode
zoomout.svg,width=16,height=16] _xref:/Zoom_Out_Tool.adoc[Zoom Out Tool]_ in
...
_xref:/Properties_Dialog.adoc[Properties Dialog]_ (GeoGebra Web and Tablet Apps)
...
Depending on the xref:/Tools.adoc[_Tool_] or object you select, the buttons in
the _xref:/Style_Bar.adoc[Style Bar]_ adapt to your selection. Please see
xref:/Style_Bar.adoc[Style Bar Options for Tools and Objects] for more
information.
