...
xref:/Views.adoc[_View_] in GeoGebra Desktop, or click the _Style Bar Button_ in
the GeoGebra Web and Tablet Apps. Please note that there are still more properties you can change using the
xref:/Properties_Dialog.adoc[_Properties Dialog_].
...
_xref:/Properties_Dialog.adoc[Properties Dialog]_ for the _Graphics View_ or a
...
* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] *Open the Properties Dialog*: Open the
_xref:/Properties_Dialog.adoc[Properties Dialog]_ for the _3D Graphics View_ or
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Auxiliary Objects_] in the
_Algebra View_.
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Free Objects_] and
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[_Dependent Objects_]. If you
...
_xref:/Input_Bar.adoc[Input Bar]_ at the top of the _Spreadsheet View_ (GeoGebra
Desktop).
...
Depending on the xref:/Tools.adoc[_Tool_] or existing object you select, the
_Style Bar_ offers a selection of buttons to change the following properties of either the selected object(s) or the
object(s) you are about to create using the selected xref:/Tools.adoc[_Tool_]:
...
xref:/Labels_and_Captions.adoc[caption] that differs from the name or value of
...
xref:/Move_Graphics_View_Tool.adoc[moving the _(3D) Graphics View_] or zooming
(GeoGebra Desktop).
* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] *Properties Dialog*: Open the
_xref:/Properties_Dialog.adoc[Properties Dialog]_ (GeoGebra Web and Tablet Apps)
* image:16px-Stylingbar_dots.svg.png[Stylingbar dots.svg,width=16,height=16] *Display Views*: You may display additional
