...
xref:/Nézetek.adoc[_Views_] or
xref:/Objects.adoc[objects]. In order to open or close the _Style Bar_, either
click on the little arrow next to the name of the corresponding
xref:/Nézetek.adoc[_View_] in GeoGebra Desktop, or click the _Style Bar Button_ in
the GeoGebra Web and Tablet Apps. Please note that there are still more properties you can change using the
xref:/Tulajdonságok_párbeszédablak.adoc[_Properties Dialog_].
...
_xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog]_ for the _Graphics View_ or a
...
xref:/Nézetek.adoc[_Views_] in the GeoGebra window (GeoGebra Web and Tablet Apps).
...
_xref:/Point_Capturing.adoc[Point Capturing]_.
...
xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog].)
...
* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] *Open the Properties Dialog*: Open the
_xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog]_ for the _3D Graphics View_ or
...
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Auxiliary Objects_] in the
_Algebra View_.
...
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Free Objects_] and
xref:/Szabad_Függő_és_Segéd_alakzatok.adoc[_Dependent Objects_]. If you
...
_xref:/Parancssor.adoc[Input Bar]_ at the top of the _Spreadsheet View_ (GeoGebra
Desktop).
...
Depending on the xref:/Eszközök.adoc[_Tool_] or existing object you select, the
_Style Bar_ offers a selection of buttons to change the following properties of either the selected object(s) or the
object(s) you are about to create using the selected xref:/Eszközök.adoc[_Tool_]:
...
choose from the following xref:/Címkék_és_feliratok.adoc[Labelling settings]
...
xref:/Címkék_és_feliratok.adoc[caption] that differs from the name or value of
the object (e.g., if you want to give several objects the same label) and can be specified in the
_xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog]_.
...
xref:/tools/Rajzlap_mozgatása.adoc[moving the _(3D) Graphics View_] or zooming
(GeoGebra Desktop).
* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] *Properties Dialog*: Open the
_xref:/Tulajdonságok_párbeszédablak.adoc[Properties Dialog]_ (GeoGebra Web and Tablet Apps)
* image:16px-Stylingbar_dots.svg.png[Stylingbar dots.svg,width=16,height=16] *Display Views*: You may display additional
