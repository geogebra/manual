...
* Javascript figyelők által (lásd xref:/Referencia__JavaScript.adoc[Referencia:JavaScript])
...
xref:/Parancssor.adoc[Input Bar]-ba is be lehet írni. Miután a szkript elkezd
...
xref:/Referencia__JavaScript.adoc[Referencia:JavaScript].

A GeoGebra tartalmazza a saját JavaScript motorját. Amkor egy konstrukciót exportálnak
xref:/Dynamic_Worksheet.adoc[Dynamic Worksheet]-ként, ki lehet választani, hogy
...
konstrukció teljes törlése. Ezeknek egy teljes listája elérhető a xref:/Referencia__JavaScript.adoc[Referencia:JavaScript]
címen.
...
* _a_ egy egész-értékű xref:/tools/Csúszka.adoc[csúszka] 1-től 3-ig
