...
Impostazione di uno strumento _Quadrato_, che crea un quadrato quando si fa clic con il mouse su due punti
già esistenti o in due posizioni qualsiasi della image:16px-Menu_view_graphics.svg.png[Menu view
...
Il nome dello strumento verrà visualizzato nella xref:/Barra_degli_strumenti.adoc[barra degli strumenti] di
GeoGebra, mentre il nome del comando potrà essere utilizzato nella xref:/Barra_di_inserimento.adoc[barra di
inserimento].
