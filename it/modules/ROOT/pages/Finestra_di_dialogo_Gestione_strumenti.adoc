...
Gli strumenti creati dagli utenti vengono salvati in file con estensione GGT, in modo tale che possano essere
distinti dai file standard di GeoGebra (GGB).
