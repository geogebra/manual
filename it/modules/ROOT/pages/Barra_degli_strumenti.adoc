...
== Guida della barra degli strumenti
...
== Barre degli strumenti nelle diverse Viste
...
=== Creare una barra degli strumenti personalizzata
...
=== Modificare la posizione della barra degli strumenti
...
=== Modificare la barra degli strumenti in un'applet di GeoGebra

Per modificare la modalità di visualizzazione della _barra degli strumenti_ nei
xref:/Finestra_di_dialogo_Esporta_foglio_di_lavoro_dinamico.adoc[fogli di lavoro dinamici], impostare il parametro
xref:/Riferimenti__Parametri_applet.adoc[_customToolBar_].
