...
xref:/Algebra_View.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]] _vista Algebra_.
La xref:/tools/Strumenti_Grafici_3D.adoc[_barra degli strumenti della vista Grafici 3D_] è visualizzata in alto, con i
pulsanti
...
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _Grafici 3D_
è disponibile nella xref:/Algebra_View.adoc[image:16px-Menu_view_algebra.svg.png[Menu view
...
_xref:/tools/Strumento_Sfera_-_dato_il_centro_e_un_punto.adoc[Sfera - dato il centro e un punto]_ e fare clic in due
...
che si riferiscono all'oggetto geometrico risultante: ad esempio la casella degli strumenti
...
`Piramide[A, B, C, D]`, dopo aver premuto il tasto [.kcode]#Invio# viene creata la piramide di base _ABC_ e vertice _D_.
...
trascinare con il mouse e rilasciare i xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[punti liberi] nella loro
...
La relativa rappresentazione algebrica si aggiorna automaticamente nella _xref:/Vista_Algebra.adoc[vista
Algebra]_.
