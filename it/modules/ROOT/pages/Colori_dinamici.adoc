...
xref:/Animazione.adoc[Animando] automaticamente gli slider con velocità diverse, si avrà un effetto di
colorazione dinamica automatica.
...
Per fare assumere al punto _A_ tutti i colori dell'arcobaleno al variare della propria posizione, selezionare
il modello colore _HSV_, impostare _Saturazione_ e _Valore_ pari a 1 e digitare `x(A)` nel campo testo _Tonalità_.
