...
disponibili i modelli https://it.wikipedia.org/Hue_Saturation_Brightness[HSV] e
https://it.wikipedia.org/Hue_Saturation_Brightness[HSL] in alternativa al modello
https://it.wikipedia.org/RGB[RGB] predefinito. Selezionare il modello colore desiderato nella casella a discesa
