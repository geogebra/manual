...
GeoGebra Classico], che è disponibile sia https://www.geogebra.org/classic[online] che in versione
...
di xref:/Categoria__Strumenti.adoc[strumenti] e xref:/Categoria__Comandi.adoc[comandi]. Sono inoltre disponibili molte
...
* La xref:/Riferimenti__Installazione_di_GeoGebra.adoc[Guida di installazione] vi aiuterà ad installare e integrare le app
...
* Visitate il https://www.geogebra.org/forum[Forum Utenti di GeoGebra] per qualsiasi informazione o suggerimento.
