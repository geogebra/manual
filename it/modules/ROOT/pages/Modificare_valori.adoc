...
Per modificare il valore di un numero già esistente a = 3, digitare `a = 5` nella barra di inserimento,
quindi premere [.kcode]#Invio#.
...
Mentre i valori degli oggetti liberi sono direttamente modificabili, quelli degli oggetti dipendenti possono
essere influenzati solo dalla modifica degli oggetti parenti o dalla loro completa ridefinizione.
