...
Gli xref:/Categoria__Strumenti.adoc[strumenti di GeoGebra] consentono la creazione di nuovi xref:/Oggetti.adoc[oggetti]
...
Tutti gli xref:/Categoria__Strumenti.adoc[_strumenti_] dispongono di xref:/Categoria__Comandi.adoc[_comandi equivalenti_], utili per
...
più xref:/Categoria__Strumenti.adoc[_strumenti_] dello stesso tipo. Per aprire una _casella degli strumenti_ fare clic su:
...
xref:/Riferimenti__Formato_file.adoc[foglio di lavoro di GeoGebra (*.ggb)]. Vedere la pagina
...
Fare riferimento all'xref:/Categoria__Strumenti.adoc[elenco completo di tutti gli strumenti disponibili] e alle pagine che
