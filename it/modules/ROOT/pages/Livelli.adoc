...
In GeoGebra, i livelli servono per determinare quale oggetto selezionare o trascinare quando si fa clic o si
selezionano più oggetti contemporaneamente.
...
Dopo avere selezionato un oggetto nella versione desktop, per selezionare tutti gli oggetti appartenenti allo
stesso livello selezionare _Seleziona livello corrente_ (tasti di scelta rapida: [.kcode]#CTRL# + [.kcode]#L#) nel menu
