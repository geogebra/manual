...
È possibile assegnare un nome alla conica, digitandolo prima della relativa equazione, seguito da un simbolo di
due punti (:).
...
Se sono stati precedentemente definiti due parametri, ad es. _a = 4_ e _b = 3_, è possibile utilizzarli
nell'equazione di una conica, come ad es. in `ell: b^2 x^2 + a^2 y^2 = a^2 b^2`.
