...
<<assegnazioni,assegnazioni>> per ulteriori dettagli.
...
In alternativa sono disponibili gli xref:/tools/Strumenti_CAS.adoc[_strumenti_] della <<Barra_degli_strumenti_della_vista_CAS,_barra degli strumenti
della vista CAS_>>.
