...
In alternativa sono disponibili gli xref:/tools/Strumenti_CAS.adoc[_strumenti_] della xref:/.adoc[_barra degli
strumenti della vista CAS_].
...
Fare riferimento alla sezione xref:/commands/Comandi_specifici_CAS.adoc[comandi specifici CAS] che contiene
l'elenco di tutti i comandi disponibili.
...
A partire dalla versione 5.0 di GeoGebra la image:16px-Menu_view_cas.svg.png[Menu view
cas.svg,width=16,height=16] _vista CAS_ supporta il calcolo esatto di
xref:/commands/Comandi_geometrici_supportati_in_vista_CAS.adoc[alcuni _comandi geometrici_]
...
Fare riferimento alla sezione xref:/tools/Strumenti_CAS.adoc[strumenti CAS] per l'elenco completo degli
...
Per copiare in formato LaTeX i contenuti di più righe CAS, selezionare le righe con [.kcode]##Ctrl##+clic
(MacOS: [.kcode]#Cmd#-clic), quindi fare clic con il tasto destro del mouse (MacOS: [.kcode]#Ctrl#-clic)
sull'intestazione di riga e selezionare _Copia come LaTeX_.
