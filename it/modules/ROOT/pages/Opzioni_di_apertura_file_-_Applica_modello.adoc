...
/File:Foglio_Stile_Pto.PNG.adoc[image:500px-Foglio_Stile_Pto.PNG[Foglio Stile Pto.PNG,width=500,height=222]]
...
/File:Applica_Modello_Lista.PNG.adoc[image:Applica_Modello_Lista.PNG[Applica Modello Lista.PNG,width=470,height=110]]
