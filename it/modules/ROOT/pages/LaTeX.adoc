...
Per creare un testo contenente una formula LaTeX e del testo statico, digitare la parte statica del testo
all'interno di \text\{} (l'opzione _Formula LaTeX_ deve essere attivata).
...
È inoltre possibile utilizzare il xref:/commands/Comando_LaTeX.adoc[comando LaTeX] per digitare direttamente la
