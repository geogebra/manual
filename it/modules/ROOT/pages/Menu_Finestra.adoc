...
Questa opzione può essere utile ad esempio quando si utilizza GeoGebra in una presentazione e si desidera
passare agevolmente tra una finestra e l'altra.
