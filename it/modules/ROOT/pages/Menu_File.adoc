...
È inoltre possibile aprire direttamente un file di GeoGebra trascinandolo con il mouse e rilasciandolo
direttamente all'interno della finestra attiva di GeoGebra.
...
Se alcune impostazioni vengono personalizzate e salvate, la nuova finestra di GeoGebra utilizzerà le
