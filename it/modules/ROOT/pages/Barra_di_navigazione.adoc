...
È inoltre possibile aggiungere un pulsante _Esegui_, per avviare l'animazione dei passi della costruzione, oltre
a un pulsante per visualizzare il xref:/Protocollo_di_Costruzione.adoc[protocollo di costruzione].
...
È possibile modificare la velocità di esecuzione automatica della costruzione, utilizzando la casella di testo
alla destra del pulsante /File:Animate_Play.png.adoc[image:Animate_Play.png[Animate Play.png,width=16,height=16]]
Esegui.
