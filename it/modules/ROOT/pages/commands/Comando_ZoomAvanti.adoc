...
Se _a_ è uno slider, `ZoomAvanti(-a, -a, a, a)` rende la porzione visibile della _vista Grafici_ dipendente
dallo slider _a_.
...
Se uno o più di questi parametri sono oggetti dipendenti, gli estremi visibili della vista Grafici diventano
dinamici. Per eliminare questo comportamento, utilizzare il comando
