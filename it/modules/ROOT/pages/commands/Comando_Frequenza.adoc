...
Siano `dati={1, 2, 2, 2, 3, 3, 4, 4, 4, 4}` la lista dei dati grezzi e `classi={0, 2, 5}` la lista degli
estremi delle classi. Allora `Frequenza(classi, dati, false)` e `Frequenza(classi, dati)` restituiscono la lista \{1,
