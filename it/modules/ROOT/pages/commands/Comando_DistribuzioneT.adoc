...
Restituisce la probabilità relativa a un dato valore di _x_ (ovvero l'area sottesa dalla curva della
distribuzione t di Student alla sinistra dell'ascissa _x_ indicata).
