...
Vedere anche i comandi xref:/commands/Comando_Fattorizza.adoc[Fattorizza],
xref:/commands/Comando_Assumi.adoc[Assumi], xref:/commands/Comando_FrazioniParziali.adoc[FrazioniParziali],
xref:/commands/Comando_Sviluppa.adoc[Sviluppa], xref:/commands/Comando_Polinomio.adoc[Polinomio].
