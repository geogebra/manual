...
Sia _lista1=\{1, 2, 5}_ una lista di numeri. `Compatta(Semplifica(a*x^(b-1)), a, lista1,b)` restituisce la
lista _\{1, 2x, 5x²}_.
...
Sia _lista1=\{x^2, x^3, x^6}_ una lista di polinomi. `Compatta(Grado(a), a, lista1)` restituisce la lista
_\{2, 3, 6}_.
