...
inglese (vedere https://wiki.geogebra.org/en/Reference:Colors[Colors])
...
`ImpColore(testo1, "#80FF0000")` imposta il colore del _testo1_ già esistente in rosso, con una trasparenza
di bianco del 50%
