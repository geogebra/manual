...
`Inserisci(x^2, {1, 2, 3, 4, 5}, -1)` inserisce _x^2^_ alla fine della lista e restituisce _\{1, 2, 3, 4, 5,
x^2^}_.
...
`Inserisci({11, 12}, {1, 2, 3, 4, 5}, 3)` inserisce gli elementi della prima lista a partire dalla terza
posizione della seconda lista e restituisce _\{1, 2, 11, 12, 3, 4, 5}_.
