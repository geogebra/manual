...
Se gli oggetti della lista non sono di tipo numerico, il comando _Max_ considera i numeri associati a tali
oggetti: ad es. _Max_(_Lista di segmenti_) restituisce il segmento avente lunghezza massima.
...
`Max({1, 2, 3, 4, 5}, {5, 3, 4, 2, 0})` restituisce 4, il massimo numero della lista avente frequenza
maggiore di 0.
