...
xref:/tools/Strumento_Sfera_-_dato_il_centro_e_un_punto.adoc[Sfera - dato il centro e un punto] e
image:22px-Mode_spherepointradius.svg.png[Mode spherepointradius.svg,width=22,height=22]
xref:/tools/Strumento_Sfera_-_dato_il_centro_e_il_raggio.adoc[Sfera - dato il centro e il raggio].
