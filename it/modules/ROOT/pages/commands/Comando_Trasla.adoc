...
Vedere anche lo strumento image:24px-Mode_translatebyvector.svg.png[Mode
translatebyvector.svg,width=24,height=24] xref:/tools/Strumento_Traslazione.adoc[Traslazione].
