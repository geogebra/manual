...
`PolinomioTaylor(x^2, 3, 1)` restituisce 9 + 6 (_x_ - 3), lo sviluppo in serie di potenze di _x^2^_ centrato
in _x_ = 3, di ordine 1.
...
`PolinomioTaylor(x^2, a, 1)` restituisce __a__^2^ + 2__a__ (_x_ - _a_), lo sviluppo in serie di potenze di
_x^2^_ centrato in _x_ = _a_, di ordine 1.
