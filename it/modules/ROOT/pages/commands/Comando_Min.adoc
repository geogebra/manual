...
Se gli argomenti sono oggetti non numerici, allora _Min_ considera i numeri associati a tali oggetti. Per
esempio, se _Lista1_ è una lista di segmenti, _Min_(_Lista1_) restituisce il segmento di minima lunghezza.
...
`Min({1, 2, 3, 4, 5}, {0, 3, 4, 2, 3})` restituisce 2, il minimo tra gli elementi della lista avente
