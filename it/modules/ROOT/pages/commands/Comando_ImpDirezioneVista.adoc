...
Per ruotare la vista 3D in funzione dei valori assunti da uno slider _α_ precedentemente creato, inserire
nella scheda _All'aggiornamento_ dello slider _α_ l'istruzione `ImpDirezioneVista(Vettore((1; α; -30°)), false)`
