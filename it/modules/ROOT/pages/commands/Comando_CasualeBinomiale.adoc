...
`CasualeBinomiale(3, 0.1)` restituisce _j ∈ \{0, 1, 2, 3}_, dove la probabilità di ottenere _j_ è quella di un evento di
probabilità _0.1_ che si verifica _j_ volte in 3 prove.
