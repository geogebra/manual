...
Vedere anche il comando xref:/commands/CilindroInfinito.adoc[CilindroInfinito] e gli strumenti
image:24px-Mode_cylinder.svg.png[Mode cylinder.svg,width=24,height=24] xref:/tools/Cilindro.adoc[Cilindro] e
