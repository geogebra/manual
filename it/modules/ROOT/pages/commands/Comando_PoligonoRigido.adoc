...
Il poligono copiato mantiene il legame con il poligono originale, quindi ad esempio per modificare la forma del
poligono copiato è necessario modificare l'originale.
