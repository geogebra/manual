...
`Istogramma({0, 1, 2, 3, 4, 5}, {2, 6, 8, 3, 1})` genera un istogramma avente 5 barre, ciascuna avente
altezza ordinatamente indicata nella seconda lista. La prima barra occupa l'intervallo [_0, 1_], la seconda occupa
l'intervallo [_1, 2_], e così via.
...
`Istogramma(true, {10, 20, 30, 40}, {10, 11, 11, 12, 18, 20, 25, 40}, true) ` genera un istogramma avente 3
barre, di altezze rispettivamente 0.5, 0.7 e 0.8
