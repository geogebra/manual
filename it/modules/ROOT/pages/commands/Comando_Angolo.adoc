...
*Note:* Vedere anche gli strumenti image:../assets/images/20px-Mode_angle.svg.png[Mode angle.svg,width=20,height=20]
link:/it/Strumento_Angolo[Angolo] e image:../assets/images/20px-Mode_anglefixed.svg.png[Mode
