...
`Angolo(x^2 / 4 + y^2 / 9 = 2)` restituisce _90°_ o 1.57 rad se l'unità di misura selezionata per gli angoli
è _radianti_.
...
`Angolo(Poligono((4, 1), (2, 4), (1, 1)))` restituisce _56.31°_, _52.13°_ e _71.57°_ o i corrispondenti
...
L'utilizzo di una _Direzione_ consente di bypassare la visualizzazione predefinita per gli angoli in 3__D__ che
