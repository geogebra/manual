...
RiempiCelle(IntervalloCelle, Oggetto)::
  ...
  xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[oggetti liberi], cioè non saranno modificate se l'oggetto origine
  subirà modifiche.
  +
...
RiempiCelle(Cella, Lista)::
  ...
  sono xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[oggetti liberi], cioè non saranno modificate se la lista
  origine subirà modifiche.
...
RiempiCelle(Cella, Matrice)::
  ...
  posizionato con la cella indicata. Le celle risultanti sono xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[oggetti
