...
Questo è un xref:/commands/Comandi_Scripting.adoc[comando di tipo scripting] che imposta il valore del numero
una volta sola. Per convertire un testo _testo1_ in un numero che possa essere aggiornato dinamicamente, utilizzare il
comando xref:/commands/Comando_DaBase.adoc[DaBase](testo1,10).
