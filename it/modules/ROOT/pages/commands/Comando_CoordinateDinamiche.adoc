...
(1.3,2.1) con lo image:20px-Mode_move.svg.png[Mode move.svg,width=20,height=20]
xref:/tools/Strumento_Muovi.adoc[strumento Muovi], il punto _A_ diventa (1.3,2.1) e _B_ viene visualizzato in (1,2).
