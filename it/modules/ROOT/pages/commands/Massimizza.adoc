...
Sia _a_ uno slider a valori in [0,10] e _t1_ il triangolo rettangolo di vertici _C_ = (_a_, 0), _A_ = (0, 0) e _B_ = (0,10 - _a_). `++Massimizza(t1,a)++` restituisce 5, il valore di _a_ che massimizza l'area del triangolo _t1_.
