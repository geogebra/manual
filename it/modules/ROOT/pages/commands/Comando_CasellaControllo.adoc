...
Dati i punti _A_ e _B_, `c=CasellaControllo({A,B})` crea una casella di controllo _c_. Quando _c_ è
selezionata, _A_ e _B_ sono visibili, in caso contrario sono nascosti.
