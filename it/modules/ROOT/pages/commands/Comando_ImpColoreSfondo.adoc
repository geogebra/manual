...
ImpColoreSfondo(Oggetto, "Colore")::
  ...
  * un nome di colore in inglese, tra quelli disponibili alla pagina
  /s_index_php?title=En:Reference:Colors&action=edit&redlink=1.adoc[Colors], oppure uno tra quelli disponibili in
...
(vedere /s_index_php?title=En:Reference:Colors&action=edit&redlink=1.adoc[Colors])
...
ImpColoreSfondo("Colore")::
  ...
  /s_index_php?title=En:Reference:Colors&action=edit&redlink=1.adoc[Colors]), alcuni dei quali, elencati nella tabella
...
/s_index_php?title=En:Reference:Colors&action=edit&redlink=1.adoc[Colors])
