...
Se la condizione: 2 * _lunghezza semiasse maggiore_ > _distanza focale_ non è soddisfatta, si otterrà
un'iperbole.
...
Sia s = Segmento((0,1), (2,1)), allora `Ellisse((0, 1), (2, 1), s)` genera l'ellisse di equazione _3x² + 4y²
- 6x - 8y = 5_.
