...
Min(Funzione, x iniziale, x finale)::
  ...
  continua, definita sul proprio dominio naturale (senza restrizioni) e avere un solo punto di minimo locale nell'intervallo (e nessun massimo locale).
...
Min(Funzione, x iniziale, x finale)::
  ...
  inclusi gli estremi. La funzione deve essere
  continua, definita sul proprio dominio naturale (senza restrizioni) e avere un solo punto di minimo locale nell'intervallo (e nessun massimo locale).
