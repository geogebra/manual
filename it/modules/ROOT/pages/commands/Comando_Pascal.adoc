...
Se il numero di prove indipendenti di Bernoulli che devono avere successo è _n_ = 1 e la probabilità di
successo in ciascuna prova è p = stem:[\frac\{1}\{6}], allora la probabilità di avere 2 insuccessi prima del successo è
data da ` Pascal(1, 1/6, 2, false)`, che restituisce _0.12_ nella image:16px-Menu_view_algebra.svg.png[Menu view
