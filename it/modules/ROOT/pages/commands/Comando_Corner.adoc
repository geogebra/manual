...
Corner[Numero del corner] non è applicabile all'interno di altri comandi. Nel caso ciò fosse necessario, creare
ad esempio `C_1 = Corner(1)` e utilizzare tale oggetto all'interno di altri comandi.
...
Corner(Vista Grafici, Numero del corner) non è applicabile all'interno di altri comandi. Nel caso ciò fosse
necessario, creare ad esempio `C_1 = Corner(1)` e utilizzare tale oggetto all'interno di altri comandi.
