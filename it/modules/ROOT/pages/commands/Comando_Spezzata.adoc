...
`Spezzata((1, 3), (4, 3), (?,?), (6, 2), (4, -2), (2, -2))` genera la spezzata discontinua avente i vertici
indicati e visualizza in vista image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] _Algebra_
la relativa lunghezza _9.47_ .
