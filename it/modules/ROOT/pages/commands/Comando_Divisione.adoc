...
In _Vista Algebra_ è possibile utilizzare una sola variabile, che verrà sempre rinominata in _x_. In _Vista CAS_
è invece possibile utilizzare più variabili.
