...
Le note limitazioni computazionali legate al
http://docs.oracle.com/cd/E19957-01/806-3568/ncg_goldberg.html[calcolo in virgola mobile] possono causare risposte non
corrette, se le cifre significative indicate sono in numero non sufficiente. Ad esempio,
