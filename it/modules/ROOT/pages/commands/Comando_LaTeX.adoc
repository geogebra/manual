...
Se _a = 2_ e _f(x) = a x^2^_, allora `LaTeX(f, true, true)` restituisce _f(x)=2 x^2^_ (come testo LaTeX),
mentre `LaTeX(f, false, false)` restituisce _a x^2^_ (come testo _LaTeX_).
