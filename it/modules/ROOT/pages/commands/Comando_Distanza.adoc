...
Il comando è applicabile a punti, segmenti, rette, coniche e curve implicite. Per la funzioni utilizza un
algoritmo numerico al momento stabile solo con le funzioni polinomiali.
