...
Max(Funzione, x iniziale, x finale)::
  ...
  specificati. La funzione deve essere continua, definita sul proprio dominio naturale (senza restrizioni) e avere un solo punto di massimo locale nell'intervallo (e nessun minimo locale).
...
Max(Funzione, x iniziale, x finale)::
  ...
  inclusi gli estremi. La funzione deve essere continua, definita sul proprio dominio naturale (senza restrizioni) e avere un solo punto di massimo locale nell'intervallo (e nessun minimo locale).
