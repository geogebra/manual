...
Binomiale(Numero di prove, Probabilità di successo)::
  Restituisce un istogramma di una https://it.wikipedia.org/Distribuzione_binomiale[distribuzione
  binomiale].
  _Parametri:_
...
Binomiale(Numero di prove, Probabilità di successo, Booleano _Cumulata_)::
  Restituisce un istogramma di una distribuzione binomiale quando _Cumulata_ = false.
