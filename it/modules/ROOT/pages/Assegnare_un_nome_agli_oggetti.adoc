...
Selezionare l'oggetto da rinominare, quindi selezionare l'opzione
...
xref:/Finestra_di_dialogo_Proprietà.adoc[Finestra di dialogo Proprietà] dell'oggetto e inserire il nuovo nome nel campo
