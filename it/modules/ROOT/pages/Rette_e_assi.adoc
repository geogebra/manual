...
Per assegnare un nome alla retta, digitarlo nella _barra di inserimento_ prima dell'equazione, seguito da un
simbolo di due punti ` : `.
...
Il comando `Perpendicolare(A, asseX)` costruisce la retta passante per il punto A indicato e perpendicolare
