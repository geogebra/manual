...
punto, la sintassi `a(A)` è altresì valida. È possibile limitare le posizioni di un punto all'interno di una zona del
piano descritta da una disequazione utilizzando il xref:/commands/Comando_PuntoIn.adoc[comando PuntoIn]. Se la
