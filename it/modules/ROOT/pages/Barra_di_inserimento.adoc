...
Premere sempre [.kcode]#Invio# dopo un input algebrico nella _barra di inserimento_ per confermare
l'inserimento.
...
La definizione di un oggetto sostituisce qualsiasi espressione contenuta nella _barra di inserimento_ prima
della pressione del tasto [.kcode]#F3#.
