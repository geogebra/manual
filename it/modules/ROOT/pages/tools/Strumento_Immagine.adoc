...
Questo corner, che controlla la larghezza dell'immagine, può essere impostato solo se il _Corner 1_ è stato
...
Questo corner, che controlla l'altezza dell'immagine, può essere impostato solo se il _Corner 1_ è stato
definito in precedenza.
...
Per collegare l'immagine a un punto _A_ e assegnare ad essa dimensioni fissate (ad esempio larghezza = 3,
altezza = 4 unità):
