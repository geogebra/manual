...
== Strumento Muovi nella image:22px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=22,height=22] vista Grafici
...
translateview.svg,width=20,height=20] xref:/tools/Muovi_la_vista_Grafici.adoc[Muovi la vista Grafici].
...
* Per spostare uno xref:/tools/Slider.adoc[slider] nella vista _Grafici_, selezionare lo strumento
...
== Strumento Muovi nella image:22px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=22,height=22] vista Grafici 3D
