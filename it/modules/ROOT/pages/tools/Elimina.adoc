...
* Utilizzare questo strumento per cancellare parti di grafico creato con lo xref:/tools/Strumento_Penna.adoc[strumento Penna]. Dopo avere selezionato lo strumento, tenere premuto il tasto sinistro del mouse mentre si passa il puntatore sopra la parte di grafico da eliminare (dispositivi non-touch), oppure passare con la penna o il dito sopra la parte di grafico da eliminare (dispositivi touch).
