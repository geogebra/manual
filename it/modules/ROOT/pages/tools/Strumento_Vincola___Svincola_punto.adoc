...
clic su un punto xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[libero], quindi sul cammino o sulla regione. Da
questo momento in poi, il punto potrà essere spostato utilizzando lo image:22px-Mode_move.svg.png[Mode
