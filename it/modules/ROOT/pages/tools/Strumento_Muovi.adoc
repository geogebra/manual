...
Selezionare lo strumento, quindi trascinare e rilasciare gli xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[oggetti
...
xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[punti liberi] nella loro posizione finale. Per muovere un punto nella
