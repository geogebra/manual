...
* xref:/tools/Strumento_Calcola.adoc[image:24px-Mode_evaluate.svg.png[Mode evaluate.svg,width=24,height=24]]
xref:/tools/Strumento_Calcola.adoc[strumento Calcola]
* xref:/tools/Strumento_Numerico.adoc[image:24px-Mode_numeric.svg.png[Mode numeric.svg,width=24,height=24]]
xref:/tools/Strumento_Numerico.adoc[strumento Numerico]
* xref:/tools/Strumento_Mantieni_inserimento.adoc[image:24px-Mode_keepinput.svg.png[Mode
keepinput.svg,width=24,height=24]] xref:/tools/Strumento_Mantieni_inserimento.adoc[strumento Mantieni inserimento]
