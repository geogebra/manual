...
È possibile ottenere lo stesso effetto senza selezionare lo strumento, ma semplicemente tenendo premuto il tasto
destro del mouse e trascinando la image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra
