...
/File:Tool_New_Point_gif.adoc[image:Tool_New_Point.gif[Tool New Point.gif,width=32,height=32]] (la seconda a partire da
...
* xref:/tools/Strumento_Vincola_Svincola_punto.adoc[Vincola / Svincola punto]
