...
* xref:/tools/Segmento_dati_un_punto_e_la_lunghezza.adoc[Segmento - dati un punto e la lunghezza]
* xref:/tools/Semiretta.adoc[Semiretta]
* xref:/tools/Spezzata_aperta.adoc[Spezzata aperta]
* xref:/tools/Vettore.adoc[Vettore]
* xref:/tools/Vettore_dati_un_punto_e_la_direzione.adoc[Vettore - dati un punto e la direzione]
