...
* Nella xref:/Vista_Grafici_3D.adoc[image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra
3Dgraphics.svg,width=16,height=16]] xref:/Vista_Grafici_3D.adoc[vista Grafici 3D], il vettore traslazione deve avere come estremi due punti già esistenti.
