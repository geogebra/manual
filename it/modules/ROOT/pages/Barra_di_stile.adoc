...
xref:/Finestra_di_dialogo_Propriet%C3%A0.adoc[finestra di dialogo Proprietà] consente invece la modifica di tutte le
...
=== [#Barra_di_stile_della_vista_Grafici]#image:24px-Stylingbar_icon_graphics.svg.png[Stylingbar icon graphics.svg,width=24,height=17] Barra di stile della vista Grafici#
...
_xref:/Finestra_di_dialogo_Propriet%C3%A0.adoc[finestra di dialogo Proprietà]_ della
...
=== [#Barra_di_stile_della_vista_Grafici_3D]#image:24px-Stylingbar_icon_graphics3D.svg.png[Stylingbar icon graphics3D.svg,width=24,height=17] Barra di stile della vista Grafici 3D#
...
=== [#Barra_di_stile_della_vista_Algebra]#image:24px-Stylingbar_icon_algebra.svg.png[Stylingbar icon algebra.svg,width=24,height=17] Barra di stile della vista Algebra#
...
** _Dipendenza_: gli oggetti matematici sono classificati come
xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[_oggetti liberi_] oppure
xref:/Oggetti_liberi,_dipendenti_e_ausiliari.adoc[_oggetti dipendenti_]. Se un oggetto viene creato senza utilizzare un
altro oggetto, è classificato come _oggetto libero_; in caso contrario sarà classificato come _oggetto dipendente_.
...
=== [#Barra_di_stile_della_vista_CAS]#image:24px-Stylingbar_icon_cas.svg.png[Stylingbar icon cas.svg,width=24,height=17] Barra di stile della vista CAS#
...
=== [#Barra_di_stile_della_vista_Foglio_di_calcolo]#image:24px-Stylingbar_icon_spreadsheet.svg.png[Stylingbar icon spreadsheet.svg,width=24,height=17] Barra di stile della vista Foglio di calcolo#
...
* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] *Apri la finestra di dialogo Proprietà*: aprire
la image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16]
_xref:/Finestra_di_dialogo_Propriet%C3%A0.adoc[finestra di dialogo Proprietà]_ (GeoGebra Web e app per tabet)
* image:16px-Stylingbar_dots.svg.png[Stylingbar dots.svg,width=16,height=16] *Mostra Viste*: visualizzare ulteriori
xref:/Viste.adoc[_Viste_] nella finestra di GeoGebra (GeoGebra Web e app per tablet)

=== [#Opzioni_della_barra_di_stile_per_strumenti_e_oggetti]#Opzioni della barra di stile per strumenti e oggetti#
...
_xref:/Finestra_di_dialogo_Propriet%C3%A0.adoc[finestra di dialogo Proprietà]_ dell'oggetto.
* image:Pin.png[Pin.png,width=16,height=16] *Posizione assoluta sullo schermo*: fissare un oggetto (ad es. un testo)
sullo schermo in modo che la sua posizione non si modifichi quando si
xref:/tools/Strumento_Muovi_la_vista_Grafici.adoc[_muove la vista Grafici (3D)_] o si effettuano degli zoom(GeoGebra
Desktop).
