...
== [#Un_software.2C_diversi_pacchetti]#Un software, diversi pacchetti#
...
/s_index_php?title=Riferimenti:Dispositivi_supportati&action=edit&redlink=1.adoc[Dispositivi supportati] per ulteriori
...
== [#Personalizzare_il_layout_dell.27interfaccia_utente]#Personalizzare il layout dell'interfaccia utente#
