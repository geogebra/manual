...
* i listener Javascript (vedere xref:en@reference::/GeoGebra_Apps_API.adoc[Riferimenti:JavaScript])
...
xref:en@reference::/GeoGebra_Apps_API.adoc[Riferimenti:JavaScript].
...
completo è disponibile in xref:en@reference::/GeoGebra_Apps_API.adoc[Riferimenti:JavaScript].
