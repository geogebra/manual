...
Lo scripting con JavaScript è molto versatile, ma molte funzionalità sono disponibili anche utilizzando
GeoGebraScript, che è molto più semplice.
...
L'utilizzo di qualsiasi metodo ggbApplet in _Globali JavaScript_ al di fuori di _ggbOnInit_ non avrà l'effetto
atteso, in quanto tali metodi vengono chiamati prima del caricamento della costruzione.
