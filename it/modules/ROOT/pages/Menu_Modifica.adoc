...
image:16px-Menu-edit-undo.svg.png[Menu-edit-undo.svg,width=16,height=16] _Annulla_ alla destra della
...
È inoltre possibile utilizzare il pulsante
image:16px-Menu-edit-redo.svg.png[Menu-edit-redo.svg,width=16,height=16] _Ripristina_ alla destra della barra degli
strumenti.
...
È necessario innanzitutto xref:/Selezionare_oggetti.adoc[selezionare gli oggetti] da eliminare (ad es. con un
