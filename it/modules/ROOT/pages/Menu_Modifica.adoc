...
== image:24px-Menu-edit-undo.svg.png[Menu-edit-undo.svg,width=24,height=24] Annulla
...
== image:24px-Menu-edit-redo.svg.png[Menu-edit-redo.svg,width=24,height=24] Ripristina
...
== image:24px-Menu-edit-copy.svg.png[Menu-edit-copy.svg,width=24,height=24] Copia
...
== image:24px-Menu-edit-paste.svg.png[Menu-edit-paste.svg,width=24,height=24] Incolla
...
== image:24px-Menu-options.svg.png[Menu-options.svg,width=24,height=24] Proprietà…
...
xref:/Finestra_di_dialogo_Proprietà.adoc[finestra di dialogo Proprietà] che consente di modificare le proprietà di tutti
gli oggetti utilizzati nel file di GeoGebra.
...
Modifica la xref:/Proprietà_degli_oggetti.adoc[visibilità] degli oggetti selezionati.
...
== image:Menu_Copy.png[Menu Copy.png,width=24,height=24] Vista Grafici negli Appunti (solo versione Desktop)
...
== image:24px-Tool_Delete.gif[Tool Delete.gif,width=24,height=24] Elimina
