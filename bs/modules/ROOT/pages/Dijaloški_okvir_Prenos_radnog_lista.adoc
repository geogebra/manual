...
zadatke), a zatim kliknuti [.kcode]#Učitavanje# da postavimo datoteku na https://www.geogebra.org/[GeoGebra].
...
xref:/Priručnik__Prenos_kao_html_Web_stranice.adoc[Prenos kao html Web-stranice] za
detalje
