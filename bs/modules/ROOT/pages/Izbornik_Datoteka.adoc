...
xref:/Dijaloški_okvir_Prenos_radnog_lista.adoc[Dynamic Worksheet as Webpage (html)...] .
...
for the xref:/Radna_površ.adoc[Graphics View]. You may specify Title, Author,
