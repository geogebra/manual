...
našem xref:/Tutorijal__Početna_strana.adoc[uvodnom materijalu] ili
xref:/Priručnik__Početna_strana.adoc[priručniku].
...
"xref:/Tipovi__Kompleksni_brojevi.adoc[Savjeti\Upute: Kompleksni brojevi]" i dodajući Vaš savjet ili uputu kao sadržaj.
...
xref:/Tipovi__Kompleksni_brojevi.adoc[Savjeti\Upute: Kompleksni brojevi].
* Naglasite GeoGebra naredbe poput `++funkcija[f,-2,2]++` stavljajući tekst između oznaka `++<code>++` i `++</code>++`.

xref:/En__Tips.adoc[en:Tips]
