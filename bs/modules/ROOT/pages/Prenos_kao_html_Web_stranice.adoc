...
interactive applet (e. g., show the xref:/Alatna_traka.adoc[Toolbar], modify height
...
xref:/Show_Hide_Object_Tool.adoc[show / hide object or label],
xref:/Tragom.adoc[trace on / off],
xref:/Osobine_Dijaloški_okvir.adoc[Properties dialog]). It is also possible to use the
common xref:/Keyboard_Shortcuts.adoc[keyboard shortcuts].
...
xref:/Reference__Applets.adoc[signed applets] are used and every user of your applet
...
xref:/Prikazi.adoc[views] shown in the applet.
...
Tangent, Expand https://www.geogebra.org/trac/browser/trunk/geogebra/geogebra/kernel/cas

* you don't use any of these commands:

https://www.geogebra.org/trac/browser/trunk/geogebra/geogebra/kernel/discrete
...
* See xref:/Embedding_to_CMS_VLE_(Moodle)_and_Wiki.adoc[Embedding to CMS, VLE
