...
interactive applet (e. g., show the xref:/Toolbar.adoc[Toolbar], modify height
...
xref:/Tracing.adoc[trace on / off],
xref:/Properties_Dialog.adoc[Properties dialog]). It is also possible to use the
...
xref:/Views.adoc[views] shown in the applet.
