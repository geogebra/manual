...
xref:/Uređivanje.adoc[Edit Menu].

* Select the image:Tool_Move.gif[Tool Move.gif,width=32,height=32]
xref:/Pomjeranje_Alat.adoc[Move Tool] and double click on an object in the
xref:/Radna_površ.adoc[Graphics View]. In the appearing
...
You can modify the xref:/Osobine_figure.adoc[properties] of
xref:/Označavanje_figura.adoc[selected objects] using the tabs on the right hand
