...
In the image:../assets/images/16px-Menu_view_cas.svg.png[Menu view cas.svg,width=16,height=16] link:/en/CAS_View[CAS
...
Furthermore, the following command is only available in the image:../assets/images/16px-Menu_view_cas.svg.png[Menu view
