...
Move.gif,width=32,height=32] xref:/tools/Premikanje_orodje.adoc[Move Tool] and select the
...
xref:/tools/Premikanje_orodje.adoc[Move Tool] and select the object whose value you want to
...
before.
** Activate image:Tool_Move.gif[Tool Move.gif,width=32,height=32]
xref:/tools/Premikanje_orodje.adoc[Move Tool] and select the object whose definition you want
