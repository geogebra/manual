...
xref:/View_Menu.adoc[Upravljanje konstrukcijskih korakov > Gumb za prikaz opisa
korakov] v meniju xref:/View_Menu.adoc[Pogled] in s tem ukazom prikažete
navigacijsko vrstico pod konstrukcijo (v spodnjem delu okna
xref:/Graphics_View.adoc[grafičnega okna].
