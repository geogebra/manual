...
_Orodja_ Geogebre omogočajo izdelovanje novih
xref:/Objekt.adoc[Objektov] z uporabo miške, ali drugega kazalnika. Aktiviramo
jih s klikom na ustrezen gumb v _xref:/Orodna_vrstica.adoc[Orodni vrstici]_.

== Različna orodja za različne poglede

Vsak xref:/Pogledi.adoc[_Pogled_] razen
image:16px-Menu_view_algebra.svg.png[Pogled algebra,title="Pogled algebra",width=16,height=16]
_xref:/Algebra.adoc[Algebra]_ ima lastno orodno vrstico _Orodna vrstica_, z
...
All _Orodja_ imajo svoje _xref:Ukazne.adoc[Ukazne ekvivalente]_ ki so tudi primernejši za
