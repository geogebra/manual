...
Primi in premakni xref:/Free_Dependent_and_Auxiliary_Objects.adoc[Prosti
objekti].
...
xref:/Animation.adoc[ročna animacija])
...
* To move a xref:/Slider_Tool.adoc[Slider] when
...
xref:/Move_Graphics_View_Tool.adoc[Move Graphics View] tool.
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[free points]. In order to move a
