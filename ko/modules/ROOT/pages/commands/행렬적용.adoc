...
ApplyMatrix( <([Matrices|Matrix)]>, <xref:/s_index_php?title=Geometric_Objects_action=edit_redlink=1.adoc[Object]> )::
...
This command also works for xref:/s_index_php?title=Images_action=edit_redlink=1.adoc[images].
