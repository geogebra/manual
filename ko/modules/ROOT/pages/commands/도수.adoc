...
Frequency( <List of Raw Data> )::
  ...
  values use the xref:/s_index_php?title=Unique_Command_action=edit_redlink=1.adoc[Unique Command].
...
Frequency( <List of Text>, <List of Text> )::
  ...
  list of the unique values for each list use the command
  xref:/s_index_php?title=Unique_Command_action=edit_redlink=1.adoc[Unique Command].
...
See also the xref:/s_index_php?title=ContingencyTable_Command_action=edit_redlink=1.adoc[ContingencyTable] command.
