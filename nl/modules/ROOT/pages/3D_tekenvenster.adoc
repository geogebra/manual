...
Naast de brede waaier aan xref:/Categorie__Commando_s.adoc[_Commando's_] in de andere _xref:/Views.adoc[vensters]_ van
...
Met de knop xref:/tools/Verplaatsen.adoc[image:16px-Mode_move.svg.png[Mode move.svg,width=16,height=16]]
...
In het image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _3D
tekenvenster_, kan je de toets xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] gebruiken om een geselecteerd object verticaal
naar boven te verplaatsen en de toets xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] om het verticaal naar beneden te
verplaatsen.
...
xref:/tools/Roteer_3D_tekenvenster.adoc[image:16px-Mode_rotateview.svg.png[Mode rotateview.svg,width=16,height=16]]
