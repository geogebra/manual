...
Met de xref:/Macro_s.adoc[_Knoppen_] in de xref:/Gereedschappenbalk.adoc[_Knoppenbalk_] kan je wiskundige constructies
...
assenstelsel. Je kunt zowel de _xref:/Macro_s.adoc[Knoppen]_ in de xref:/Gereedschappenbalk.adoc[Knoppenbalkbalk____]
