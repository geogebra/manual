...
xref:/Algebra_venster.adoc[image:24px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=24,height=24]]
...
xref:/Tekenvenster.adoc[image:24px-Menu_view_graphics.png[Menu view graphics.png,width=24,height=24]]
...
a|
xref:/3D_tekenvenster.adoc[image:24px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra
...
a|
xref:/CAS_venster.adoc[image:24px-Menu_view_cas.svg.png[Menu view cas.svg,width=24,height=24]] _xref:/CAS_venster.adoc[CAS
venster]_ :
...
a|
xref:/Rekenblad.adoc[image:24px-Menu_view_spreadsheet.svg.png[Menu view spreadsheet.svg,width=24,height=24]]
