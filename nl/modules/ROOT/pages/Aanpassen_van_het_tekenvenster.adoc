...
* Je kunt sneltoetsen gebruiken om in te zoomen: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] en om uit te zoomen:
...
* Je kunt de assen herschalen door de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-toets ingedrukt te houden (PC: ook
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-toets) en tegelijk de as te verslepen.
