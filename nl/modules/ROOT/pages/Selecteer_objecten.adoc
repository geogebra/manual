...
Je kunt ook meerdere objecten tegelijk selecteren door de toets xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac OS:
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) ingedrukt te houden terwijl je verschillende objecten aanklikt.
