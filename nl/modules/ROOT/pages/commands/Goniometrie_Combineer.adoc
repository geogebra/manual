...
`++GoniometrieCombineer(sin(x) + cos(x), sin(x))++` geeft stem:[ \left\{\sqrt{2} sin \left( x + \frac{1}{4} \pi \right)\right\}
].
...
`++GoniometrieCombineer(sin(x) + cos(x))++` geeft stem:[ \left\{\sqrt{2} cos \left( x - \frac{1}{4} \pi \right)\right\} ].
...
`++GoniometrieCombineer(sin(x) cos(3x))++` geeft stem:[\left\{\frac{1}{2} sin \left( 4 x \right) - \frac{1}{2} sin \left(
2 x \right)\right\}].
...
`++GoniometrieCombineer(sin(p) cos(3p))++` geeft stem:[\left\{\frac{1}{2} sin \left( 4 p \right) - \frac{1}{2} sin
\left( 2 p \right)\right\}].
...
`++GoniometrieCombineer(sin(p) + cos(p), sin(x))++` geeft stem:[ \left\{\sqrt{2} sin \left( p + \frac{1}{4} \pi \right)\right\}
].
