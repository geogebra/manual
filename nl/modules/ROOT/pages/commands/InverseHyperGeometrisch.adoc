...
InverseHyperGeometrisch( <Populatiegrootte>, <Aantal Successen>, <Steekproefgrootte>, <Waarschijnlijkheid> )::
  ...
  https://en.wikipedia.org/wiki/Hypergeometric_distribution[hypergeometrische variabele] bepaald door
  _Populatiegrootte_, _Aantal Successen_ en _Steekproefgrootte_.
