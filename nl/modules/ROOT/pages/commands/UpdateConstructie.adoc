...
UpdateConstructie( )::
  ...
  Dit is hetzelfde als de toetscombinaties xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] of
...
`++Inzoomen[1]++` gebruiken, wat overeenkomt met de toetscombinatie xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode].
