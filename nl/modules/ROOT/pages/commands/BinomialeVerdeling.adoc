...
[NOTE]
====
- Het algebravenster toont bij een diagram steeds de oppervlakte onder de grafiek als waarde, dus ook bij alle syntaxen van dit commando, ook al heeft het wiskundig geen betekenis om cumulatieve waarden nog eens extra bij elkaar te tellen.  
