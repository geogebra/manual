...
Dit histogram heeft als totale oppervlakte = 0.5*10 + 0.2*10 + 0.1*10 = 8. Deze waarde lees je af in het algebravenster. 
...
de staven is gelijk aan de frequenties van de waarden in elke klasse. In het algebravenster lees je het totaal aantal waarden af.
...
toe om de staafhoogtes te laten overeenstemmen met de relatieve frequentie van elke klasse. Je leest 1 af als waarde van het histogram.
...
van de klasse. In dit geval heeft het bijhorende getal in het algebravenster geen statistische betekenis.
