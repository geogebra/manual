...
De commando's *Oplossen* en xref:/commands/Opkossingen.adoc[Oplossingen] lossen een vergelijking of een stelsel van vergelijkingen symbolisch op voor reële getallen. Om vergelijkingen numeriek op te lossen, gebruik je het commando xref:/commands/NOplossingen.adoc[NOplossingen]. 
