...
[cols=",,",]
|===
|xref:/Schermindelingen.adoc[image:40px-Menu_view_algebra.png[Menu view algebra.png,width=40,height=40]] _Algebra_
|xref:/Schermindelingen.adoc[image:40px-Perspectives_geometry.png[Perspectives geometry.png,width=40,height=40]] _Meetkunde_
|xref:/Schermindelingen.adoc[image:40px-Menu_view_spreadsheet.png[Menu view spreadsheet.png,width=40,height=40]] _Rekenblad_

|xref:/Schermindelingen.adoc[image:40px-Menu_view_cas.png[Menu view cas.png,width=40,height=40]] _CAS_
|xref:/Schermindelingen.adoc[image:40px-Perspectives_algebra_3Dgraphics.png[Perspectives algebra
3Dgraphics.png,width=40,height=40]] _3D venster_ |xref:/Schermindelingen.adoc[image:40px-Menu_view_probability.png[Menu view
...
De schermindeling _Algebra_ bestaat uit het xref:/Algebra_venster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view
...
xref:/Algebra_venster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]] _Algebra
...
De schermindeling _Meetkunde_ bestaat uit het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
De schermindeling _Rekenblad_ bestaat uit het xref:/Rekenblad.adoc[image:16px-Menu_view_spreadsheet.svg.png[Menu
...
De schermindeling _CAS_ bestaat uit het xref:/CAS_venster.adoc[image:16px-Menu_view_cas.svg.png[Menu view
...
xref:/Algebra_venster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]]
...
xref:/tools/Waarschijnlijkheidrekening.adoc[image:16px-Menu_view_probability.svg.png[Menu view
...
_xref:/Invoerveld.adoc[Invoerveld]_, een tweede xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
