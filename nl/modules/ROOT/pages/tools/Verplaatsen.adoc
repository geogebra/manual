...
* … het object verwijderen door op xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] te klikken
* … het object verplaatsen met de pijltoetsen (zie xref:/Animatie.adoc[Animatie])

[NOTE]
====

* Je kunt de knop _Verplaatsen_ ook selecteren met de toetsen xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode].
