...
volgende instructies. xref:/Sjabloon__Step.adoc[Sjabloon:Stepselecteer] de knop
xref:/tools/Rechte_door_twee_punten.adoc[Rechte door twee punten], klik op de rechte _l_ in twee punten om de punten _C_
en _D_ te creëren; tegelijk wordt een nieuwe rechte gecreëerd xref:/Sjabloon__Step.adoc[Sjabloon:Step]Gebruik de _Hellingknop_
voor de nieuw gecreëerde rechte xref:/Sjabloon__Step.adoc[Sjabloon:Stepverberg] punt _D_
xref:/Sjabloon__Step.adoc[Sjabloon:Stepverplaats] punt _C_ naar de gewenste positie
