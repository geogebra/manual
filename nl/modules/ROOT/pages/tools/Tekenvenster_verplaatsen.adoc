...
Je kunt ook de achtergrond verplaatsen en de assen herschalen met de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets (MS
Windows: ook xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets) en het te verslepen met de muis, ongeacht welke knop
geselecteerd is.
