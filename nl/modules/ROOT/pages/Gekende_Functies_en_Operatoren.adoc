...
|ℯ (https://nl.wikipedia.org/E_(wiskunde)[het getal van Euler]) |xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]

|ί (https://nl.wikipedia.org/Imaginaire_eenheid[Imaginaire eenheid]) |xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]

|π |xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] of pi

|° (https://nl.wikipedia.org/Booggraad[Graden symbool]) |xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]
