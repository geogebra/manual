...
== [#Tekenvenster]#xref:/Tekenvenster.adoc[image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24]] Tekenvenster#

Het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
...
=== Het xref:/Tekenvenster.adoc[image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24]] Tekenvenster aanpassen
...
=== Tonen van een tweede xref:/Tekenvenster.adoc[image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24]] Tekenvenster

Je kunt een tweede xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
graphics.svg,width=16,height=16]] _Tekenvenster_ openen via het menu _xref:/Beeld_Menu.adoc[Beeld]_. Wanneer twee
...
Met de knoppen in de xref:/Knoppenbalk.adoc[_Knoppenbalk_] kan je muisconstructies maken in het
xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
...
Elk object dat je creëert in het you create in the xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu
view graphics.svg,width=16,height=16]] _Tekenvenster_ heeft ook een algebraïsche voorstelling in het
xref:/Tekenvenster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]]
...
Selecteer de knop xref:/Tekenvenster.adoc[image:16px-Mode_circle2.svg.png[Mode circle2.svg,width=16,height=16]]
_xref:/tools/Cirkel_met_middelpunt_door_punt.adoc[Cirkel met middelpunt door punt]_ en klik twee maal in het
xref:/Tekenvenster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]] _Tekenvenster_.
...
xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
_Tekenvenster_ kan creëren. Elk item in de _xref:/Knoppenbalk.adoc[Gereedschappenbalk]_ staat voor een rolmenu
...
xref:/Tekenvenster.adoc[image:16px-Mode_point.svg.png[Mode point.svg,width=16,height=16]] en knoppen die meetkundige
transformaties uitvoeren in het rolmenu van de knop xref:/Tekenvenster.adoc[image:16px-Mode_mirroratline.svg.png[Mode
...
Je kunt ook objecten creëren in het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
Het _Invoerveld_ kan je zichtbaar maken via het menu _xref:/Beeld_Menu.adoc[Beeld]_.
...
xref:/Algebra_venster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
_xref:/Algebra_venster.adoc[Algebra venster]_.
...
Met de sneltoetsen xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] en xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac
OS:/Sjabloon:KeyCode.adoc[Sjabloon:KeyCode] en xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) kan je geselecteerde objecten
