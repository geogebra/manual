...
toetsencombinaties xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode], xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] of door het
...
Op Mac OS zijn de toetscombinaties voor kopiëren en plakken xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] en
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets tijdens het slepen, dan verschijnt er een dialoogvenster bij het loslaten
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) gebruiken om de gegevens te
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) gebruiken.
...
GeoGebra gebruikt een punt xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] bij decimale getallen, en een komma
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] om velden te scheiden. Controleer vooraf in de databestanden of dat ook daar
het geval is.
...
samen gerangschikt onder de knop xref:/tools/Onderzoek_één_variabele.adoc[image:16px-Mode_onevarstats.svg.png[Mode
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klikken) op deze selectie. Hierop verschijnt een
...
afbakenen met de muis. Klik dan met de rechtermuisknop (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik) op de
...
cellen _A1:D4_ met de muis. Klik dan met de rechtermuisknop (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik) op
