...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] Je kan in GeoGebra eigen macro's aanmaken, gebaseerd op bestaande
...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] In het dialoogvenster xref:/Macro_Manager_dialoogvenster.adoc[Macro beheren]
...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] Hiermee kan je de verschillende knoppenbalken aanpassen.
