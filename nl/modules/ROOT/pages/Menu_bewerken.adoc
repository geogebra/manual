...
Je kunt ook de knop rechts van de xref:/Knoppenbalk.adoc[Knoppenbalk] gebruiken.
...
Keert het tonen of verbergen van de geselecteerde objecten om. xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem]

Toetsencombinatie xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode])

Keert het tonen of verbergen van de labels van de geselecteerde objecten om. xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem]
...
Toetsen xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]
