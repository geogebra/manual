...
Met xref:/Categorie__Macro_s.adoc[Knoppen] kan je nieuwe objecten creëren. Je kunt ze activeren door ze aan te klikken op de
_xref:/Knoppenbalk.adoc[Knoppenbalk]_.

[NOTE]
====

Alle xref:/Categorie__Macro_s.adoc[Knoppen____] hebben ook een overeenkomend xref:/Categorie__Commando_s.adoc[_Commando_] die je
...
Elk xref:/Views.adoc[_venster_] behalve het xref:/Algebra_venster.adoc[image:16px-Menu_view_algebra.svg.png[Menu view
...
Elke _xref:/Knoppenbalk.adoc[Knoppenbalk]_ bestaat uit een aantal rolmenu's waarin meerdere knoppen gegroepeerd
...
Een volledige lijst met beschikbare knoppen vind je op xref:/Categorie__Macro_s.adoc[_Lijst van knoppen_]. Algemene informatie
over knoppenbalken vind je op xref:/Knoppenbalk.adoc[_Knoppenbalk_].
