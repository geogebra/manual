...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] Wanneer de dynamische constructie afhangt van een schuifknop, kan je met dit
...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] Met dit menu-item kan je het tekenvenster opslaan als een
