...
Typ `++(a+b)^2++` in een _Invoerveld_ en klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-toets. Je krijgt als
...
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]: Verrekent je invoer
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]: Verrekent je invoer numeriek
+
[EXAMPLE]
====
...
====
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]: Verwerkt je invoer maar rekent hem niet uit.
+
[EXAMPLE]
====
...
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] balk: voert de vorige output in een nieuwe rij in.
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik) op de kop van een rij:
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-click (MacOS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik), dan rechts te
klikken (MacOS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik) op de rijkop en _Kopieer als LaTeX_ te selecteren.
...
xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]-klik) op een CAS uitvoer:
...
=== CAS Objecten tonen in het xref:/Tekenvenster.adoc[image:20px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=20,height=20]] _Tekenvenster_
...
al dan niet tonen in het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
