...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] xref:/Algebra_View.adoc[image:32px-Menu_view_algebra.svg.png[Menu view
...
xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] xref:/Spreadsheet_View.adoc[image:32px-Menu_view_spreadsheet.svg.png[Menu
view spreadsheet.svg,width=32,height=32]] Hiermee open of sluit je het xref:/Rekenblad.adoc[Rekenblad].

Toetsencombinatie xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode])

xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] xref:/CAS_View.adoc[image:32px-Menu_view_cas.svg.png[Menu view
cas.svg,width=32,height=32]] Hiermee open of sluit je het xref:/CAS_venster.adoc[CAS venster].

Toetsencombinatie xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode])

xref:/Sjabloon__Menuitem.adoc[Sjabloon:Menuitem] xref:/Graphics_View.adoc[image:32px-Menu_view_graphics.svg.png[Menu view
