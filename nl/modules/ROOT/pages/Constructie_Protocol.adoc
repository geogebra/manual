...
* Klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] pijltoets om naar de vorige constructiestap te gaan.
* Klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] pijltoets om naar de volgende constructiestap te gaan.
* Klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets om naar de eerste constructiestap te gaan.
* Klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets om naar de laatste constructiestap te gaan.
* Klik op de xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] toets om de geselecteerde stap te verwijderen.
