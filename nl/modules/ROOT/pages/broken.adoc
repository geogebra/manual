 ...
 ** xref:commands/3D commando's[commands/3D comma]
* commands/Cone.adoc:
 ...
 ** xref:commands/Kansrekening_Commando_s.adoc[commands/Kansrekening_Commando_s]
...
* commands/TToets.adoc:
 
 ** xref:commands/Statistiek_Commando_s.adoc[commands/Statistiek_Commando_s]
