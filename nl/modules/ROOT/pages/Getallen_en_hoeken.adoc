...
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) voor graden °
* xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] (Mac OS: xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]) voor π
