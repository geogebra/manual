...
geopend naast het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
klikken op xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode] verschijnt je invoer in het
image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] _Algebra venster_ terwijl tegelijk ook de
grafische voorstelling ervan getoond wordt in het xref:/Tekenvenster.adoc[image:16px-Menu_view_graphics.svg.png[Menu
...
dat hierop verschijnt, kan je rechtstreeks het object aanpassen. Na klikken op xref:/Sjabloon__KeyCode.adoc[Sjabloon:KeyCode]
