 ...
 ** xref:commands/BinomniKoeficijent.adoc[commands/BinomniKoeficijent]
* `++\sqrt\{5}++`:
 ...
 ** xref:commands/EksponencijalnaRazdioba.adoc[commands/EksponencijalnaRazdioba]
* `++\sqrt\{2}e^\{\frac{i\pi}{4}}++`:
 
 ** xref:commands/EksponencijalniZapis.adoc[commands/EksponencijalniZapis]
* `++\frac\{n(n+3)}2++`:
 
 ** xref:commands/ImplicitnaKrivulja.adoc[commands/ImplicitnaKrivulja]
* `++2 \sqrt\{2} a++`:
 
 ** xref:commands/IntegralIzmeđu.adoc[commands/IntegralIzmeđu]
* `++2 \sqrt\{2}++`:
 
 ** xref:commands/IntegralIzmeđu.adoc[commands/IntegralIzmeđu]
* `++\frac{-b}{\sqrt\{a^\{2} + b^\{2}}}++`:
 
 ** xref:commands/JediničniOkomitVektor.adoc[commands/JediničniOkomitVektor]
* `++\frac{a}{\sqrt\{a^\{2} + b^\{2}}}++`:
 
 ** xref:commands/JediničniOkomitVektor.adoc[commands/JediničniOkomitVektor]
 ** xref:commands/JediničniVektor.adoc[commands/JediničniVektor]
* `++\frac{b}{\sqrt\{a^\{2} + b^\{2}}}++`:
 
 ** xref:commands/JediničniVektor.adoc[commands/JediničniVektor]
* `++a_kx^k+a_\{k-1}x^\{k-1}+\cdots+a_1x+a_0++`:
 
 ** xref:commands/Koeficijenti.adoc[commands/Koeficijenti]
 ** xref:commands/Koeficijenti.adoc[commands/Koeficijenti]
* `++\sqrt\{3}++`:
 
 ** xref:commands/Maksimum.adoc[commands/Maksimum]
 ** xref:commands/PolarneKoordinate.adoc[commands/PolarneKoordinate]
 ** xref:commands/PolarneKoordinate.adoc[commands/PolarneKoordinate]
* `++\sqrt\{2}++`:
 
 ** xref:commands/Minimum.adoc[commands/Minimum]
 ** xref:commands/SD.adoc[commands/SD]
 ** xref:commands/StandardnaDevijacija.adoc[commands/StandardnaDevijacija]
* `++0.5 erf(-\sqrt\{2}) + 0.5++`:
 
 ** xref:commands/NormalnaRazdioba.adoc[commands/NormalnaRazdioba]
* `++1.871\approx \sqrt\{3.5}++`:
 
 ** xref:commands/OčekivanaTSrednjaVrijednost.adoc[commands/OčekivanaTSrednjaVrijednost]
* `++2\left|\frac\{t}2-\mathrm round\left(\frac\{t}2\right)\right|++`:
 
 ** xref:commands/PostaviBoju.adoc[commands/PostaviBoju]
 ** xref:commands/PostaviBojuPozadine.adoc[commands/PostaviBojuPozadine]
* `++\frac\{N}2++`:
 
 ** xref:commands/PostaviDebljinuCrte.adoc[commands/PostaviDebljinuCrte]
* `++\frac\{cos(3) x^\{3} (2 y - 6) + sin(3) x^\{3} (-y^\{2} + 6 y - 7)}\{2}++`:
 
 ** xref:commands/TaylorovPolinom.adoc[commands/TaylorovPolinom]
* `++(-1)^\{1.5}++`:
 
 ** xref:commands/UkloniNedefinirano.adoc[commands/UkloniNedefinirano]
* `++(-1)^\{2.5}++`:
 
 ** xref:commands/UkloniNedefinirano.adoc[commands/UkloniNedefinirano]
* `++\frac\{2 a^\{2} - 6 a + 6}\{9}++`:
 
 ** xref:commands/Varijanca.adoc[commands/Varijanca]
* `++\sum_\{t=s}^\{e}f(t)++`:
 
 ** xref:commands/Zbroj.adoc[commands/Zbroj]
* `++\frac\{r^\{n+1} - 1}\{r - 1}++`:
