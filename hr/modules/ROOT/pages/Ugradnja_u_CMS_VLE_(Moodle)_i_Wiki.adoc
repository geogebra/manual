...
Druga je opcija postaviti vaš dinamični uradak na https://www.geogebra.org/[GeoGebra], što sada možete lako napraviti iz
...
xref:/Tutorijal__Glavna_stranica.adoc[Tutorijal:Glavna stranica] za detalje.
