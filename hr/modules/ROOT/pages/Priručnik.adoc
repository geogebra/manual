...
ili xref:/Naredbe.adoc[naredbe]. xref:/Tutorijal__Glavna_stranica.adoc[Turorijali] vas mogu voditi kroz vaše prve
konstrukcije.
...
* xref:/Kategorija__Alati.adoc[Popis alata]

=== Naredbe

* xref:/Naredbe.adoc[O naredbama]
* xref:/Kategorija__Naredbe.adoc[Popis naredbi]
...
* spremiti u xref:/En__Reference__File_Format.adoc[GeoGebra formatu]
