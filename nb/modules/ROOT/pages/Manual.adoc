...
xref:/Verktøy.adoc[verktøy] eller xref:/Kommandoer.adoc[kommandoer]. xref:/Opplæring__Hovedside.adoc[Opplæring:Hovedside] kan
...
* xref:/Kategori__Verktøy.adoc[Liste av verktøy]

=== Kommandoer

* xref:/Kommandoer.adoc[Om kommandoer]
* xref:/Kategori__Kommandoer.adoc[Liste av kommandoer]
...
* lagre den i xref:/En__Reference__File_Format.adoc[GeoGebras filformat]
...
opplasting
* laste opp konstruksjonen til https://www.geogebra.org[GeoGebra]

xref:/En__Manual.adoc[en:Manual]
xref:/No__Manual.adoc[no:Manual]
xref:/Nn__Manual.adoc[nn:Manual]
