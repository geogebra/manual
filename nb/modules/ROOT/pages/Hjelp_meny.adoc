...
Dette punktet åpner xref:/Manual__Hovedside.adoc[startsiden] til denne hjelpewikien i nettleseren din.

== Opplæring

Dette punktet åpner xref:/Opplæring__Hovedside.adoc[veiledningssiden] til denne hjelpewikien i nettlesaren din.

== GeoGebra

Dette punktet åpner https://www.geogebra.org/[GeoGebra] i nettlesaren din. Der kan du finne arbeidsark, verktøy og
https://www.geogebra.org/type/9/p1/created/desc[GeoGebra-bøker] som andre brukere har delt.

== Rapporter feil

Dette punktet åpner https://www.geogebra.org/bugs/?v=4.4[forumet] hvor du kan rapportere feil direkte til utviklerne av
GeoGebra.
