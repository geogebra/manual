...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssiden] og last ned deb-filen.
...
ned fra https://www.geogebra.org/cms/nb[hjemmesiden]. Framgangsmetoden for dette er vist under xref:/.adoc[Detaljert
fremgangsmetode].
...
`++wget https://www.geogebra.org/download/?os=unix -O GeoGebra-Unixlike-Installer.tar.gz++`
...
* https://www.geogebra.org/download/?os=mac[Last ned geogebra]
* Pakk den ut
...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssiden] og velg *Mac OS X*.
...
* https://www.geogebra.org/download/?os=win[Last ned] siste versjon
* Kjør filen
...
Gå til https://www.geogebra.org/cms/nb/download[nedlastingssiden] og velg *Windows*.
...
Åpne Chrome og gå til https://www.geogebra.org/cms/nb/download/[nedlastingssiden]. Velg *GeoGebra Chrome App*.
...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssiden] og velg *Java Webstart*.
...
for nettbrett ved å surfe på nettbrettet til https://www.geogebra.org/cms/nb/[Geogebras nettside] og klikke på *Last
ned*.
