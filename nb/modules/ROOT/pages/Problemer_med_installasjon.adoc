...
Webstart finner du på https://www.geogebra.org/cms/nb/download/[nedlastingssiden]. Her er en
https://www.geogebra.org/webstart/geogebra.jnlp[direktelink] til webstarten.
...
* {blank}
** Startmeny -> Kjør -> javaws -verbose -import -shortcut -association https://www.geogebra.org/webstart/geogebra.jnlp

*Linux eller Mac*

* Åpne en terminal
* javaws -verbose -import -shortcut -association https://www.geogebra.org/webstart/geogebra.jnlp
