...
(Werkzeug)]
* xref:/tools/Polygonzug.adoc[image:24px-Mode_polyline.svg.png[Mode polyline.svg,width=24,height=24]]
xref:/tools/Polygonzug.adoc[Streckenzug (Werkzeug)]
...
* xref:/tools/Parallele_Gerade.adoc[image:24px-Mode_parallel.svg.png[Mode parallel.svg,width=24,height=24]]
...
* xref:/tools/Spiegle_an_Gerade.adoc[image:24px-Mode_mirroratline.svg.png[Mode mirroratline.svg,width=24,height=24]]
...
(Werkzeug)]
* xref:/tools/Freihandskizze.adoc[image:24px-Mode_freehandshape.svg.png[Mode
freehandshape.svg,width=24,height=24]] xref:/tools/Freihandskizze.adoc[Freihandskizze erkennen (Werkzeug)]
...
* xref:/tools/Verschiebe_Grafik_Ansicht.adoc[image:24px-Mode_translateview.svg.png[Mode
translateview.svg,width=24,height=24]] xref:/tools/Verschiebe_Grafik_Ansicht.adoc[Verschiebe Zeichenblatt (Werkzeug)]
