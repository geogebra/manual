...
* xref:/Wahrscheinlichkeitsrechner.adoc[image:24px-Mode_probabilitycalculator.svg.png[Mode
probabilitycalculator.svg,width=24,height=24]] xref:/Wahrscheinlichkeitsrechner.adoc[Wahrscheinlichkeitsrechner
(Werkzeug)]

== Werkzeuge für Listen und Tabellen

* xref:/tools/Liste.adoc[image:24px-Mode_createlist.svg.png[Mode createlist.svg,width=24,height=24]]
xref:/tools/Liste.adoc[Liste erzeugen (Werkzeug)]
* xref:/tools/Liste_von_Punkten.adoc[image:24px-Mode_createlistofpoints.svg.png[Mode
createlistofpoints.svg,width=24,height=24]] xref:/tools/Liste_von_Punkten.adoc[Liste von Punkten erzeugen
(Werkzeug)]
* xref:/tools/Matrix.adoc[image:24px-Mode_creatematrix.svg.png[Mode creatematrix.svg,width=24,height=24]]
xref:/tools/Matrix.adoc[Matrix erzeugen (Werkzeug)]
* xref:/tools/Tabelle.adoc[image:24px-Mode_createtable.svg.png[Mode createtable.svg,width=24,height=24]]
xref:/tools/Tabelle.adoc[Tabelle erzeugen (Werkzeug)]
* xref:/tools/Polygonzug.adoc[image:24px-Mode_createpolyline.svg.png[Mode
createpolyline.svg,width=24,height=24]] xref:/tools/Polygonzug.adoc[Polygonzug erzeugen (Werkzeug)]
...
* xref:/tools/Anzahl.adoc[image:24px-Mode_countcells.svg.png[Mode countcells.svg,width=24,height=24]]
xref:/tools/Anzahl.adoc[Zähle (Werkzeug)]
