...
[cols=",,",]
|===
|<<algebra-perspective,image:40px-Menu_view_algebra.png[Algebra,width=40,height=40]>> _<<algebra-perspective,Algebra>>_
|<<geometry-perspective,[image:40px-Perspectives_geometry.png[Geometrie,width=40,height=40]>> _<<geometry-perspective,Geometrie>>_
|<<spreadsheet-perspective,image:40px-Menu_view_spreadsheet.png[Tabelle,width=40,height=40]>> _<<spreadsheet-perspective,Tabelle>>_

|<<cas-perspective,image:40px-Menu_view_cas.png[CAS,width=40,height=40]>> _<<cas-perspective,CAS>>_
|<<perspective-3d,image:40px-Perspectives_algebra_3Dgraphics.png[3D Grafik,width=40,height=40]>> _<<perspective-3d,3D Grafik>>_
|<<prob-perspective,image:40px-Menu_view_probability.png[Probability,width=40,height=40]>> _<<prob-perspective,Statistik>>_
|===
