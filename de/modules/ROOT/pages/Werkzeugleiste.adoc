...
[cols=",",]
|===
|xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Grafik-Ansicht-Werkzeugleiste_]
|xref:/Werkzeuge_der_Grafik_Ansicht.adoc[image:344px-Toolbar-Graphics.png[Toolbar-Graphics.png,width=344,height=32]]

|xref:/3D_Grafik_Werkzeuge.adoc[_Werkzeugleiste der 3D Grafik-Ansicht_]
|xref:/3D_Grafik_Werkzeuge.adoc[image:398px-Toolbar-3D-Graphics.png[Toolbar-3D-Graphics.png,width=398,height=32]]

|xref:/CAS_Werkzeuge.adoc[_CAS-Ansicht-Werkzeugleiste_]
|xref:/CAS_Werkzeuge.adoc[image:315px-Toolbar-CAS.png[Toolbar-CAS.png,width=315,height=32]]

|xref:/Tabellenkalkulationswerkzeuge.adoc[_Tabellenkalkulations-Werkzeugleiste_]
|xref:/Tabellenkalkulationswerkzeuge.adoc[image:146px-Toolbar-Spreadsheet.png[Toolbar-Spreadsheet.png,width=146,height=32]]
|===
