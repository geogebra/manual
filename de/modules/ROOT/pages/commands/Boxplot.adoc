...
BoxPlot( <yAbstand>, <ySkalierung>, <Liste von Rohdaten>, <Boolsche Ausreißer> )::
  Dies ermöglicht, dass http://en.wikipedia.org/wiki/de:Ausrei%C3%9Fer[Ausreißer] als "X" dargestellt werden, anstatt im
  Box-Plot inkludiert zu sein. "Ausreißer" sind dabei jene Daten, die unterhalb von _Q1 - 1.5 * [Q3 - Q1]_ bzw. oberhalb
  _Q3 + 1.5 * [Q3 - Q1]_ liegen (siehe auch http://en.wikipedia.org/wiki/IQR[IQR]).
