...
ZufallszahlGleichverteilt( <Min>, <Max> )::
  Liefert eine reelle Zufallszahl einer http://en.wikipedia.org/wiki/de:Stetige_Gleichverteilung[Gleichverteilung] im
...
ZufallszahlGleichverteilt( <Min>, <Max>, <Stichprobenanzahl n> )::
  ...
  http://en.wikipedia.org/wiki/de:Stetige_Gleichverteilung[Gleichverteilung] im gegebenen Intervall [_min_, _max_].
