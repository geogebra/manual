...
Stichprobenvarianz( <Liste von Rohdaten> )::
  Berechnet die http://en.wikipedia.org/wiki/de:Stichprobenvarianz[Stichprobenvarianz] der angegebenen Zahlen.
...
Stichprobenvarianz( <Liste von Zahlen>, <Liste von Häufigkeiten> )::
  Berechnet die http://en.wikipedia.org/wiki/de:Stichprobenvarianz[Stichprobenvarianz] der angegebenen Zahlen abhängig
  ihrer Häufigkeiten.
