...
KürzesterPfad( <Liste von Strecken>, <Startpunkt>, <Endpunkt>, <Wahrheitswert Gewichtung> )::
  ...
  http://en.wikipedia.org/wiki/de:Graph_(Graphentheorie)[Graphen], der durch die Strecken bestimmt ist. Ist der
  Wahrheitswert _false_, so ist das http://en.wikipedia.org/wiki/de:Glossar_Graphentheorie#Gewicht[Gewicht] jeder Kante
