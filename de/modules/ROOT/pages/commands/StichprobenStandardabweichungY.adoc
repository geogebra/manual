...
StichprobenStandardabweichungY( <Liste von Punkten> )::
  Berechnet die
  https://de.wikipedia.org/wiki/Stichprobenstandardabweichung#Sch.C3.A4tzung_der_Standardabweichung_der_Grundgesamtheit_aus_einer_Stichprobe[Stichprobenstandardabweichung]
