...
Dieser Befehl faktorisiert Ausdrücke über den http://en.wikipedia.org/wiki/de:Rationale_Zahl[rationalen Zahlen]. Um über
irrationale Zahlen zu faktorisieren siehe den Befehl xref:/commands/IFaktorisiere.adoc[IFaktorisiere]. Um über den
