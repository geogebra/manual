...
Zeta( <Anzahl der Elemente>, <Exponent> )::
  Erzeugt ein Balkendiagramm einer http://en.wikipedia.org/wiki/de:Zeta-Verteilung[Zeta-Verteilung]. (Englisch:
  http://en.wikipedia.org/wiki/Zipf%27s_law[Zipf's law])
  _Parameter:_
...
Zeta( <Anzahl der Elemente>, <Exponent>, <Wahrheitswert Verteilungsfunktion> )::
  ...
  Erzeugt ein Balkendiagramm einer kumulativen http://en.wikipedia.org/wiki/de:Zeta-Verteilung[Zeta-Verteilung], wenn
