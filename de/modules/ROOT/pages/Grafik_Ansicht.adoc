...
== image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24] Benutzeroberfläche der Grafik-Ansicht
...
=== image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24] Anpassen der Grafik-Ansicht
...
=== Anzeigen einer zweiten image:24px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24] Grafik-Ansicht
...
festlegen, in welcher / welchen image:16px-Menu_view_graphics.svg.png[Menu view
...
Mithilfe der xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Konstruktionswerkzeuge_], die sich in der
...
den angezeigten Tooltip, um herauszufinden, wie das aktivierte xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Werkzeug_] verwendet wird.

[NOTE]
====

Alle Objekte, die Sie in der image:16px-Menu_view_graphics.svg.png[Menu view
...
Aktivieren Sie das Werkzeug image:16px-Mode_circle2.svg.png[Mode
circle2.svg,width=16,height=16] _xref:/tools/Kreis_mit_Mittelpunkt_durch_Punkt.adoc[Kreis mit Mittelpunkt durch Punkt]_
und klicken Sie zweimal in die image:16px-Menu_view_algebra.svg.png[Menu view
...
Die xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Werkzeugleiste der Grafik-Ansicht_] bietet Ihnen eine Vielzahl an
_xref:/Werkzeuge.adoc[Werkzeugen]_. Die unterschiedlichen Werkzeuge ermöglichen es Ihnen graphische Darstellungen von
Objekten direkt in der image:16px-Menu_view_graphics.svg.png[Menu view
...
xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Konstruktionswerkzeugen_] beinhaltet. Um einen _Werkzeugkasten_ zu öffnen, müssen Sie das
...
Sie können ein Objekt in der image:16px-Menu_view_graphics.svg.png[Menu view
...
xref:/Algebra_Ansicht.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
