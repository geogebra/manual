...
Die vielen verschiedenen xref:/Kategorie__Werkzeuge.adoc[_Werkzeuge_] von GeoGebra machen es Ihnen einfach neue
xref:/Kategorie__Objekte.adoc[_mathematische Objekte_] zu erstellen. Aktivieren Sie die Werkzeuge, indem Sie die entsprechende
Schaltfläche in der _xref:/Werkzeugleiste.adoc[Werkzeugleiste]_ auswählen.

[NOTE]
====

Es gibt zu allen xref:/Kategorie__Werkzeuge.adoc[_Werkzeugen_] auch xref:/Kategorie__Befehle.adoc[_äquivalente Befehle_], die sich
...
xref:/Werkzeuge_der_Grafik_Ansicht.adoc[_Werkzeugleiste der Grafik-Ansicht_]
...
aus einem Werkzeug oder mehreren miteinander verwandten xref:/Kategorie__Werkzeuge.adoc[_Werkzeugen_]. Sie können einen
...
Weitere Informationen zu den Werkzeugen finden Sie in der xref:/Kategorie__Werkzeuge.adoc[vollständigen Liste aller
