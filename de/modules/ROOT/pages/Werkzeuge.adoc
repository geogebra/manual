...
mathematische Objekte zu erstellen. Aktivieren Sie die Werkzeuge, indem Sie die entsprechende
Schaltfläche in der _xref:/Werkzeugleiste.adoc[Werkzeugleiste]_ auswählen.

[NOTE]
====

Es gibt zu allen _Werkzeugen_ auch xref:/Befehle.adoc[_äquivalente Befehle_], die sich
...
aus einem Werkzeug oder mehreren miteinander verwandten _Werkzeugen_. Sie können einen
...
Informieren Sie sich auch über xref:/Werkzeugleiste.adoc[_Werkzeugleisten_],
