...
image:Ambox_content.png[image,width=40,height=40] Cette fonctionnalité n'est plus accessible dans les versions postérieures à la 5.2.904.2 du 27 octobre 2025.
__________________________________________________________

Vous pouvez aussi renommer un objet en faisant dessus un clic droit, puis en sélectionnant le menu image:Rename.png[Rename.png] en 5, ou image:18px-Menu-edit-rename.svg.png[18px-Menu-edit-rename.svg.png,width=18,height=18] en 6 _Renommer_,

ou en ouvrant le dialogue des xref:/Dialogue_Propriétés.adoc[_Propriétés ..._] et en saisissant le nouveau nom dans le champ
