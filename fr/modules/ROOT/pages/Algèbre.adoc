...
xref:/Objets_libres_dépendants_ou_auxiliaires.adoc[_Objets auxiliares _] in the image:16px-Menu_view_algebra.svg.png[Menu
...
criteria:
** _Dependency_: The mathematical objects are organized as xref:/Objets_libres_dépendants_ou_auxiliaires.adoc[_Objets libres_] and xref:/Objets_libres_dépendants_ou_auxiliaires.adoc[_Objets dépendants _]. If you create a new object without
