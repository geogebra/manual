...
Dans la fenêtre image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] xref:/Algebre.adoc[Algèbre] vous en lisez l’équation de la droite support.
