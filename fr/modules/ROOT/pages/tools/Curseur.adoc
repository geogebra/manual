...
nombre ou d’un angle libre]. Vous pouvez aisément créer un curseur à partir de n’importe quel nombre ou
...
sont fixés par défaut. Vous pouvez en modifier la valeur par un simple clic dessus.
