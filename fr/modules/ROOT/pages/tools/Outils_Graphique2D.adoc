...
|image:Mode_freehandshape1.png[Mode freehandshape1.png,width=32,height=32]
...
mirroratcircle.svg,width=32,height=32] |image:Mode_image1.png[Mode image1.png,width=32,height=32]
|image:32px-Mode_zoomout.svg.png[Mode zoomout.svg,width=32,height=32]

|image:Mode_pen1.png[Mode pen1.png,width=32,height=32] |image:32px-Mode_intersect.svg.png[Mode
