...
fonction ou une courbe vous créez un point sur cet objet (voir aussi l'outil image:32px-Mode_pointonobject.svg.png[Mode pointonobject.svg,width=32,height=32] xref:/tools/Point_sur_Objet.adoc[Point sur Objet] et
