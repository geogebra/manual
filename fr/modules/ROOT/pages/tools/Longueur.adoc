...
/Fichier:Mode_countcells_svg.adoc[image:32px-Mode_countcells.svg.png[Mode countcells.svg,width=32,height=32]] (code
2042), dans la Boîte à outils par défaut /Fichier:Mode_sumcells_svg.adoc[image:32px-Mode_sumcells.svg.png[Mode
