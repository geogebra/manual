...
pause.svg,width=16,height=16] *la rotation de la vue*: Vous pouvez, à l'aide du curseur affiché, en préciser le sens et la vitesse.

* image:16px-Stylingbar_graphics3D_rotateview_play.svg.png[Stylingbar graphics3D rotateview play.svg,width=16,height=16]
*Démarrer* ou *arrêter* image:16px-Stylingbar_graphics3D_rotateview_pause.svg.png[Stylingbar graphics3D rotateview
pause.svg,width=16,height=16] *la rotation de la vue* image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _ Graphique 3D_. Vous pouvez, à l'aide d'un curseur, en préciser le sens et la vitesse.
