...
Graphique 3D_] est affichée au sommet de la fenêtre GeoGebra ainsi que les boutons _Annuler / Refaire _dans le coin
supérieur droit.
...
En plus de la multitude de xref:/commands/Toutes_les_commandes.adoc[_Commandes_] utilisables dans les autres  _xref:/VuesEx.adoc[fenêtres]_
de GeoGebra, il y a aussi une sélection de _Commandes 3D _ spécifiques à _Graphique 3D _.

[EXAMPLE]
====

Soit `++A=(2, 2, 0)++`, `++B=(-2, 2, 0)++`, `++C=(0, -2, 0)++`, et `++D=(0, 0, 3)++`. Taper la commande
`++Pyramide[A, B, C, D]++` et puis valider par [.kcode]#Entrée# pour créer la pyramide de base _ABC_ et sommet _D_.
...
Utiliser le image:16px-Stylingbar_icon_graphics3D.svg.png[Stylingbar icon graphics3D.svg,width=16,height=12] _Bouton Barre Style Graphique 3D_ pour la faire apparaître avec les options :


* image:16px-Stylingbar_graphics3D_axes_plane.svg.png[Stylingbar graphics3D axes plane.svg,width=16,height=16] *Afficher ou cacher les axes et le plan xOy*
...
axes.svg,width=16,height=16] seuls les axes sont affichés ;
** image:16px-Stylingbar_graphics3D_plane.svg.png[Stylingbar graphics3D plane.svg,width=16,height=16] seul le plan xOy est
affiché ;
...
grid.svg,width=16,height=16] *Afficher ou cacher la grille* du plan _xOy_.
* image:16px-Stylingbar_graphicsview_standardview.svg.png[Stylingbar graphicsview standardview.svg,width=16,height=16] *Retour à la vue par défaut*
...
* image:16px-Stylingbar_graphics3D_view_orthographic.svg.png[Stylingbar graphics3D view
orthographic.svg,width=16,height=16] *Choisir le type de projection parmi :*
** image:16px-Stylingbar_graphics3D_view_orthographic.svg.png[Stylingbar graphics3D view
orthographic.svg,width=16,height=16] _Projection 'Parallèle'_ ;
** image:16px-Stylingbar_graphics3D_view_perspective.svg.png[Stylingbar graphics3D view perspective.svg,width=16,height=16]
_Perspective_ ; 
** image:16px-Stylingbar_graphics3D_view_glases.svg.png[Stylingbar graphics3D view
glases.svg,width=16,height=16] _Projection 'pour lunettes'_ ;
** image:16px-Stylingbar_graphics3D_view_oblique.svg.png[Stylingbar graphics3D view oblique.svg,width=16,height=16]
_Projection 'Oblique'_.


* image:16px-Stylingbar_graphics3D_rotateview_play.svg.png[Stylingbar graphics3D rotateview play.svg,width=16,height=16]
*Démarrer* ou *arrêter* image:16px-Stylingbar_graphics3D_rotateview_pause.svg.png[Stylingbar graphics3D rotateview
pause.svg,width=16,height=16] *la rotation de la vue* image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _Graphique 3D_ . Vous pouvez, à l'aide du curseur affiché, en préciser le sens et la vitesse.

* image:16px-Stylingbar_graphicsview_point_capturing.svg.png[Stylingbar graphicsview point
capturing.svg,width=16,height=16]  *Capture d'un point* : Automatique/ Approché de la Grille/ Attaché à la Grille/Désactivé. Plus d'informations dans _xref:/Capture_Point.adoc[Capture Point]_.

* image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] Ouvre le _xref:/Dialogue_Propriétés.adoc[Dialogue
Propriétés]_ pour la vue  image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _Graphique 3D_ ou un objet sélectionné.
...
[NOTE]
====
La gestion de l'**Espace Restreint** est au bas de l'onglet _Basique_ du image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] _xref:/Dialogue_Propriétés.adoc[Dialogue Propriétés]_:
[cols=",,,",]
|===
|_Espace Restreint_|||

|_Utiliser Espace Restreint_|       |  _Afficher Espace Restreint_ | 

|_Taille Espace Restreint_ |||

|_Petite_ |      _Moyenne_ |     _Large_|
|===
...
[NOTE]
====
à partir de 727, éviter le zoom dans Graphique 3D, mais permettre de déplacer les axes

créer 6 curseurs  a, b, c, d, e, et f et les affecter comme valeurs à xMin, xMax, yMin, yMax, zMin, et zMax respectivement dans la fenêtre Préférences > Graphique 3D > Dimensions
