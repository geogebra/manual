...
* l'utilisation de l 'outil /Fichier:Tool_Locus_gif.adoc[image:Tool_Locus.gif[Tool Locus.gif,width=32,height=32]]
xref:/tools/Lieu.adoc[Lieu] pour le lieu d'un point dépendant d'un point appartenant à un objet ;
...
Un *lieu géométrique* possède la propriété xref:/Propriétés_d'un_objet.adoc[Remplissage] ce qui fait de lui un outil
détourné pour le coloriage de formes quelconques délimitées par un chemin continu fermé.

Un exemple :

[[ggbContainer4b9492be1090e812accd1040742f0f94]]
