...
La fonction doit être continue et définie sur son ensemble de définition classique, (des restrictions ne doivent pas lui être appliquées) et n'avoir, sur l'intervalle, qu'un seul _minimum local_  et pas de maximum local.
