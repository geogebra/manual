...
|5 |https://fr.wikipedia.org/Cercle_d%27Euler[Centre du cercle d'Euler] (cercle des neuf points)

|6 |https://fr.wikipedia.org/Sym%C3%A9diane#Point_de_Lemoine[Point de Lemoine]

|7 |https://fr.wikipedia.org/Cercles_inscrit_et_exinscrits_d%27un_triangle#Point_de_Gergonne[Point de Gergonne]

|8 |https://fr.wikipedia.org/Cercles_inscrit_et_exinscrits_d%27un_triangle#Point_de_Nagel[Point de Nagel]

|13 |https://fr.wikipedia.org/Point_de_Fermat[Point de Fermat d'un triangle dont les angles sont inférieurs à
120°]
|===
