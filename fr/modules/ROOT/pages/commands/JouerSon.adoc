...
`++JouerSon("#J2sQQfwQ")++` joue un https://www.geogebra.org/m/J2sQQfwQ[son.mp3 qui a été téléversé] sur GeoGebra ;
...
voir https://www.geogebra.org/m/wztkqxuv par exemple. Il doit commencer par la chaîne `++data:audio/mp3;base64,++` pour fonctionner dans GeoGebra Classique 5.
...
JouerSon( <Chaîne Notes>, <Instrument> )::
  ...
  Les commandes de base sont données ci-dessous. 
