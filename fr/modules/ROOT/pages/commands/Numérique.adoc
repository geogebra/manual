...
image:Tool_tool.png[Tool tool.png,width=32,height=32] Voir aussi l'*outil*  image:32px-Mode_nsolve.svg.png[Mode nsolve.svg,width=32,height=32] xref:/tools/Outil_Numérique.adoc[Numérique].
