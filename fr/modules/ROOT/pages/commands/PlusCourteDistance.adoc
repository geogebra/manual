...
PlusCourteDistance( <Liste Segments>, <Départ>, <Arrivée>, <Booléen pondéré> )::
  ...
  http://en.wikipedia.org/wiki/fr:Graphe_simple[graphe] défini par la liste des segments.

Si http://en.wikipedia.org/wiki/fr:Lexique_de_la_th%C3%A9orie_des_graphes#P[_pondéré_] = *false*, chaque segment compte
