...
AléaUniforme( <Min>, <Max> )::
  Retourne un nombre aléatoire à partir d'une https://fr.wikipedia.org/Loi_uniforme_continue[distribution
...
AléaUniforme( <Min>, <Max>, <Nombre de tirages n> )::
  ...
  https://fr.wikipedia.org/Loi_uniforme_continue[distribution uniforme] sur l'intervalle [min,max].
