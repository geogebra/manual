...
`++NRésoudre(cos(x) = x)++` retourne _{x = 0.7390851332152}_ ( Option : 15 décimales).
...
* `++NRésoudre(sin(x) = x)++` retourne _{x = 0, x = 4.760636329593 10^^-13^}_ (Option : 15 décimales).
* `++NRésoudre(a^4+34a^3-34, a)++` retourne _{a = -34, a = 0.99}_.
====
...
* `++NRésoudre(cos(x) = x, x = 0)++` retourne _{x = 0.74}_
...
`++NRésoudre({π / x = cos(x - 2y), 2 y - π = sin(x)}, {x=3, y=1.5})++` retourne _{x = 3.141592651686591, y =
1.570796327746508}_.
...
`++NRésoudre({π / x = cos(x - 2y), 2 y - π = sin(x)}, {x, y})++` retourne par exemple _{x = -179.91, y = 1.94}
