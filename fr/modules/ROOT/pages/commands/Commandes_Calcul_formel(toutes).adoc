...
* xref:/commands/PolynômeAuHasard.adoc[PolynômeAuHasard]
* xref:/commands/PolynômeCaractéristique.adoc[PolynômeCaractéristique], xref:/commands/PolynômeMinimal.adoc[PolynômeMinimal]
...
* xref:/commands/Quartile1.adoc[Quartile1], xref:/commands/Quartile2.adoc[Quartile2]
