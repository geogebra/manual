...
[cols=",,,,",options="header",]
|===
|Algèbre |/Fichier:Menu_view_cas_svg.adoc[image:24px-Menu_view_cas.svg.png[Menu view cas.svg,width=24,height=24]]CAS
(dédiées) |Calculs & Fonctions |GeoGebra |Géométrie
