...
*Exemple :* image:Equa1PasAPas.png[Equa1PasAPas.png,width=283,height=420]
...
*Exemple :* image:VerifEqua.PNG[VerifEqua.PNG,width=303,height=347] Je vérifie que pour la valeur de 'x' trouvée, le
...
*Exemple :* image:CasRadicaux.PNG[CasRadicaux.PNG,width=302,height=183] Entre l'appui sur le bouton
