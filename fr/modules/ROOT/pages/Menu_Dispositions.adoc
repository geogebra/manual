...
|image:24px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=24,height=24] |_Graphique3D_: |xref:/Algèbre.adoc[Algèbre] et xref:/Graphique_3D.adoc[Graphique3D] (avec les axes présents).

|image:24px-Menu_view_probability.svg.png[Menu view probability.svg,width=24,height=24] |_Probabilités_: |La fenêtre du
xref:/tools/Calculs_Probabilités.adoc[Calculs de probabilités] est affichée.
|===
