...
les nouveaux objets seront dessinés dans le calque de numéro le plus grand - avec une exception pour le calque 9 (ainsi vous pouvez le réserver pour les objets devant toujours être au-dessu des autres)
