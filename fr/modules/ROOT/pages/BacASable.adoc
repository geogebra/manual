...
[width=100%, cols="10%,25%,10%,10%,10%,10%,25%", options= "header"]
|===
|Touche|Raccourci|DW|WW|WM|DM|Action

|A |[.kcode]#Touche# + [.kcode]#A# |stem:[\huge{\checkmark}]|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|Tout sélectionner
...
|C |[.kcode]#Touche# + [.kcode]#C# |stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|Copier 

||[.kcode]#Touche# + [.kcode]#Alt# + [.kcode]#C#|stem:[\huge{\checkmark}]| | |stem:[\huge{\checkmark}]|Copier valeurs (Tableur)

| |[.kcode]#Touche# + [.kcode]#Maj# + [.kcode]#C# |stem:[\huge{\checkmark}]| | |stem:[\huge{\checkmark}]|Copier ‘Graphique’ vers le presse-papiers

|D |[.kcode]#Touche# + [.kcode]#D#|stem:[\huge{\checkmark}]|stem:[\huge{\checkmark}]|  |stem:[\huge{\checkmark}]|Basculer valeur/définition/commande
...
|E |[.kcode]#Touche# + [.kcode]#E#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |Ouvrir Dialogue Propriétés

||[.kcode]#Alt# + [.kcode]#E#|stem:[\huge{\checkmark}]||||C^ste^ Euler ℯ

|F |[.kcode]#Touche# + [.kcode]#F# |stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|Rafraîchir l’affichage

| |[.kcode]#Alt# + [.kcode]#F# |stem:[\huge{\checkmark}]||||phi φ (Pressez [.kcode]#Maj# pour majuscule: Φ)

|G |[.kcode]#Touche# + [.kcode]#G#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |Afficher/Cacher les objets sélectionnés.
...
|I |[.kcode]#Alt# + [.kcode]#I#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |ί pour complexes

|J |[.kcode]#Touche# + [.kcode]#J# |stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|Sélectionner les descendants
...
|K |[.kcode]#Touche# + [.kcode]#Maj# + [.kcode]#K#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |Ouvre/ferme la fenêtre Calcul formel

|L |[.kcode]#Alt# + [.kcode]#L#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]||lambda λ (Pressez [.kcode]#Maj# pour majuscule: Λ)

| |[.kcode]#Touche# + [.kcode]#Maj# + [.kcode]#L# |stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|Bascule affichage du Protocole de construction

|M |[.kcode]#Touche# + [.kcode]#Maj# + [.kcode]#M#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |(Exporter la chaîne ggbBase64 dans le presse-papiers ?).
...
|N |[.kcode]#Touche# + [.kcode]#N# |stem:[\huge{\checkmark}]|||[stem:[\huge{\checkmark}]|Ouvrir Nouvelle fenêtre
...
|O |[.kcode]#Touche# + [.kcode]#O#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]||[stem:[\huge{\checkmark}] |Ouvrir un fichier

| |[.kcode]#Alt# + [.kcode]#O# |stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]||symbole degré °

|P |[.kcode]#Touche# + [.kcode]#P#|stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}]||[stem:[\huge{\checkmark}] |Aperçu avant impression(Desktop) Impress Menu(web)

| |[.kcode]#Touche# + [.kcode]#Maj# + [.kcode]#P#|stem:[\huge{\checkmark}]||[stem:[\huge{\checkmark}]|[stem:[\huge{\checkmark}] |Ouvrir le dialogue Calculs de Probabilités
