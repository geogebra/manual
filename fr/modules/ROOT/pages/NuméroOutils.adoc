...
| | |6 |image:gomme.png[gomme.png,width=32,height=32] xref:/tools/Effacer.adoc[Effacer]
|===
...
Barre d'outils développée, complète, xref:/tools/Outils_Graphique3D.adoc[ici]
...
|image:revol.png[revol.png,width=32,height=32]|538| | | | | | | | | | | |
