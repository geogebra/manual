...
|image:32px-Mode_move.svg.png[Mode move.svg,width=32,height=32]|xref:/tools/Déplacer.adoc[Déplacer] image:32px-Phone_move.png[Phone move.png,width=24,height=24] |$\checkmark$ image:OK.png[OK.pn,width=24,height=24]|image:OK.png[OK.pn,width=24,height=24]|image:OK.png[OK.pn,width=24,height=24]|
