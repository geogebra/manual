...
|xref:/Fonction_PartieFractionnaire.adoc[Partie fractionnaire]
...
|xref:/Fonction_NRacine.adoc[Racine n ^ème^]
...
|NRacine(x,n) |image:NRacine.PNG[NRacine.PNG,width=154,height=67]
