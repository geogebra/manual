...
* Sélectionnez /Fichier:Tool_Show_Hide_Label_gif.adoc[image:Tool_Show_Hide_Label.gif[Tool Show Hide
Label.gif,width=32,height=32]] l'xref:/tools/Afficher_cacher_l'étiquette.adoc[outil Afficher/cacher l'étiquette] et
clique sur l'objet dont vous voulez afficher ou cacher l'étiquette.
