= LaTeX-aide Polices Boites math [Outils]
:sectnums:
...
[EXAMPLE]
====
{\scriptsize A}{\footnotesize B}{\small C}{\normalsize D}{\large E}{\Large F}{\LARGE G}{\huge H}{\Huge I} image:LTX1.PNG[LTX1.PNG,width=139,height=38]
====
...
[EXAMPLE]
==== 
\text{{\Huge GeoGebra}, le plus puissant, {\small depuis }}\oldstylenums{ 2001-2012}  image:LTX2fr.PNG[LTX2fr.PNG,width=432,height=41]
====
...
[EXAMPLE]
====
\scalebox{2}{\text{{\Huge GeoGebra}, le plus puissant, {\small depuis }}\oldstylenums{ 2001-2012}}image:LTX3fr.PNG[LTX3fr.PNG,width=858,height=70]
====
...
[EXAMPLE]
====
\text{{\rm GeoGebra}{\sf ,le plus puissant}, {\tt depuis }}\oldstylenums{ 2001-2025} image:LTX4fr.PNG[LTX4fr.PNG,width=331,height=24]
====
...
\text{\textcolor{a}C\textcolor{b}O\textcolor{c}L\textcolor{d}O\textcolor{e}U\textcolor{f}R} image:LTEX7a.PNG[LTEX7a.PNG,width=113,height=37]
====
...
[EXAMPLE]
====
\rotatebox{45}{\fcolorbox{blue}{red}{2012\text{ c'est maintenant !}} image:LTX8fr.PNG[LTX8fr.PNG,width=134,height=139]
====
...
[EXAMPLE]
====
\reflectbox{\fcolorbox{blue}{red}{2012\text{ c'est maintenant !}} image:LTX9fr.PNG[LTX9fr.PNG,width=169,height=31]
====
...
image:envJlatex.png[envJlatex.png,width=451,height=30]
...
image:Refemele.PNG[Refemele.PNG,width=305,height=104]
====
