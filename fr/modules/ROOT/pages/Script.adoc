...
* Consultez une démo des scripts https://www.geogebra.org/m/bek5uqah[En cas de changement et Par Actualisation]﻿﻿ pour un ChampTexte.

* Consultez une démo de script https://www.geogebra.org/m/kxgvyqvj[En Fin Glisser] pour un point déplaçable.
====
