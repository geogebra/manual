...
[cols=",,",]
|===
|xref:/Perspektifler.adoc[image:40px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=40,height=40]]
xref:/Perspektifler.adoc[_Cebir_] |xref:/Perspektifler.adoc[image:40px-Perspectives_geometry.svg.png[Perspectives
geometry.svg,width=40,height=40]] xref:/Perspektifler.adoc[_Geometri_]
|xref:/Perspektifler.adoc[image:40px-Menu_view_spreadsheet.svg.png[Menu view spreadsheet.svg,width=40,height=40]]
xref:/Perspektifler.adoc[_Hesap Tablosu_]

|xref:/Perspektifler.adoc[image:40px-Menu_view_cas.svg.png[Menu view cas.svg,width=40,height=40]]
xref:/Perspektifler.adoc[_CAS_] |xref:/Perspektifler.adoc[image:40px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives
algebra 3Dgraphics.svg,width=40,height=40]] xref:/Perspektifler.adoc[_3D Grafik_]
|xref:/Perspektifler.adoc[image:40px-Menu_view_probability.svg.png[Menu view probability.svg,width=40,height=40]]
...
image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16]__xref:/Tercihler_Diyaloğu.adoc[Tercihler
