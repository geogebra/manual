...
xref:/Cebir_Görünümü.adoc[image:24px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=24,height=24]]
...
xref:/Grafik_Görünümü.adoc[image:24px-Menu_view_graphics.png[Menu view graphics.png,width=24,height=24]]
...
a|
xref:/CAS_Görünümü.adoc[image:24px-Menu_view_cas.svg.png[Menu view cas.svg,width=24,height=24]]
...
a|
xref:/Hesap_Çizelgesi_Görünümü.adoc[image:24px-Menu_view_spreadsheet.svg.png[Menu view spreadsheet.svg,width=24,height=24]]
