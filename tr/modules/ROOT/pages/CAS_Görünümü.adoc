...
anlamına gelir. Detaylar için <<atamalar,atamalar hakkındaki bölüme>> bakın.
...
Bu klavye kısa yollarını kullanmak yerine <<CAS_Görünümü_Araç_Çubuğu,_CAS Görünümü Araç Çubuğunda_>> bunlara karşılık gelen
