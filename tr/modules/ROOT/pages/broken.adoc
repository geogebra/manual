...
* Kategori__Komutlar.adoc:
 
 ** xref:3D_Grafik_Görünümü.adoc[3D_Grafik_Görünümü]
 ** xref:Araçlar.adoc[Araçlar]
* Kategori__Araçlar.adoc:
 ...
 ** xref:Dosya_Menüsü.adoc[Dosya_Menüsü]
 ** xref:Dosya_Menüsü.adoc[Dosya_Menüsü]
* en_Special__Upload?wpDestFile=İmage_x_generic_png.adoc:
 ...
 ** xref:Katmanlar.adoc[Katmanlar]
* tools/Noktadan_vektör.adoc:
 
 ** xref:Noktalar_ve_Vektörler.adoc[Noktalar_ve_Vektörler]
* en_Special__Upload?wpDestFile=İnterval_left_png.adoc:
 
 ** xref:Olasılık_Hesap_Makinesi.adoc[Olasılık_Hesap_Makinesi]
* en_Special__Upload?wpDestFile=İnterval_between_png.adoc:
 
 ** xref:Olasılık_Hesap_Makinesi.adoc[Olasılık_Hesap_Makinesi]
* en_Special__Upload?wpDestFile=İnterval_right_png.adoc:
