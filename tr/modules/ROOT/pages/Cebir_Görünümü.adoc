...
Görünümünde_ bu doğrusal denklemi ve xref:/Grafik_Görünümü.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
hem de xref:/Grafik_Görünümü.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
