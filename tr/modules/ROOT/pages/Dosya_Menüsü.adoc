...
xref:/Open_Dialog_Style_Templates.adoc[Style Template File] (file name extension
GGB), GeoGebra tool (file name extension GGT) or dynamic worksheet (HTM or HTML file produced by GeoGebra) that is saved
on your computer.

It also allows you to open and xref:/Open_Dialog_Insert_File.adoc[insert a
...
xref:/Export_Worksheet_Dialog.adoc[Dynamic Worksheet as Webpage (html)...]
* xref:/en_Special__Upload?wpDestFile=İmage_x_generic_png.adoc[Dosya:İmage-x-generic.png]
xref:/Export_Graphics_Dialog.adoc[Graphics View as Picture (png, eps)…]
...
This menu item opens the xref:/Print_Preview_Dialog.adoc[Print Preview window]
for the xref:/Grafik_Görünümü.adoc[Graphics View]. You may specify Title, Author,
