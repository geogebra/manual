...
|ℯ (http://en.wikipedia.org/wiki/tr:E_say%C4%B1s%C4%B1[Euler sayısı]) |[.kcode]#Alt# + [.kcode]#e#

|ί (http://en.wikipedia.org/wiki/tr:%C4%B0_say%C4%B1s%C4%B1[Sanal birim]) |[.kcode]#Alt# + [.kcode]#i#

|π |[.kcode]#Alt# + [.kcode]#p# veya pi

|° (http://en.wikipedia.org/wiki/tr:Derece_simgesi[Derece sembolü]) |[.kcode]#Alt# + [.kcode]#o# veya deg
...
|http://en.wikipedia.org/wiki/Atan2[Ark tanjant (cevap radyan cinsinden, -π ve π arasında)] |atan2(y, x)

|http://en.wikipedia.org/wiki/Atan2[Ark tanjant (cevap derece cinsinden, -180° ve 180° arasında)] |atan2d(y, x)
...
|http://en.wikipedia.org/wiki/tr:Gama_fonksiyonu[Gama fonksiyonu Γ(x)] |gamma( x)
...
|http://en.wikipedia.org/wiki/tr:Hata_fonksiyonu[Gauss Hata Fonksiyonu] |erf(x)

|http://en.wikipedia.org/wiki/tr:Digama_fonksiyonu[Digama fonksiyonu] |psi(x)
