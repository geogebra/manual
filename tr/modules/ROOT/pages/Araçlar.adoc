...
xref:/Cebir_Görünümü.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]]
...
xref:/Araç_Çubuğu.adoc[_Toolbars_], creating
_xref:/Custom_Tools.adoc[Custom Tools]_ and
xref:/Araç_Çubuğu.adoc[Customizing the Toolbar].
...
clicking on the corresponding buttons of the _xref:/Araç_Çubuğu.adoc[Toolbar]_.
...
Each xref:/Görünümler.adoc[_View_] except the
xref:/Cebir_Görünümü.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]]
_xref:/Cebir_Görünümü.adoc[Algebra View]_ has its own _Toolbar_, providing _Tools_
...
Once you start using another xref:/Görünümler.adoc[_View_] within the GeoGebra
window, the _xref:/Araç_Çubuğu.adoc[Toolbar]_ changes automatically. If you open
another _View_ in a separate window, it will have its
_xref:/Araç_Çubuğu.adoc[Toolbar]_ attached.

== Toolboxes

Each _xref:/Araç_Çubuğu.adoc[Toolbar]_ is divided into _Toolboxes_, containing one
...
xref:en@reference::/File_Format.adoc[GeoGebra Worksheet (*.ggb)]. See
xref:/Araç_Çubuğu.adoc[Customizing the Toolbar] for details.
