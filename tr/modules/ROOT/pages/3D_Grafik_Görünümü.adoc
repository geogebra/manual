...
_xref:/Tercihler_Diyaloğu.adoc[Tercihler Diyaloğu]_,
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _3D Grafik
...
_xref:/Merkez_ve_Nokta_ile_Küre_Araç.adoc[Merkez ve Nokta ile Küre Aracını]_
...
xref:/Kategori__Komutlar.adoc[_Komutlara_], ek olarak _3D Grafik Görünümüne_ özel _3D Komutlar_ da vardır.
