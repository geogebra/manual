...
xref:/Grafik_Görünümü.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
_xref:/Grafik_Görünümü.adoc[Grafik Görünümü]_ veya xref:/Cebir_Görünümü.adoc[image:16px-Menu_view_algebra.svg.png[Menu
view algebra.svg,width=16,height=16]] _xref:/Cebir_Görünümü.adoc[Cebir Görünümü]_ etkinken gösterilir.

[NOTE]
====

Pek çok inşa _Aracı_ ile xref:/Grafik_Görünümü.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
Daha fazla bilgi için lütfen xref:/Kategori__Araçlar.adoc[mevcut GeoGebra _Araçlarının_ tam listesinin] yanı sıra
...
* xref:/tools/Taşı.adoc[image:24px-Mode_move.svg.png[Mode move.svg,width=24,height=24]] xref:/tools/Taşı.adoc[Taşı Aracı]
...
* xref:/tools/Noktayı_Bağla_Ayır.adoc[image:24px-Mode_attachdetachpoint.svg.png[Mode
attachdetachpoint.svg,width=24,height=24]] xref:/tools/Noktayı_Bağla_Ayır.adoc[Noktayı Bağla / Ayır Aracı]
* xref:/tools/İki_nesnenin_kesişimi.adoc[image:24px-Mode_intersect.svg.png[Mode intersect.svg,width=24,height=24]]
...
* xref:/tools/Karmaşık_Sayı.adoc[image:24px-Mode_complexnumber.svg.png[Mode complexnumber.svg,width=24,height=24]]
...
* xref:/tools/Kökler.adoc[image:24px-Mode_roots.svg.png[Mode roots.svg,width=24,height=24]] xref:/tools/Kökler.adoc[Kökler
Aracı]

== Doğru Araçları

* xref:/tools/Doğru.adoc[image:24px-Mode_join.svg.png[Mode join.svg,width=24,height=24]] xref:/tools/Doğru.adoc[Doğru
Aracı]
...
* xref:/tools/Çoklu_Doğru.adoc[image:24px-Mode_polyline.svg.png[Mode polyline.svg,width=24,height=24]]
...
* xref:/tools/Noktadan_Vektör.adoc[image:24px-Mode_vectorfrompoint.svg.png[Mode
...
* xref:/tools/Teğet.adoc[image:24px-Mode_tangent.svg.png[Mode tangent.svg,width=24,height=24]]
...
* xref:/tools/Çokgen.adoc[image:24px-Mode_polygon.svg.png[Mode polygon.svg,width=24,height=24]]
xref:/tools/Çokgen.adoc[Çokgen Aracı]
* xref:/tools/Düzgün_Çokgen.adoc[image:24px-Mode_regularpolygon.svg.png[Mode regularpolygon.svg,width=24,height=24]]
xref:/tools/Düzgün_Çokgen.adoc[Düzgün Çokgen Aracı]
* xref:/tools/Bükülmez_Çokgen.adoc[image:24px-Mode_rigidpolygon.svg.png[Mode rigidpolygon.svg,width=24,height=24]]
...
Aracı]
* xref:/tools/Pergel.adoc[image:24px-Mode_compasses.svg.png[Mode compasses.svg,width=24,height=24]]
...
* xref:/tools/Elips.adoc[image:24px-Mode_ellipse3.svg.png[Mode ellipse3.svg,width=24,height=24]]
xref:/tools/Elips.adoc[Elips Aracı]
* xref:/tools/Hiperbol.adoc[image:24px-Mode_hyperbola3.svg.png[Mode hyperbola3.svg,width=24,height=24]]
xref:/tools/Hiperbol.adoc[Hiperbol Aracı]
* xref:/tools/Parabol.adoc[image:24px-Mode_parabola.svg.png[Mode parabola.svg,width=24,height=24]]
...
* xref:/tools/Açı.adoc[image:24px-Mode_angle.svg.png[Mode angle.svg,width=24,height=24]] xref:/tools/Açı.adoc[Açı
Aracı]
* xref:/tools/Verilen_Ölçüde_Açı.adoc[image:24px-Mode_anglefixed.svg.png[Mode anglefixed.svg,width=24,height=24]]
xref:/tools/Verilen_Ölçüde_Açı.adoc[Verilen Ölçüde Açı Aracı]
* xref:/tools/Uzaklık_veya_Uzunluk.adoc[image:24px-Mode_distance.svg.png[Mode distance.svg,width=24,height=24]]
xref:/tools/Uzaklık_veya_Uzunluk.adoc[Uzaklık veya Uzunluk Aracı]
* xref:/tools/Alan.adoc[image:24px-Mode_area.svg.png[Mode area.svg,width=24,height=24]] xref:/tools/Alan.adoc[Alan Aracı]
* xref:/tools/Eğim.adoc[image:24px-Mode_slope.svg.png[Mode slope.svg,width=24,height=24]] xref:/tools/Eğim.adoc[Eğim
Aracı]
...
* xref:/tools/İlişki.adoc[image:24px-Mode_relation.svg.png[Mode relation.svg,width=24,height=24]]
...
* xref:/tools/Sürgü.adoc[image:24px-Mode_slider.svg.png[Mode slider.svg,width=24,height=24]]
...
* xref:/tools/Yakınlaştır.adoc[image:24px-Mode_zoomin.svg.png[Mode zoomin.svg,width=24,height=24]]
xref:/tools/Yakınlaştır.adoc[Yakınlaştır Aracı]
* xref:/tools/Uzaklaştır.adoc[image:24px-Mode_zoomout.svg.png[Mode zoomout.svg,width=24,height=24]]
xref:/tools/Uzaklaştır.adoc[Uzaklaştır Aracı]
* xref:/tools/Nesneyi_Göster_Gizle.adoc[image:24px-Mode_showhideobject.svg.png[Mode showhideobject.svg,width=24,height=24]]
xref:/tools/Nesneyi_Göster_Gizle.adoc[Nesneyi Göster / Gizle Aracı]
* xref:/tools/Etiketi_Göster_Gizle.adoc[image:24px-Mode_showhidelabel.svg.png[Mode showhidelabel.svg,width=24,height=24]]
