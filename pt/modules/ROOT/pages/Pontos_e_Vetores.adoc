...
xref:/Novo_ponto.adoc[Novo ponto], image:Tool_Vector_from_Point.gif[Tool Vector
from Point.gif,width=32,height=32] xref:/Vetor_a_Partir_de_um_Ponto.adoc[Vetor a
Partir de um Ponto], image:Tool_Vector_between_Two_Points.gif[Tool Vector between Two Points.gif,width=32,height=32]
xref:/Vetor_Definido_por_Dois_Pontos.adoc[Vetor Definido por Dois Pontos] e uma
...
xref:/Número_Complexo.adoc[Número Complexo] "a+bί", então `++A + 1++` resulta em
_a + 1 + bί_.
