...
* Con la herramienta xref:/tools/Mostrar_Ocultar_objeto.adoc[image:32px-Mode_showhideobject.svg.png[Mode
showhideobject.svg,width=32,height=32]] xref:/tools/Mostrar_Ocultar_objeto.adoc[Mostrar/ocultar objeto].
