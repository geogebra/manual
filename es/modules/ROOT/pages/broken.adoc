 ...
 ** xref:tools/Tetraedro_regular.adoc[tools/Tetraedro_regular]
* Referencia__Parámetros_Applet.adoc:
 ...
 ** xref:Exportar_Gráficos.adoc[Exportar_Gráficos]
 ** xref:Menú_Archivo.adoc[Menú_Archivo]
* Categoría__Comandos_exclusivos_CAS.adoc:
 ...
 ** xref:commands/Raíces.adoc[commands/Raíces]
 ...
 ** xref:Herramientas.adoc[Herramientas]
 ** xref:Herramientas.adoc[Herramientas]
* Referencia__Formato_Archivo.adoc:
 
 ** xref:Herramientas.adoc[Herramientas]
* Categoría__Herramientas.adoc:
...
* Tutorial__Instalación_e_Introducción_Construir_Dibujos.adoc:
 ...
 ** xref:Manual.adoc[Manual]
* Referencia__Instalación_de_GeoGebra.adoc:
 
 ** xref:Manual.adoc[Manual]
* Compatibilidad.adoc:
 
 ** xref:Manual.adoc[Manual]
* Categoría__Comandos_CAS.adoc:
 ...
 ** xref:commands/PuntoInflexión.adoc[commands/PuntoInflexión]
 ...
 ** xref:Objetos.adoc[Objetos]
* Comentarios__Núm_HerramientasES.adoc:
 ...
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:tools/Circunferencia_(centro_dirección_radio).adoc[tools/Circunferencia_(centro_dirección_radio)]
...
* Categoría__Objetos.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Iconos.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Referencia__Xml.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Algebra_desde_la_Barra_de_Entrada.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Referencia__Vistas.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
* Tutorial__Visibilidad_Condicional_y_Secuencias.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Selección_de_Objetos.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Comando.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
* Comentarios__Comando_CondiciónParaMostrarObjeto.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Modalidad_del_Objeto.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Tutorial__Hacia_el_Algebra_desde_la_Barra.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Tutorial.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Comando_CasillaDeEntrada.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Objetos_de_Acción.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Etiquetas.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Excluir_de_Impresión.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Herramienta_de_Inserta_Botón.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Comandos_de_Guiones_Scripting.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Tutorial__Listas_Secuencias_y_Guiones_para_Jugar.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Manual__Referencias_y_Cuadros_de_Diálogo.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Comentarios__Comando_Sombreado.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Manual__Hoja_de_Cálculo.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Manual__Barra_de_Entrada.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Propiedades_de_Objeto.adoc:
 
 ** xref:Objetos_de_Acción.adoc[Objetos_de_Acción]
* Categoría__Tutoriales.adoc:
 ...
 ** xref:Protocolo_de_Construcción.adoc[Protocolo_de_Construcción]
* Fr__Protocole_de_construction.adoc:
...
* Es__Category__Comandos.adoc:
 
 ** xref:Vista_3D.adoc[Vista_3D]
* Categoría__Comandos_Específicos_CAS_(Cálculo_Avanzado).adoc:
 ...
 ** xref:tools/Derivada.adoc[tools/Derivada]
 ** xref:tools/Derivada.adoc[tools/Derivada]
 ** xref:tools/Integral.adoc[tools/Integral]
 ** xref:tools/Integral.adoc[tools/Integral]
 ** xref:tools/Resolución_Numérica.adoc[tools/Resolución_Numérica]
 ** xref:tools/Resolución_Numérica.adoc[tools/Resolución_Numérica]
 ** xref:tools/Sustituye.adoc[tools/Sustituye]
 ** xref:tools/Sustituye.adoc[tools/Sustituye]
* Referencia__Colores.adoc:
 
 ** xref:commands/Color.adoc[commands/Color]
 ** xref:commands/ColorFondo.adoc[commands/ColorFondo]
 ...
 ** xref:commands/Comandos_de_Estadística.adoc[commands/Comandos_de_Estadística]
* en_Special__Upload?wpDestFile=Ejemplo_jpg.adoc:
 
 ** xref:commands/Curva.adoc[commands/Curva]
* Referencia__Croquis.adoc:
 
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
* Categoría__Publishing.adoc:
 
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
* GeoGebra_Manual__AlRespecto.adoc:
 ...
 ** xref:tools/Cónica_por_cinco_puntos.adoc[tools/Cónica_por_cinco_puntos]
 ** xref:tools/Cónica_por_cinco_puntos.adoc[tools/Cónica_por_cinco_puntos]
 ** xref:tools/Desplaza_Vista_Gráfica.adoc[tools/Desplaza_Vista_Gráfica]
 ** xref:tools/Desplaza_Vista_Gráfica.adoc[tools/Desplaza_Vista_Gráfica]
 ** xref:tools/Homotecia.adoc[tools/Homotecia]
 ** xref:tools/Homotecia.adoc[tools/Homotecia]
 ** xref:tools/Intersección_de_dos_superficies.adoc[tools/Intersección_de_dos_superficies]
 ** xref:tools/Intersección_de_dos_superficies.adoc[tools/Intersección_de_dos_superficies]
 ** xref:tools/Parábola.adoc[tools/Parábola]
 ** xref:tools/Parábola.adoc[tools/Parábola]
 ** xref:tools/Pirámide_o_Cono_desde_su_base.adoc[tools/Pirámide_o_Cono_desde_su_base]
 ...
 ** xref:tools/Tetraedro_regular.adoc[tools/Tetraedro_regular]
 ** xref:tools/Tetraedro_regular.adoc[tools/Tetraedro_regular]
 ** xref:tools/Volumen.adoc[tools/Volumen]
 ** xref:tools/Volumen.adoc[tools/Volumen]
* Categoría__Extension_help.adoc:
 
 ** xref:commands/Cúbica.adoc[commands/Cúbica]
* Manual__Página_Principal.adoc:
...
* Categoría__Iconos_de_Herramientas.adoc:
 
 ** xref:commands/ImagenHerramienta.adoc[commands/ImagenHerramienta]
* En__w__Log_normal.adoc:
 
 ** xref:commands/LogNormalInversa.adoc[commands/LogNormalInversa]
* Tutorial__Orden_de_Listas_Avanzado.adoc:
 
 ** xref:commands/Ordena.adoc[commands/Ordena]
* Tutorial__Recorriendo_Parámetros_y_Trayectos.adoc:
...
* Es__w__Números_reales.adoc:
 
 ** xref:commands/Raíces.adoc[commands/Raíces]
* Pista__Contando_Aleatorias_Resoluciones.adoc:
 ...
 ** xref:tools/Sector_Tres_Puntos.adoc[tools/Sector_Tres_Puntos]
 ** xref:tools/Sector_Tres_Puntos.adoc[tools/Sector_Tres_Puntos]
* Comentarios__GeoGebra_Windows_Tablet_App_Videos.adoc:
 ...
 ** xref:tools/Tetraedro_regular.adoc[tools/Tetraedro_regular]
 ** xref:tools/Volumen.adoc[tools/Volumen]
* Manual__Notas_Lanzamiento_de_GeoGebra_5_0.adoc:
 ...
 ** xref:tools/Polígono_vectorial.adoc[tools/Polígono_vectorial]
 ** xref:tools/Punto_en_Objeto.adoc[tools/Punto_en_Objeto]
* Pista__Rígidos_Armados.adoc:
 
 ** xref:tools/Polígono_rígido.adoc[tools/Polígono_rígido]
* Plantilla__TABu.adoc:
 
 ** xref:tools/Registro_en_Hoja_de_Cálculo.adoc[tools/Registro_en_Hoja_de_Cálculo]
* Tutorial__Textos_en_la_Vista_Gráfica.adoc:
 ...
 ** xref:commands/TortugaDerecha.adoc[commands/TortugaDerecha]
 ** xref:commands/TortugaIzquierda.adoc[commands/TortugaIzquierda]