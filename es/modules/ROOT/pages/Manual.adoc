...
== ¡Elige tu aplicación GeoGebra favorita!

GeoGebra ofrece varias https://www.geogebra.org[Aplicaciones Matemáticas]para enseñar y aprender en todos los niveles
educativos. Este manual abarca los xref:/Comandos.adoc[comandos] y xref:/Herramientas.adoc[herramientas] de nuestra
aplicación image:20px-Geogebra-logo.svg.png[Geogebra-logo.svg,width=20,height=20] https://www.geogebra.org[GeoGebra] .

Puede que te interesen también nuestras otras aplicaciones:

image:20px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=20,height=20] https://www.geogebra.org/graphing[GeoGebra
...
https://www.geogebra.org/geometry[GeoGebra Geometría] y los https://www.geogebra.org/m/m6rgmhvq[tutoriales de GeoGebra
Geometría].

image:20px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=20,height=20]
https://www.geogebra.org/3d[GeoGebra 3D] y los https://www.geogebra.org/m/fuznheva[tutoriales de GeoGebra 3D].

== Interfaz del usuario en GeoGebra Clásico

El siguiente apartado refiere a nuestra aplicación
image:20px-Geogebra-logo.svg.png[Geogebra-logo.svg,width=20,height=20] https://www.geogebra.org/classic[GeoGebra
Clásico], que puede utilizarse https://www.geogebra.org/classic[en línea] o también puede
https://www.geogebra.org/download[descargarse].

=== xref:/Vistas.adoc[Vistas] y xref:/Apariencias.adoc[Apariencias]

image:20px-Geogebra-logo.svg.png[Geogebra-logo.svg,width=20,height=20] https://www.geogebra.org/classic[GeoGebra Clásico]
...
|xref:/Calculadora_de_probabilidades.adoc[image:32px-Menu_view_probability.svg.png[Menu view
probability.svg,width=32,height=32]]xref:/Calculadora_de_probabilidades.adoc[Calculadora de Probabilidades]
|===
...
https://www.geogebra.org/classic[GeoGebra Clásico] a las preferencias personales, modificando la
...
https://www.geogebra.org/classic[GeoGebra Clásico] también ofrece una variedad de xref:/Cuadros_de_Diálogo.adoc[Cuadros
...
https://www.geogebra.org/classic[GeoGebra Clásico], echa un vistazo a nuestros
https://www.geogebra.org/m/MqVqGRux[tutoriales de GeoGebra Clásico]. Te encontrarás con guías paso a paso y aprenderás a
usar image:20px-Geogebra-logo.svg.png[Geogebra-logo.svg,width=20,height=20] https://www.geogebra.org/classic[GeoGebra
...
* La xref:/Referencia__Instalación_de_GeoGebra.adoc[guía de instalación] responde preguntas acerca de la instalación de
...
* Visita nuestro https://www.geogebra.org/forum[foro de usuarios] si tienes alguna pregunta o sugerencia.
