...
*https://www.geogebra.org/[Volver a GeoGebra]* &#0151; *xref:/Envío_a_GeoGebra.adoc[Volver a Ayuda de Página Inicial]*

GeoGebra es el nombre de la plataforma para https://www.geogebra.org%7Ccompartir[materiales de GeoGebra]. Se pueden subir
archivos https://www.geogebra.org%7Cdirectamente[desde aquí] sea para compartirlos con docentes y estudiantes o para
