...
* xref:/commands/EnvolventeConvexa.adoc[CierreConvexo]
...
La posibilidad de dar xref:/Propiedades_de_Objeto.adoc[_opacidad_] al lugar geométrico, desde la pestaña [.kcode]#Color# de la
Caja de Diálogo de xref:/Propiedades_de_Objeto.adoc[Propiedades de Objeto] ofrece una alternativa para _colorear_ lo creado.Es
