...
Para más información, se puede acceder a la xref:/Categoría__Herramientas.adoc[lista completa de herramientas de GeoGebra],
...
* xref:en@manual::tools/Complex_Number.adoc[image:24px-Mode_complexnumber.svg.png[Mode complexnumber.svg,width=24,height=24]]
xref:en@manual::tools/Complex_Number.adoc[Número Complejo]
...
* xref:/tools/Figura_a_Mano_Alzada.adoc[image:24px-Mode_freehandshape.svg.png[Mode freehandshape.svg,width=24,height=24]]
