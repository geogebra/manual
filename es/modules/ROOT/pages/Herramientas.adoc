...
xref:/Referencia__Formato_Archivo.adoc[archivo de GeoGebra (*.ggb)]. Por más información, consultar cómo
xref:/Barra_de_herramientas.adoc[personalizar la barra de herramientas].

== Más información sobre Herramientas

Para más información puede consultarse la xref:/Categoría__Herramientas.adoc[lista completa de todas herramientas
