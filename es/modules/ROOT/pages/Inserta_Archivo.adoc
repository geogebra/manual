...
*xref:/Tutorial__Instalación_e_Introducción_Construir_Dibujos.adoc[Tutorial:]* _¿Cómo distinguir entre Construcción y Dibujo?_
[.small]##

xref:/Tutorial__Instalación_e_Introducción_Construir_Dibujos.adoc[Lista de Tutoriales]
