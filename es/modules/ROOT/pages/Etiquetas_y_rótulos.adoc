...
xref:/tools/Mostrar_Ocultar_etiqueta.adoc[Mostrar / Ocultar Etiquta] y haciendo clic sobre el objeto cuya etiqueta se desea
mostrar u ocultar.
* Tildando o quitando el tilde a image:22px-Mode_showhidelabel.svg.png[Mode showhidelabel.svg,width=22,height=22]
xref:/tools/Mostrar_Ocultar_etiqueta.adoc[_Etiqueta visible_] en el xref:/Menú_contextual.adoc[menú contextual] del objeto
en cuestión.
...
xref:/tools/Mostrar_Ocultar_etiqueta.adoc[_Etiqueta visible_] de la pestaña *Básico*.
