...
== image:24px-Menu_view_probability.png[Menu view probability.png,width=24,height=24] xref:/Calculadora_de_probabilidades.adoc[Calculadora de Probabilidad]
...
de xref:/Categoría__Comandos_exclusivos_CAS.adoc[comandos exclusivos], muchos de los de empleo general
presentan un comportamiento xref:/Categoría__Comandos_CAS.adoc[específico] cuando se
...
probability.png,width=24,height=24] xref:/Calculadora_de_probabilidades.adoc[de Probabilidades] y la del
...
probability.png,width=24,height=24] xref:/Calculadora_de_probabilidades.adoc[Cálculo de probabilidades] como la del
image:20px-Menu_view_construction_protocol.png[Menu view construction protocol.png,width=20,height=20]
