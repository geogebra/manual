...
se operará la reflexión. 'image:GGb5.png[GGb5.png,width=47,height=42] Obra del xref:/GeoGebra_Manual__AlRespecto.adoc[mismo
modo] en image:Menu_view_graphics3D.png[Menu view graphics3D.png,width=24,height=24]
xref:/Comentarios__GeoGebra_Windows_Tablet_App_Videos.adoc[la Vista
3]xref:/Comentarios__GeoGebra_Windows_Tablet_App_Videos.adoc[[.kcode]#D#] xref:/GeoGebra_Manual__AlRespecto.adoc[de]
xref:/Comentarios__GeoGebra.adoc[GG] http://wiki.geogebra.org/uploads/2/20/GG_5_web_y_tablet_LMS_lianasaidon.pdf[5]
