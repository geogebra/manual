...
xref:/Tutorial__Textos_en_la_Vista_Gráfica.adoc[tutorial de Textos vía su Herramienta], en la que se puede anotar un texto,
...
Texto]La guía tutorial gráfica xref:/Tutorial__Textos_en_la_Vista_Gráfica.adoc[Textos vía su Herramienta]Breve animación, en
