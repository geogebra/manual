...
también la xref:/Herramientas.adoc[herramienta] xref:/tools/Figura_a_Mano_Alzada.adoc[image:23px-Mode_freehandshape.svg.png[Mode
freehandshape.svg,width=23,height=23]] xref:/tools/Figura_a_Mano_Alzada.adoc[Croquis].
