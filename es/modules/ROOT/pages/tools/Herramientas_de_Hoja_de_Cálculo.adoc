...
spreadsheet.svg,width=16,height=16]] xref:/Vista_de_Hoja_de_Cálculo.adoc[_Vista Hoja de Cálculo_] y proporciona las siguientes _herramientas_.
...
probabilitycalculator.svg,width=24,height=24]] xref:/tools/Calculadora_de_probabilidades.adoc[Calculadora de probabilidades]
