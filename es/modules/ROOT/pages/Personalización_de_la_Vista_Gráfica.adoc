...
Ver la sección posterior <<propiedades-vista-grafica,al respecto>>.
...
xref:/Propiedades_de_Objeto.adoc[visibilidad] para más xref:/Propiedades_de_Objeto.adoc[detalles]):
...
* emplear la xref:/tools/Mostrar_Ocultar_objeto.adoc[image:32px-Mode_showhideobject.svg.png[Mode
...
recurso mientras se circula por la xref:/Apariencias.adoc[interfaz] de GG.
...
https://www.geogebra.org/material/show/id/4483[hoja dinámica de GeoGebra] que presenta, en francés, una aplicación
