...
* `++Lista1 == Lista2++` Controla si las dos listas son iguales como http://en.wikipedia.org/wiki/es:Tupla[tuplas]
ordenadas y brinda como resultado de salida verdadero (_true_) o falso (_false_).
* `++Lista1 != Lista2++` Controla si las dos listas son desiguales como http://en.wikipedia.org/wiki/es:Tupla[tuplas]
...
http://en.wikipedia.org/wiki/es:Multiconjunto[multiconjunto] (es decir, ignorando el orden de los elementos).
