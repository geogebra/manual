...
*DistribuciónFInversa*[ <Grados de Libertad del Numerador>, <Grados de Libertad del Denominador>, <Probabilidad> ]::
  ...
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_F[*Distribución F*] (en inglés
  http://en.wikipedia.org/wiki/F-distribution[_F-distribution_]).Así, *DistribuciónFInversa[n, d, p]* establece el valor
  de _t_ tal que:
  _P(X ≤ t) = p_
  .. siendo _X_ la http://en.wikipedia.org/wiki/es:Variable_aleatoria[variable aleatoria] sujeta a una
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_F[*Distribución F*] con _n_ y _d_ como grados de libertad (del
