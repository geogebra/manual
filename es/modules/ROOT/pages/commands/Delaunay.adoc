...
*Delaunay*[ <Lista de Puntos> ]::
  Crea una https://es.wikipedia.org/Triangulaci%C3%B3n_de_Delaunay[Triangulación de Delaunay]
  ...
  https://es.wikipedia.org/Triangulaci%C3%B3n_de_Delaunay[Triangulación de Delaunay] correspondiente al conjunto
