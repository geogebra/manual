...
== image:16px-Menu_view_cas.svg.png[Menu view cas.svg,width=16,height=16]xref:/commands/Comandos_Específicos_CAS_(Cálculo_Avanzado).adoc[En] xref:/Categoría__Comandos_Específicos_CAS_(Cálculo_Avanzado).adoc[Vista **C**~[.small]#omputación#~**A**~[.small]#lgebraica#~**S**~[.small]#imbólica#~]

Sin admitir literales, en esta xref:/Categoría__Comandos_Específicos_CAS_(Cálculo_Avanzado).adoc[vista] todas las variantes
