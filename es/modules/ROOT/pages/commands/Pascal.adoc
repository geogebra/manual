...
/Archivo:Pascal_1_gif.adoc[image:Pascal_1.gif[Pascal 1.gif,width=532,height=543]]
...
xref:/tools/Valor_Numérico.adoc[valor]/Archivo:Mode_numeric_svg.adoc[image:23px-Mode_numeric.svg.png[Mode
numeric.svg,width=23,height=23]] __0.116__^decimales según xref:/Menú_de_Opciones.adoc[Redondeo]^ y al
xref:/tools/Evalúa.adoc[evaluarlo] resulta /Archivo:Mode_evaluate_svg.adoc[image:23px-Mode_evaluate.svg.png[Mode
evaluate.svg,width=23,height=23]] __stem:[\frac\{25}\{216}]__**`++Pascal[1, 1/6, 2, true]++`** da como
xref:/tools/Valor_Numérico.adoc[valor] aproximado /Archivo:Mode_numeric_svg.adoc[image:23px-Mode_numeric.svg.png[Mode
numeric.svg,width=23,height=23]] _0.42_ y es xref:/tools/Evalúa.adoc[evaluado] como
[.small]#*/Archivo:Mode_evaluate_png.adoc[image:Mode_evaluate.png[Mode evaluate.png,width=32,height=32]]* 3 *B*
stem:[\{\left( 1, 3, \frac\{1}\{6} \right)}]#.
...
*Ejemplos:* *`++Pascal[ n, p, 3, false]++`* da por
resultado:/Archivo:Pascal3_PNG.adoc[image:Pascal3.PNG[Pascal3.PNG,width=332,height=51]]

'''''

*`++Pascal[n, p, 2, x(A) > 2]++`* da por resultado Ι(n, 3, p) cuando la abscisa de *`++A++`* es mayor que 2 y, en caso
contrario,/Archivo:Pascal2_PNG.adoc[image:Pascal2.PNG[Pascal2.PNG,width=332,height=51]]

'''''

*`++Pascal[n, 1/3, 3, false]++`* da /Archivo:Pascal1_PNG.adoc[image:Pascal1.PNG[Pascal1.PNG,width=320,height=54]]
...
/Archivo:Mode_numeric_svg.adoc[image:23px-Mode_numeric.svg.png[Mode numeric.svg,width=23,height=23]] __0.12__^decimales
según xref:/Menú_de_Opciones.adoc[Redondeo]^ y al xref:/tools/Evalúa.adoc[evaluarlo]
/Archivo:Mode_evaluate_svg.adoc[image:23px-Mode_evaluate.svg.png[Mode evaluate.svg,width=23,height=23]]
_stem:[\frac\{25}\{216}]_
