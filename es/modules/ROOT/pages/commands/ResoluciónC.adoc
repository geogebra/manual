...
== xref:/Vista_CAS.adoc[image:18px-Menu_view_cas.svg.png[Menu view cas.svg,width=18,height=18]] xref:/Categoría__Comandos_exclusivos_CAS.adoc[De] xref:/Vista_CAS.adoc[Vista CAS **C**~[.small]#omputación#~**A**~[.small]#lgebraica#~**S**~[.small]#imbólica#~]
...
* Ver además la _pista_ *xref:/Pista__Contando_Aleatorias_Resoluciones.adoc[Contando Aleatorias Resoluciones]*
