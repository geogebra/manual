...
/Categoría:Extension_help.adoc[análogo] en la xref:/Referencia__Vistas.adoc[Vista]
image:20px-Menu_view_cas.svg.png[Menu view cas.svg,width=20,height=20]
xref:/Referencia__Croquis.adoc[CAS] sin /Manual:Página_Principal.adoc[operar] con
literales.
