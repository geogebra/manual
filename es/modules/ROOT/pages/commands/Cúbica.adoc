...
== image:18px-Menu_view_cas.svg.png[Menu view cas.svg,width=18,height=18] xref:/Referencia__Vistas.adoc[Vista] xref:/Referencia__Croquis.adoc[**C**~[.small]#omputación#~**A**~[.small]#lgebraica#~**S**~[.small]#imbólica#~]

El xref:/Categoría__Comando.adoc[comando] xref:/Categoría__Publishing.adoc[opera] xref:/GeoGebra_Manual__AlRespecto.adoc[de modo]
xref:/Categoría__Extension_help.adoc[análogo] en la xref:/Referencia__Vistas.adoc[Vista]
image:20px-Menu_view_cas.svg.png[Menu view cas.svg,width=20,height=20]
xref:/Referencia__Croquis.adoc[CAS] sin xref:/Manual__Página_Principal.adoc[operar] con
literales.
