...
xref:/Vista_CAS.adoc[CAS View] supports exact versions of the following _Geometry Commands_.

== Exact Calculations

[cols=",,",options="header",]
|===
|Command |image:Tool_Evaluate.gif[Tool Evaluate.gif,width=32,height=32] xref:/tools/Evalúa.adoc[Evaluate]
|image:Tool_Numeric.gif[Tool Numeric.gif,width=32,height=32] xref:/tools/Valor_Numérico.adoc[Numeric] or Input,
...
|===
|Command |image:Tool_Evaluate.gif[Tool Evaluate.gif,width=32,height=32] xref:/tools/Evalúa.adoc[Evaluate]
|image:Tool_Numeric.gif[Tool Numeric.gif,width=32,height=32] xref:/tools/Valor_Numérico.adoc[Numeric]
