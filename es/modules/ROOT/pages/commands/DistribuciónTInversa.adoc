...
*DistribuciónTInversa*[ <Grados de Libertad>, <Probabilidad> ]::
  ...
  de la http://en.wikipedia.org/wiki/es:Funci%C3%B3n_Distribuici%C3%B3n_Acumulada[función acumulada^*_fda_*^] de
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_t_de_Student[*Distribución t de Student*]
  (http://en.wikipedia.org/wiki/Student%27s_t-distribution[_t-distribution_] en inglés).Así, *DistribuciónTInversa[d,
  ...
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_t_de_Student[*Distribución t de Student*] con _d_ grados de
  libertad.
