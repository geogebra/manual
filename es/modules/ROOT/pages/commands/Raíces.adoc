...
Raíces[ <Función>, <Valor de x Inicial>, <Valor de x Final> ]::
  ...
  xref:/Es__w__Números_reales.adoc[[.small]##*ℝ*##eales] de la función en el intervalo
  dado y los xref:/Vista_Gráfica.adoc[grafica].

  '''''
  Para que el xref:/Categoría__Comandos_exclusivos_CAS.adoc[comando] xref:/Listas.adoc[liste] el
