...
embargo, el comando Demuestra utiliza http://en.wikipedia.org/wiki/es:C%C3%A1lculo_simb%C3%B3lico[cálculo simbólico]
...
[[ggbContainer22abe7f75bc22cd33a6c9f9bbe12727d]]====
