...
*ExponencialInversa*[ <Media~λ~>, <Probabilidad~p~> ]::
  ...
  de la http://en.wikipedia.org/wiki/es:Funci%C3%B3n_Distribuici%C3%B3n_Acumulada[*_fda_*, acumulada] de la
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_exponencial[distribución exponencial] (en inglés,
  http://en.wikipedia.org/wiki/Exponential_distribution[_exponential distribution_])Así, *ExponencialInversa[λ, p]* da
  por resultado el valor de _t_ tal que:
  _P(X ≤ t) = p_
  ... siendo _X_ la http://en.wikipedia.org/wiki/es:Variable_aleatoria[variable aleatoria] sujeta a una
  http://en.wikipedia.org/wiki/es:Distribuci%C3%B3n_exponencial[distribución exponencial], _p_ la _probabilidad_ y _λ_,
