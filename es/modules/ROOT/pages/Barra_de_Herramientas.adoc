...
los parámetros correspondientes xref:/Referencia__Parámetros_Applet.adoc[de preparación de la _Barra_]. Al empezar a emplear
...
especificarse a través de los xref:/Referencia__Parámetros_Applet.adoc[parámetros disponibles] para prepararla.
|===
...
usando el parámetro xref:/Referencia__Parámetros_Applet.adoc[correspondiente a la _preparación de la Barra_].
