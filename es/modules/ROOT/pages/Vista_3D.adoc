...
/Archivo:Stylingbar_point_down_svg.adoc[image:10px-Stylingbar_point_down.svg.png[Stylingbar point
down.svg,width=10,height=10]] se despliegan las cuatro posibilidades correspondientes
* image:16px-Stylingbar_graphics3D_rotateview_play.svg.png[Stylingbar graphics3D rotateview play.svg,width=16,height=16]
