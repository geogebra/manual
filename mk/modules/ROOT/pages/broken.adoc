 ...
 ** xref:commands/БиноменКоефициент.adoc[commands/БиноменКоефициент]
* `++\sqrt\{5}++`:
 
 ** xref:commands/Должина.adoc[commands/Должина]
 ** xref:commands/Должина.adoc[commands/Должина]
 ** xref:commands/Должина.adoc[commands/Должина]
* `++\frac{a}{\sqrt\{a^\{2} + b^\{2}}}++`:
 ...
 ** xref:commands/Коефициенти.adoc[commands/Коефициенти]
 ...
 ** xref:commands/СтандардноОтстапување.adoc[commands/СтандардноОтстапување]
* `++\sum_\{t=s}^\{e}f(t)++`:
 
 ** xref:commands/Сума.adoc[commands/Сума]
* `++\frac\{r^\{n+1} - 1}\{r - 1}++`:
 
 ** xref:commands/Сума.adoc[commands/Сума]
* `++ \overrightarrow\{AB}++`:
 
 ** xref:tools/Права_низ_две_точки.adoc[tools/Права_низ_две_точки]