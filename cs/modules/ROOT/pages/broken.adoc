 ...
 ** xref:commands/Invertovat.adoc[commands/Invertovat]
* `++(\frac{-b}\{\sqrt{a^\{2} + b^\{2}}}++`:
 
 ** xref:commands/JednotkovyNormVektor.adoc[commands/JednotkovyNormVektor]
* `++\frac{a}{\sqrt{a^\{2} + b^\{2}}})++`:
 
 ** xref:commands/JednotkovyNormVektor.adoc[commands/JednotkovyNormVektor]
* `++\frac{1}\{3}++`:
 
 ** xref:commands/JednotkovyVektor.adoc[commands/JednotkovyVektor]
* `++\frac{2}\{3}++`:
 ...
 ** xref:commands/Koeficienty.adoc[commands/Koeficienty]
 ** xref:commands/Koeficienty.adoc[commands/Koeficienty]
* `++\displaystyle \frac{n^\{3} - 3 n^\{2} + 2 n}\{6}++`:
 
 ** xref:commands/KombinacniCislo.adoc[commands/KombinacniCislo]
 ...
 ** xref:commands/NormalniRozdeleni.adoc[commands/NormalniRozdeleni]
* `++(-1)^\{2.5}++`:
 
 ** xref:commands/OdstranitNedefinovane.adoc[commands/OdstranitNedefinovane]
* `++(-1)^\{1.5}++`:
 ...
 ** xref:commands/Suma.adoc[commands/Suma]
* `++\frac{r^\{n+1} - 1}\{r - 1}++`:
...
* `++\frac{cos(3) x^\{3} (2 y - 6) + sin(3) x^\{3} (-y^\{2} + 6 y - 7)}\{2}++`:
 
 ** xref:commands/TaylorovaRada.adoc[commands/TaylorovaRada]
 ...
 ** xref:commands/VyberovyRozptyl.adoc[commands/VyberovyRozptyl]
* `++\{a = \frac{4}\{x}, a = 0\}++`:
 
 ** xref:commands/Vyresit.adoc[commands/Vyresit]
