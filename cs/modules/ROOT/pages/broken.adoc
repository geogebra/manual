 ...
 ** xref:commands/InverzniLaplace.adoc[commands/InverzniLaplace]
 ...
 ** xref:commands/NekonecnyKuzel.adoc[commands/NekonecnyKuzel]
...
* commands/JordanovaDiagonalizace.adoc:
...
* commands/ZelvaDoleva.adoc:
 
 ** xref:commands/Zelva.adoc[commands/Zelva]
 ** xref:commands/ZelvaVpred.adoc[commands/ZelvaVpred]
 ** xref:commands/ZelvaZpet.adoc[commands/ZelvaZpet]
* commands/ZelvaDoprava.adoc:
 
 ** xref:commands/Zelva.adoc[commands/Zelva]
 ** xref:commands/ZelvaVpred.adoc[commands/ZelvaVpred]
 ** xref:commands/ZelvaZpet.adoc[commands/ZelvaZpet]
* commands/ZelvaPeroNahoru.adoc:
 
 ** xref:commands/Zelva.adoc[commands/Zelva]
 ** xref:commands/ZelvaPeroDolu.adoc[commands/ZelvaPeroDolu]
