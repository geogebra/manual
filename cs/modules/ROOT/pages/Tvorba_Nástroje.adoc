...
image:18px-Menu-tools.svg.png[Menu-tools.svg,width=18,height=18] xref:/tools/Menu_Nástroje.adoc[Tools menu], select
...
image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16] xref:/Nákresna.adoc[Graphics
View].
...
The Tool Name will appear in GeoGebra's xref:/Nástrojová_lišta.adoc[Toolbar], while the Command Name can be used in GeoGebra's
xref:/Vstupní_pole.adoc[Input Bar].

====

* You may also enter text to be shown in the xref:/Nástrojová_lišta.adoc[Toolbar Help].
...
you can define a list of commands and use it with xref:/commands/Vykonat.adoc[Execute Command].
