...
Bunka( <Soupec>, <Řádek> )::
  Dostaneme kopii obsahu buňky z xref:/Spreadsheet_View.adoc[spreadsheet] v
...
xref:/Construction_Protocol.adoc[Construction_Protocol] a poté teprve v tomto
příkazu
...
xref:/Free_Dependent_and_Auxiliary_Objects.adoc[auxiliary] a v takovém případě
