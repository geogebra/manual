...
Pokud chceme obnovit náhled (např. při odstraňování xref:/Trasování.adoc[traces] z
xref:/Nákresna.adoc[Graphics View]) můžeme použít `++ZoomIn[1]++` , což
odpovídá také [.kcode]#Ctrl# + [.kcode]#F#. Někdy je nejprve zapotřebí
xref:/commands/NastavitAktivniNahled.adoc[SetActiveView[1]] nebo
xref:/commands/NastavitAktivniNahled.adoc[SetActiveView[2]] pokud používáme dvě nákresny.
