...
MinimalniKostra( <Seznam bodů> )::
  Vrací minimální http://en.wikipedia.org/wiki/cs:Kostra_grafu[kostru grafu]
  http://en.wikipedia.org/wiki/cs:%C3%9Apln%C3%BD_graf[úplného grafu] sestrojeného na daných vrcholech. Váha hrany
