...
MinimalniKostra( <Seznam bodů> )::
  Vrací minimální https://cs.wikipedia.org/wiki/Kostra_grafu[kostru grafu]
  https://cs.wikipedia.org/wiki/%C3%9Apln%C3%BD_graf[úplného grafu] sestrojeného na daných vrcholech. Váha hrany
