...
SmerovePole( <f(x,y)>, <Číslo n> )::
  ...
  image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16] xref:/Nákresna.adoc[Grafický pohled] čtverec) nebo menší. Výchozí rozměr je 40.
