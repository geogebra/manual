...
Viz též nástroje image:24px-Mode_pyramid.svg.png[Mode pyramid.svg,width=24,height=24] xref:/tools/Jehlan.adoc[Pyramid] a image:24px-Mode_conify.svg.png[Mode conify.svg,width=24,height=24] xref:/tools/Vytažení_do_jehlanu_nebo_kužele.adoc[Extrude
to Pyramid].
