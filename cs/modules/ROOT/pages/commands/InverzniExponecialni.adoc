...
InverzniExponecialni( <Lambda>, <Pravděpodobnost p> )::
  ...
  http://en.wikipedia.org/wiki/cs:Exponenci%C3%A1ln%C3%AD_rozd%C4%9Blen%C3%AD[exponenciálního rozdělení] pro
  pravděpodobnost _p_, tedy vypočítá _p_.100% http://en.wikipedia.org/wiki/cs:Kvantil[kvantil]. Jinými slovy, výsledkem
