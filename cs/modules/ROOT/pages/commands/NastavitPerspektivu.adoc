...
Nastaví viditelnost a rozložení dílčích prostředí GeoGebry, tzv. _náhledů_. Parametr _Text_ je buď slovním popisem příslušného rozložení, nebo popisem samostatného _náhledu_, který
chceme nastavit, nebo jednoduchým identifikátorem jednoho ze standardních uspořádání (tj. jedné konkrétní perspektivy).
