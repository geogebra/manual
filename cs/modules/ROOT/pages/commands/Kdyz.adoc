...
Více o pravdivostních hodnotách v sekci xref:/Booleovské_hodnoty.adoc[Pravdivostní hodnoty].
...
Podrobněji o symbolech, které lze užít v podmínkových výrazech, v sekci xref:/Booleovské_hodnoty.adoc[Pravdivostní
hodnoty].
