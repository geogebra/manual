...
|Je zobrazeno xref:/Algebraické_okno.adoc[Algebraické okno] a xref:/Nákresna.adoc[Grafický pohled] (s osami).

|image:24px-Perspectives_geometry.svg.png[Perspectives geometry.svg,width=24,height=24] |_Geometrie_: |Je zobrazen pouze
xref:/Nákresna.adoc[Grafický pohled] (s mřížkou).

|image:24px-Menu_view_spreadsheet.svg.png[Menu view spreadsheet.svg,width=24,height=24] |_Tabulka_:
|Je zobrazena xref:/Tabulka.adoc[Tabulka] a xref:/Nákresna.adoc[Grafický pohled].
...
xref:/Nákresna.adoc[Grafický pohled].
