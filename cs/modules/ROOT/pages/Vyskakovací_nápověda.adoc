...
V dialogovém okně _Pro pokročilé_ v xref:/Dialog_Předvolby.adoc[Nastavení] je možné nastavit také jazyk vyskakovací nápovědy a dobu jejího zobrazení.
