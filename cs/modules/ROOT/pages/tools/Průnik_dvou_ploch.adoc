...
image:24px-Mode_intersectioncurve.svg.png[Mode
intersectioncurve.svg,width=32,height=32] Aktivujte nástroj a poté vyberte dvě roviny, dvě koule nebo rovinu a těleso (kouli, krychli, hranol, kužel, válec...), abyste získali jejich průnik v podobě přímky, křivky nebo mnohoúhelníku, pokud mají oba objekty společné body.
