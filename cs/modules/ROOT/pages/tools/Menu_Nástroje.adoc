...
V GeoGebře můžeme vytvářet vlastní nástroje podle již existující konstrukce. Po sestrojení konstrukce, kterou chceme aby náš nástroj uměl vytvořit, vybereme v xref:/Tools_Menu.adoc[Tools Menu] Vytvořit
