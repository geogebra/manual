...
V GeoGebře můžeme vytvářet vlastní nástroje podle již existující konstrukce. Po sestrojení konstrukce, kterou chceme aby náš nástroj uměl vytvořit, vybereme v xref:/tools/Menu_Nástroje.adoc[Tools Menu] Vytvořit
