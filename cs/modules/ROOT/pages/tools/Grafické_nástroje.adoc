...
* xref:/tools/Pen.adoc[image:24px-Mode_pen.svg.png[Mode pen.svg,width=24,height=24]] xref:/tools/Pero.adoc[Pero]
...
xref:/tools/Vztah_mezi_dvěma_objekty.adoc[Vztah mezi objekty]
...
xref:/tools/Zaškrtávací_políčko_pro_zobrazení_skrytí_objektu.adoc[Zaškrtávací plíčko]
