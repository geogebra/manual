...
xref:/Properties_Dialog.adoc[Properties Dialog]. Barvu objektu také můžeme měnit
...
* Vytvoříme tři xref:/Slider_Tool.adoc[slider] a, b, a c s intervalem od 0 do 1.
* Vytvoříme mnohoúhelník, jehož barva bude ovlivněna hodnotami na posuvnících.
* Otevřeme xref:/Properties_Dialog.adoc[Properties Dialog] mnohoúhelníku
