...
xref:/Dialog_Vlastnosti.adoc[Properties Dialog]. Barvu objektu také můžeme měnit
...
* Vytvoříme tři xref:/tools/Posuvník.adoc[slider] a, b, a c s intervalem od 0 do 1.
* Vytvoříme mnohoúhelník, jehož barva bude ovlivněna hodnotami na posuvnících.
* Otevřeme xref:/Dialog_Vlastnosti.adoc[Properties Dialog] mnohoúhelníku
