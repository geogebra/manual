...
zobrazení navigačního panelu v doní části xref:/Nákresna.adoc[Graphics
View] vybereme položku xref:/Menu_Zobrazit.adoc[Construction Protocol... >
Navigation Bar for Construction Steps] v xref:/Menu_Zobrazit.adoc[View Menu]
