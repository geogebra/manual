...
zobrazení navigačního panelu v doní části xref:/Graphics_View.adoc[Graphics
View] vybereme položku xref:/View_Menu.adoc[Construction Protocol... >
Navigation Bar for Construction Steps] v xref:/View_Menu.adoc[View Menu]
