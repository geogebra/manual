...
* xref:/tools/Kružnice_daná_osou_a_bodem.adoc[image:24px-Mode_circleaxispoint.svg.png[Mode
...
* xref:/tools/Rovina_procházející_třemi_body.adoc[image:24px-Mode_planethreepoint.svg.png[Mode
planethreepoint.svg,width=24,height=24]] xref:/tools/Rovina_procházející_třemi_body.adoc[Rovina procházející 3 body]
* xref:/tools/Rovina.adoc[image:24px-Mode_plane.svg.png[Mode plane.svg,width=24,height=24]] xref:/tools/Rovina.adoc[Rovina]
...
* xref:/tools/Jehlan.adoc[image:24px-Mode_pyramid.svg.png[Mode pyramid.svg,width=24,height=24]]
xref:/tools/Jehlan.adoc[Jehlan]
* xref:/tools/Hranol.adoc[image:24px-Mode_prism.svg.png[Mode prism.svg,width=24,height=24]] xref:/tools/Hranol.adoc[Hranol]
* xref:/tools/Vytažení_do_jehlanu_nebo_kužele.adoc[image:24px-Mode_conify.svg.png[Mode conify.svg,width=24,height=24]]
xref:/tools/Vytažení_do_jehlanu_nebo_kužele.adoc[Vytažení do jehlanu nebo kužele]
* xref:/tools/Vytažení_do_hranolu_nebo_válce.adoc[image:24px-Mode_extrusion.svg.png[Mode
extrusion.svg,width=24,height=24]] xref:/tools/Vytažení_do_hranolu_nebo_válce.adoc[Vytažení do hranolu nebo válce]
* xref:/tools/Kužel.adoc[image:24px-Mode_cone.svg.png[Mode cone.svg,width=24,height=24]] xref:/tools/Kužel.adoc[Kužel]
* xref:/tools/Valec.adoc[image:24px-Mode_cylinder.svg.png[Mode cylinder.svg,width=24,height=24]]
xref:/tools/Valec.adoc[Válec]
* xref:/tools/Čtyřstěn.adoc[image:24px-Mode_tetrahedron.svg.png[Mode tetrahedron.svg,width=24,height=24]]
xref:/tools/Čtyřstěn.adoc[Čtyřstěn]
* xref:/tools/Krychle.adoc[image:24px-Mode_cube.svg.png[Mode cube.svg,width=24,height=24]] xref:/tools/Krychle.adoc[Krychle]
* xref:/tools/Síť.adoc[image:24px-Mode_net.svg.png[Mode net.svg,width=24,height=24]] xref:/tools/Síť.adoc[Síť tělesa]
...
* xref:/tools/Koule_zadaná_středem_a_bodem.adoc[image:24px-Mode_sphere2.svg.png[Mode
sphere2.svg,width=24,height=24]] xref:/tools/Koule_zadaná_středem_a_bodem.adoc[Koule zadaná středem a bodem]
* xref:/tools/Koule_zadaná_středem_a_poloměrem.adoc[image:24px-Mode_spherepointradius.svg.png[Mode
...
* xref:/tools/Otáčení_kolem_přímky.adoc[image:24px-Mode_rotatearoundline.svg.png[Mode
...
* xref:/tools/Otočit_grafický_náhled_3D.adoc[image:24px-Mode_rotateview.svg.png[Mode rotateview.svg,width=24,height=24]]
...
* xref:/tools/Pohled_podle_objektu.adoc[image:24px-Mode_viewinfrontof.svg.png[Mode viewinfrontof.svg,width=24,height=24]]
