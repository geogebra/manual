...
algebra.svg,width=16,height=16] xref:/Algebraické_okno.adoc[algebraickém okně] a potom použijte šipky pro změnu hodnoty proměnné (viz xref:/Animace.adoc[Animace]).
