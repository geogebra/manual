...
== [#Graphics_View_User_Interface]#xref:/Nákresna.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=24,height=24]] Uživatelské rozhraní nákresny#
