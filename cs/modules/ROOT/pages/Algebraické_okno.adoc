...
the image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] _Algebraického okna_ (GeoGebra pro web a tablety).  xref:/tools/Formátovací_panel.adoc[Formátovací panel] nákresny je v horizontální liště nad nákresnou. 
Tlačítka
