...
xref:/tools/Ukazovátko.adoc[Move Tool] a poklepeme na objekt v
...
* Vybereme image:Tool_Move.gif[Tool Move.gif,width=32,height=32]
xref:/tools/Ukazovátko.adoc[Move Tool] a poklepeme myší na jakýkoliv objekt v
xref:/Nákresna.adoc[Graphics View]. Tím otevřeme dialog Předefinovat, který
...
záložce Základní v xref:/Dialog_Vlastnosti.adoc[Properties Dialog].
