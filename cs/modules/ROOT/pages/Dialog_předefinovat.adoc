...
xref:/Move_Tool.adoc[Move Tool] a poklepeme na objekt v
...
* Vybereme image:Tool_Move.gif[Tool Move.gif,width=32,height=32]
xref:/Move_Tool.adoc[Move Tool] a poklepeme myší na jakýkoliv objekt v
xref:/Graphics_View.adoc[Graphics View]. Tím otevřeme dialog Předefinovat, který
...
záložce Základní v xref:/Properties_Dialog.adoc[Properties Dialog].
