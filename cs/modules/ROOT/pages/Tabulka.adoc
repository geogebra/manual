...
xref:/tools/Formátovací_panel.adoc/#/tabulka[_Formátovací panel_] obsahuje nejrůznější _xref:/Nástroje.adoc[nástroje]_, které umožňují vytvořit objekty v image:16px-Menu_view_spreadsheet.svg.png[Menu view
