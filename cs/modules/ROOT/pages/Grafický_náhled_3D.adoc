...
basic setup can be changed using the xref:/Formátovací_panel.adoc[_3D Graphics View Style Bar_] (e.g. display of coordinate
axes, _xOy_-plane, grid). In addition, the _xref:/Dialog_Předvolby.adoc[Preferences Dialog]_ provides more options to
...
Using the xref:/Nástroje_3D_náhledu.adoc[construction _Tools_] available in the xref:/Grafický_náhled_3D.adoc[_3D
...
Graphics View_ in order to find out how to use the selected xref:/Nástroje_3D_náhledu.adoc[_Tool_].
...
_xref:/Algebraické_okno.adoc[Algebra View]_.
...
_xref:/tools/Koule_zadaná_středem_a_bodem.adoc[Sphere with Center through Point Tool]_ and click in the _3D Graphics
...
The xref:/Nástroje_3D_náhledu.adoc[_3D Graphics View Toolbar_] provides a wide range of _xref:/Nástroje.adoc[Tools]_
...
3Dgraphics.svg,width=16,height=16] _3D Graphics View_. Every icon in the _xref:/Nástrojová_lišta.adoc[Toolbar]_ represents a
xref:/Nástroje.adoc[_Toolbox_] that contains a selection of related xref:/Nástroje.adoc[construction _Tools_]. In order to
...
_xref:/Nástroje_3D_náhledu.adoc[Planes Toolbox]_ or _Tools_ that allow you to create geometric solids in the
image:16px-Mode_pyramid.svg.png[Mode pyramid.svg,width=16,height=16] xref:/Nástroje_3D_náhledu.adoc[Geometric Solids
Toolbox].
...
coordinate system. You may either use the _xref:/Nástroje.adoc[Tools]_ provided in the xref:/Grafický_náhled_3D.adoc[_3D
Graphics View Toolbar_], or directly enter the algebraic representation of these objects in the
_xref:/Vstupní_pole.adoc[Input Bar]_ or xref:/Vstupní_pole.adoc[_Input Field_] of the
image:16px-Menu_view_algebra.svg.png[Algebra View,title="Algebra View",width=16,height=16]
_xref:/Algebraické_okno.adoc[Algebra View]_ (GeoGebra Web and Tablet Apps).
...
In addition to the wide range of xref:/Category__Commands.adoc[_Commands_] available for the other _xref:/Náhledy.adoc[Views]_
...
Using the image:16px-Mode_move.svg.png[Move Tool,title="Move Tool",width=16,height=16] _xref:/tools/Ukazovátko.adoc[Move
Tool]_ you may drag and drop xref:/Volné_závislé_a_pomocné_objekty.adoc[_Free Points_] in the
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16] _3D Graphics
...
translateview.svg,width=16,height=16] _xref:/tools/Pohybovat_s_nákresnou.adoc[Move Graphics View Tool]_ and dragging the
...
_Back to Default View_ in the xref:/Formátovací_panel.adoc[_3D Graphics View Style Bar_].
...
Tool,title="Rotate 3D Graphics View Tool",width=16,height=16] _xref:/tools/Otočit_grafický_náhled_3D.adoc[Rotate 3D
...
pause.svg,width=16,height=16] _Stop Rotating the View_ in the xref:/Formátovací_panel.adoc[_3D Graphics View Style Bar_].
...
rotate.svg,width=16,height=16] _Rotate back to default view_ in the xref:/Formátovací_panel.adoc[_3D Graphics View Style Bar_].
...
_xref:/tools/Pohled_podle_objektu.adoc[View in front of Tool]_ in order to view the coordinate system from a viewpoint in
front of the selected object.

=== Zoom

You may use the image:16px-Mode_zoomin.svg.png[Mode zoomin.svg,width=16,height=16] _xref:/tools/Zvětšit.adoc[Zoom In
Tool]_ and image:16px-Mode_zoomout.svg.png[Mode zoomout.svg,width=16,height=16] _xref:/tools/Zmenšit.adoc[Zoom Out
...
The xref:/Formátovací_panel.adoc[_3D Graphics View Style Bar_] contains buttons to
...
capturing.svg,width=16,height=16] _xref:/Přichytávání_bodu.adoc[Point Capturing]_ settings
* image:16px-Stylingbar_graphics3D_rotateview_play.svg.png[Stylingbar graphics3D rotateview play.svg,width=16,height=16]
...
* open the image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16] _xref:/Dialog_Vlastnosti.adoc[Properties
...
_xref:/Náhledy.adoc[Views]_ in the GeoGebra window (GeoGebra Web and Tablet Apps)

=== Style Bar for Tools and Objects

Depending on the xref:/Nástroje.adoc[_Tool_] or object you select, the buttons in the _xref:/Formátovací_panel.adoc[Style Bar]_
adapt to your selection. Please see xref:/Formátovací_panel.adoc[Style Bar Options for Tools and Objects] for more information.
