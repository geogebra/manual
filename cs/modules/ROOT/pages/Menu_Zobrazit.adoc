...
Tato položka nabídky vám umožňuje zobrazit nebo skrýt xref:/tools/Pravděpodobnostní_kalkulačka.adoc[Pravděpodobnostní kalkulačku].
...
protocol.svg,width=16,height=16] xref:/Zápis_konstrukce.adoc[Zápis konstrukce].
...
Tato položka nabídky vám umožňuje zobrazit nebo skrýt xref:/Vstupní_pole.adoc[Vstupní pole] and the Command List at the bottom of the
GeoGebra window.
