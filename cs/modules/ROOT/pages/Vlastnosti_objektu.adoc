...
_Dialogu Vlatnosti_ můžete nastavit upevnění objektu. S upevněnými objekty (xref:/Volné_závislé_a_pomocné_objekty.adoc[volvými i závislými]) se nedá hýbat. 
To stop an object being selected / deleted you can uncheck its "Selection Allowed" option in the Advanced Tab.
