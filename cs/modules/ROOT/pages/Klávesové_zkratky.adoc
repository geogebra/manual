...
xref:/Zápis_konstrukce.adoc[Construction Protocol]
...
image:16px-Menu_view_graphics1.svg.png[Menu view graphics1.svg,width=16,height=16] xref:/Nákresna.adoc[Graphics
View] 1
...
image:16px-Menu_view_graphics2.svg.png[Menu view graphics2.svg,width=16,height=16] xref:/Nákresna.adoc[Graphics
View] 2
...
|F3 |[.kcode]#F3# |X | | |[.kcode]#F3# |Copy definition of selected object to the xref:/Vstupní_pole.adoc[Input Bar]

|F4 |[.kcode]#F4# |X | | |[.kcode]#F4# |Copy value of selected object to the xref:/Vstupní_pole.adoc[Input Bar]

|F4 |[.kcode]#Alt# + [.kcode]#F4# |X |X | | |Quit GeoGebra

|F5 |[.kcode]#F5# |X | | |[.kcode]#F5# |copy name of selected object to the xref:/Vstupní_pole.adoc[Input Bar]
...
graphics.svg,width=16,height=16] xref:/Nákresna.adoc[Graphics View] and xref:/Vstupní_pole.adoc[Input Bar]
...
xref:/Vstupní_pole.adoc[input bar]
...
xref:/Nákresna.adoc[Graphics View] | | | | |Fast drag mode (drag on object) Selection rectangle Open menu (click on
...
image:16px-Menu_view_construction_protocol.svg.png[Menu view construction protocol.svg,width=16,height=16]
xref:/Zápis_konstrukce.adoc[construction protocol] (only Desktop) Move active Graphics view up
...
construction protocol.svg,width=16,height=16] xref:/Zápis_konstrukce.adoc[construction protocol] (only Desktop)
...
construction protocol.svg,width=16,height=16] xref:/Zápis_konstrukce.adoc[construction protocol] (Desktop only)
...
image:16px-Menu_view_construction_protocol.svg.png[Menu view construction protocol.svg,width=16,height=16]
xref:/Zápis_konstrukce.adoc[construction protocol] (only Desktop) Move active Graphics view down
...
construction protocol.svg,width=16,height=16] xref:/Zápis_konstrukce.adoc[construction protocol] (only Desktop) *3D
