...
直線ツールは，デフォルトでは GeoGebra Classic の xref:/ツールバー.adoc[ツールバー] の image:24px-Mode_join.svg.png[Mode join.svg,width=24,height=24] アイコン（左から3番目）にグループ化されている． 他のアプリでは，直線のカテゴリにグループ化されている．
