...
変形xref:/ツール.adoc[ツール]は，デフォルトではimage:Tool_Reflect_Object_in_Line.gif[Tool Reflect Object inLine.gif,width=32,height=32]xref:/ツールバー.adoc[ツールバー]のアイコン（右から3番目）にグループ化されている．現在，6つの変形ツールがある：
