...
* xref:/tools/評価.adoc[image:24px-Mode_evaluate.svg.png[Mode evaluate.svg,width=24,height=24]]
xref:/tools/評価.adoc[評価]
* xref:/tools/数値的.adoc[image:24px-Mode_numeric.svg.png[Mode numeric.svg,width=24,height=24]]
xref:/tools/数値的.adoc[数値評価]
* xref:/tools/入力を保つ.adoc[image:24px-Mode_keepinput.svg.png[Mode keepinput.svg,width=24,height=24]]
xref:/tools/入力を保つ.adoc[入力を保つ]

== 計算ツール

* xref:/tools/因数.adoc[image:24px-Mode_factor.svg.png[Mode factor.svg,width=24,height=24]] xref:/tools/因数.adoc[因数]
...
* xref:/tools/解く.adoc[image:24px-Mode_solve.svg.png[Mode solve.svg,width=24,height=24]] xref:/tools/解く.adoc[解く]
* xref:/tools/数値的に解く.adoc[image:24px-Mode_nsolve.svg.png[Mode nsolve.svg,width=24,height=24]]
xref:/tools/数値的に解く.adoc[数値的に解く]
* xref:/tools/微分.adoc[image:24px-Mode_derivative.svg.png[Mode derivative.svg,width=24,height=24]]
