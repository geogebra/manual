...
GeoGebra の他の _xref:/表示.adoc[ビュー]_ で利用可能な多くの xref:/commands/すべてのコマンド.adoc[_コマンド_] に加え，_空間図形ビュー_ 専用の __空間図形コマンド__も用意されている．
...
image:16px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives algebra 3Dgraphics.svg,width=16,height=16]
_空間図形ビュー_ をズームするには，xref:/tools/ズームイン.adoc[image:16px-Mode_zoomin.svg.png[Mode
zoomin.svg,width=16,height=16]] _xref:/tools/ズームイン.adoc[ズームインツール]_
とxref:/tools/ズームアウト.adoc[image:16px-Mode_zoomout.svg.png[Mode zoomout.svg,width=16,height=16]]
