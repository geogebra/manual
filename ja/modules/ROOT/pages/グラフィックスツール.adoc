...
はxref:/グラフィックスビュー.adoc[image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]]
_xref:/グラフィックスビュー.adoc[グラフィックスビュー]_ または
xref:/数式ビュー.adoc[image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16]]
_xref:/数式ビュー.adoc[数式ビュー]_ がアクティブな場合に使用できる．

[NOTE]
====

ほとんどの作図 _ツール_ を使用すると，xref:/グラフィックスビュー.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
* xref:/tools/移動.adoc[image:24px-Mode_move.svg.png[Mode move.svg,width=24,height=24]] xref:/tools/移動.adoc[移動
ツール]
* xref:/tools/点の回りに回転.adoc[image:24px-Mode_moverotate.svg.png[Mode moverotate.svg,width=24,height=24]]
xref:/tools/点の回りに回転.adoc[点の回りに回転 ツール] (GeoGebra Desktop)

== 点ツール

* xref:/tools/点.adoc[image:24px-Mode_point.svg.png[Mode point.svg,width=24,height=24]] xref:/tools/点.adoc[点 ツール]
...
* xref:/tools/複素数.adoc[image:24px-Mode_complexnumber.svg.png[Mode complexnumber.svg,width=24,height=24]]
xref:/tools/複素数.adoc[複素数 ツール]
* xref:/tools/極値.adoc[image:24px-Mode_extremum.svg.png[Mode extremum.svg,width=24,height=24]]
xref:/tools/極値.adoc[極値 ツール]
* xref:/tools/根（x軸との共有点）.adoc[image:24px-Mode_roots.svg.png[Mode roots.svg,width=24,height=24]]
...
* xref:/tools/長さを指定した線分.adoc[image:24px-Mode_segmentfixed.svg.png[Mode
...
* xref:/tools/点を結ぶ折れ線.adoc[image:24px-Mode_polyline.svg.png[Mode polyline.svg,width=24,height=24]]
xref:/tools/折れ線の作成.adoc[折れ線の作成_ツール]
* xref:/tools/２点を結ぶベクトル.adoc[image:24px-Mode_vector.svg.png[Mode vector.svg,width=24,height=24]]
...
* xref:/tools/垂線.adoc[image:24px-Mode_orthogonal.svg.png[Mode orthogonal.svg,width=24,height=24]]
...
* xref:/tools/垂直二等分線.adoc[image:24px-Mode_linebisector.svg.png[Mode linebisector.svg,width=24,height=24]]
...
* xref:/tools/最良近似直線.adoc[image:24px-Mode_fitline.svg.png[Mode fitline.svg,width=24,height=24]]
...
* xref:/tools/剛体多角形.adoc[image:24px-Mode_rigidpolygon.svg.png[Mode rigidpolygon.svg,width=24,height=24]]
xref:/tools/剛体多角形.adoc[剛体多角形 ツール]
* xref:/tools/ベクトル多角形.adoc[image:24px-Mode_vectorpolygon.svg.png[Mode vectorpolygon.svg,width=24,height=24]]
xref:/tools/ベクトル多角形.adoc[ベクトル多角形_ツール]

== 円と弧ツール

* xref:/tools/中心と円周上の１点で決まる円.adoc[image:24px-Mode_circle2.svg.png[Mode circle2.svg,width=24,height=24]]
xref:/tools/中心と円周上の１点で決まる円.adoc[中心と円周上の１点で決まる円 ツール]
* xref:/tools/中心と半径で決まる円.adoc[image:24px-Mode_circlepointradius.svg.png[Mode
circlepointradius.svg,width=24,height=24]] xref:/tools/中心と半径で決まる円.adoc[中心と半径で決まる円 ツール]
* xref:/tools/コンパス.adoc[image:24px-Mode_compasses.svg.png[Mode compasses.svg,width=24,height=24]]
...
* xref:/tools/２点を通る半円.adoc[image:24px-Mode_semicircle.svg.png[Mode
...
* xref:/tools/角度.adoc[image:24px-Mode_angle.svg.png[Mode angle.svg,width=24,height=24]] xref:/tools/角度.adoc[角度
ツール]
* xref:/tools/大きさを指定した角度.adoc[image:24px-Mode_anglefixed.svg.png[Mode anglefixed.svg,width=24,height=24]]
...
* xref:/tools/面積.adoc[image:24px-Mode_area.svg.png[Mode area.svg,width=24,height=24]] xref:/tools/面積.adoc[面積
ツール]
* xref:/tools/傾き.adoc[image:24px-Mode_slope.svg.png[Mode slope.svg,width=24,height=24]] xref:/tools/傾き.adoc[傾き
ツール]
...
* xref:/tools/円に関する点の鏡映.adoc[image:24px-Mode_mirroratcircle.svg.png[Mode
mirroratcircle.svg,width=24,height=24]] xref:/tools/円に関する点の鏡映.adoc[円に関する点の鏡映 ツール]
* xref:/tools/角度を指定して点の回りにオブジェクトを回転.adoc[image:24px-Mode_rotatebyangle.svg.png[Mode rotatebyangle.svg,width=24,height=24]]
...
* xref:/tools/画像の挿入.adoc[image:24px-Mode_image.svg.png[Mode image.svg,width=24,height=24]]
xref:/tools/画像の挿入.adoc[画像の挿入 ツール]
* xref:/tools/ペン.adoc[image:24px-Mode_pen.svg.png[Mode pen.svg,width=24,height=24]] xref:/tools/ペン.adoc[ペン ツール]
* xref:/tools/フリーハンドの図形.adoc[image:24px-Mode_freehandshape.svg.png[Mode freehandshape.svg,width=24,height=24]]
xref:/tools/フリーハンドの図形.adoc[フリーハンドの図形_ツール]
* xref:/tools/２つのオブジェクトの関係.adoc[image:24px-Mode_relation.svg.png[Mode relation.svg,width=24,height=24]]
xref:/tools/２つのオブジェクトの関係.adoc[２つのオブジェクトの関係 ツール]
* xref:/tools/関数の分析.adoc[image:24px-Mode_functioninspector.svg.png[Mode
functioninspector.svg,width=24,height=24]] xref:/tools/関数の分析.adoc[関数の分析 ツール]

== アクションオブジェクトツール

* xref:/tools/スライダー.adoc[image:24px-Mode_slider.svg.png[Mode slider.svg,width=24,height=24]]
xref:/tools/スライダー.adoc[スライダー ツール]
* xref:/tools/表示／非表示のチェックボックス.adoc[image:24px-Mode_showcheckbox.svg.png[Mode showcheckbox.svg,width=24,height=24]]
xref:/tools/表示／非表示のチェックボックス.adoc[表示／非表示のチェックボックス ツール]
* xref:/tools/ボタン.adoc[image:24px-Mode_buttonaction.svg.png[Mode buttonaction.svg,width=24,height=24]]
xref:/tools/ボタン.adoc[ボタン ツール]
* xref:/tools/入力ボックスを挿入.adoc[image:24px-Mode_textfieldaction.svg.png[Mode textfieldaction.svg,width=24,height=24]]
