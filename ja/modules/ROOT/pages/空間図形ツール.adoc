...
xref:/ツールバー.adoc[_ツールバー_]に関する一般情報，_xref:/カスタムツール.adoc[カスタムツール]_
...
* xref:/Tangents_Tool.adoc[image:24px-Mode_tangent.svg.png[Mode tangent.svg,width=24,height=24]] [[接線_ツール]
...
xref:/s_index_php?title=軸と通る点で決まる円_ツール_action=edit_redlink=1.adoc[軸と通る点で決まる円_ツール]
