...
*備註：*
要變更物件的設定，請利用xref:/快顯功能表.adoc[快顯功能表]和xref:/En__Properties_Dialog.adoc[屬性對話窗]。
...
此選項將開啟xref:/En__Preferences_Dialog.adoc[設定對話窗]中的**進階**頁面。

[NOTE]
====

*備註：*
您也可透過xref:/快顯功能表.adoc[快顯功能表]開啟xref:/En__Preferences_Dialog.adoc[設定對話窗]。例如：在xref:/繪圖區.adoc[繪圖區]按滑鼠右鍵（Mac
