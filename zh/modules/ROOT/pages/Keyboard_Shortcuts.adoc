...
image:16px-Menu_view_graphics1.svg.png[Menu view graphics1.svg,width=16,height=16] xref:/繪圖區.adoc[图形视图] 1
...
image:16px-Menu_view_graphics2.svg.png[Menu view graphics2.svg,width=16,height=16] xref:/繪圖區.adoc[图形视图] 2
...
graphics.svg,width=16,height=16] xref:/繪圖區.adoc[图形视图] 和 xref:/指令列.adoc[输入栏]之间切换输入
...
xref:/指令列.adoc[输入栏]中创建选定对象的列表

|Right Click |在 image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]
xref:/繪圖區.adoc[图形视图] 中右键点击 | | | | |快速拖动模式（拖动对象） 选择矩形 打开菜单（点击对象） 打开首选项菜单（点击非对象区域）
