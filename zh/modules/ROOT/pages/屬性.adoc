...
Move.gif,width=32,height=32]**xref:/En__Move_Tool.adoc[移動]**」工具並在**xref:/繪圖區.adoc[繪圖區]**的物件上雙擊滑鼠左鍵。在彈出的**xref:/重新定義.adoc[重新定義]**對話窗中，點擊左下角的「*屬性
...*」按鈕。
...
您可在**屬性**對話窗右手邊的不同頁面中，更改xref:/En__Selecting_objects.adoc[所選物件]的xref:/En__Object_Properties.adoc[*屬性*]。
