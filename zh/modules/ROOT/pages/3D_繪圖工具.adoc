...
繪圖工具列*]，其中提供了以下*工具*。若想了解更多資訊，請參閱我們的 xref:/Category__工具.adoc[GeoGebra
...
xref:/tools/附著／脫離點.adoc[附著／脫離點] 工具
...
xref:/tools/圓（中心軸、一點）.adoc[圓（中心軸、一點）] 工具
...
xref:/tools/旋轉_3D_繪圖區.adoc[旋轉_3D_繪圖區] 工具
...
xref:/tools/面對指定面.adoc[面對指定面] 工具
