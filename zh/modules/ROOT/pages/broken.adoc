 ...
 ** xref:commands/BinomialCoefficient.adoc[commands/BinomialCoefficient]
* `++a_kx^k+a_\{k-1}x^\{k-1}+\cdots+a_1x+a_0++`:
 
 ** xref:commands/Coefficients.adoc[commands/Coefficients]
* `++f(x) = \left\{\begin\{aligned}\{} x^\{2}& , &x < -1\\ 1& ,& -1 ≤ x ≤ 1\\ -x^\{2} + 2& , &\text\{其他範圍} \end\{aligned}\right. ++`:
 ...
 ** xref:commands/IntegralBetween.adoc[commands/IntegralBetween]
* `++2 \sqrt\{2}++`:
 ...
 ** xref:commands/Normal.adoc[commands/Normal]
* `++\phi(X,A,B)=\frac{\overrightarrow\{XA}cdot\overrightarrow\{AB}}\{|AB|^2}++`:
 
 ** xref:commands/PathParameter.adoc[commands/PathParameter]
 ...
 ** xref:commands/PathParameter.adoc[commands/PathParameter]
* `++X=C+(\cos\alpha)\vec\{a} +(\sin\alpha)\vec\{b}++`:
 ...
 ** xref:commands/RemoveUndefined.adoc[commands/RemoveUndefined]
* `++(-1)^\{2.5}++`:
 ...
 ** xref:commands/Sort.adoc[commands/Sort]
* `++\sum_\{t=起始值}^\{結束值}f(t)++`:
 ...
 ** xref:commands/TableText.adoc[commands/TableText]
 ...
 ** xref:commands/TableText.adoc[commands/TableText]
* `++ \left\{\begin\{matrix} 2x+3y=5\\ 5x+8y=12 \end\{matrix}\right.++`:
