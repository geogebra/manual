...
*備註：*
當xref:/En__Spreadsheet_View.adoc[試算表]有被開啟時，如果在繪圖區開啟某個點的快顯功能表，會多一個「image:Spreadsheettrace_button.gif[Spreadsheettrace
...
Gear.png,width=24,height=24]屬性」將會開啟xref:/En__Properties_Dialog.adoc[屬性對話窗]，此處可讓您更改所有物件的屬性。
