...
此選項將開啟xref:/En__Properties_Dialog.adoc[屬性對話窗]，可讓您修改檔案中所有現存物件的屬性。
...
切換所選物件的xref:/En__Object_Properties.adoc[顯示狀態]。
...
*備註：*
您必須先xref:/En__Selecting_objects.adoc[選取]想要刪除的物件（例如：可用滑鼠框選）。
