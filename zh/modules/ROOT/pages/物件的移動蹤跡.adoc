...
xref:/繪圖區.adoc[Graphics View] when they are moved. Use the xref:/快顯功能表.adoc[Context Menu] and select
image:18px-Menu-trace-on.svg.png[Menu-trace-on.svg,width=18,height=18] _Trace On_. Alternatively you can go into the
image:18px-Menu-options.svg.png[Menu-options.svg,width=18,height=18] xref:/屬性.adoc[Object Properties] and
...
image:18px-Menu-view.svg.png[Menu-view.svg,width=18,height=18] xref:/檢視功能表.adoc[View Menu] clears all trace.
...
xref:/試算表.adoc[Spreadsheet View] is enabled, it is also possible to trace the changing positions of a point
in the image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16]
xref:/繪圖區.adoc[Graphics View]. To do so, open the xref:/快顯功能表.adoc[Context Menu] of a point in the
image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16] xref:/繪圖區.adoc[Graphics View]
