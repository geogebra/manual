...
GeoGebra
有一組標準**格局**。您可經由**格局側欄**（桌機版）或**格局選單**（線上版或平板版）輕易地切換到這些**格局**。更進一步的資訊請參閱「xref:/En__GeoGebra_5_0_Desktop_vs_Web_and_Tablet_App.adoc[選擇**格局**]」。

=== image:32px-Menu_view_algebra.png[Menu view algebra.png,width=32,height=32] 代數

**代數格局**由 xref:/代數區.adoc[image:16px-Menu_view_algebra.svg.png[Menu view
algebra.svg,width=16,height=16]]**xref:/代數區.adoc[代數區]**和
xref:/繪圖區.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
graphics.svg,width=16,height=16]]**xref:/繪圖區.adoc[繪圖區]**組成。預設情況下，xref:/繪圖區.adoc[image:16px-Menu_view_graphics.svg.png[Menu
view
...
xref:/代數區.adoc[image:16px-Menu_view_algebra.svg.png[Menu view
algebra.svg,width=16,height=16]]**xref:/代數區.adoc[代數區]**（請參閱「xref:/En__GeoGebra_5_0_Desktop_vs_Web_and_Tablet_App.adoc[指令列與指令欄]」）。

=== image:32px-Perspectives_geometry.png[Perspectives geometry.png,width=32,height=32] 幾何

**幾何格局**只顯示一個隱藏座標軸的 xref:/繪圖區.adoc[image:16px-Menu_view_graphics.svg.png[Menu view
...
**試算表格局**由 xref:/試算表.adoc[image:16px-Menu_view_spreadsheet.svg.png[Menu view
...
xref:/試算表.adoc[image:16px-Menu_view_spreadsheet.svg.png[Menu view
...
的使用介面。藉由**xref:/En__View_Menu.adoc[檢視功能表]**或是（線上版和平板版）**xref:/Style_Bar.adoc[格式列]**中的
...
image:16px-Menu-options.svg.png[Menu-options.svg,width=16,height=16]**xref:/En__Preferences_Dialog.adoc[設定對話窗]**中的
...
view.svg,width=16,height=16]**視區拖曳按鈕**）。更進一步資訊請參閱「xref:/En__GeoGebra_5_0_Desktop_vs_Web_and_Tablet_App.adoc[自訂使用介面的外觀]」。
