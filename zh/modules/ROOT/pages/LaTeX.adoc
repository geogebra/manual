...
您可以通过将 image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] xref:/代數區.adoc[代数视图] 中列出的对象拖动到 image:16px-Menu_view_graphics.svg.png[Menu view
graphics.svg,width=16,height=16] xref:/繪圖區.adoc[图形视图] 的选定位置，轻松获取包含该对象值的 LaTeX 文本。
