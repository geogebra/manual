...
https://www.geogebra.org/cms/en/download/%7CGeoGebra[5.0 Desktop] and the
image:20px-Download-icons-device-tablet.png[Download-icons-device-tablet.png,width=20,height=23]
https://www.geogebra.org/cms/en/download/%7CGeoGebra[5.0 Web and Tablet Apps]. While all versions provide the full power
...
== Selecting a xref:/格局.adoc[Perspective]
...
image:16px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=16,height=16] xref:/代數區.adoc[_Algebra View_],
the image:16px-Menu_view_graphics.svg.png[Menu view graphics.svg,width=16,height=16] xref:/繪圖區.adoc[_Graphics
View_], and the xref:/指令列.adoc[_Input Bar_] at the bottom of the screen. You may switch to another _Perspective_
...
xref:/格局.adoc[_Perspective_] that best fits the mathematical topic you want to work with. You can switch to
...
image:16px-Menu-button-open-menu.svg.png[Menu-button-open-menu.svg,width=16,height=16] _Menu_ button in the upper right
corner of the GeoGebra window in order to open the xref:/功能表.adoc[_Menu_].

== xref:/指令列.adoc[Input Bar and Input Field]
...
algebra.svg,width=16,height=16] xref:/代數區.adoc[_Algebra View_]. However, you may display the _Input Bar_ using
...
_xref:/工具列.adoc[Toolbar]_, _xref:/Sidebar.adoc[Sidebar]_). You may access the
...
the _xref:/檢視功能表.adoc[View Menu]_.
...
Menu]_ or the _xref:/檢視功能表.adoc[View Menu]_ is open.
