...
xref:/Angle_Tool.adoc[Angle] and image:16px-Tool_Angle_Fixed.gif[Tool Angle
Fixed.gif,width=16,height=16] xref:/Angle_with_Given_Size_Tool.adoc[Angle with
Given Size] tools .
