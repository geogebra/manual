...
FrequencyTable[<List of Class Boundaries>, <List of Raw Data>, <Use Density> , <Density Scale Factor> (optional) ]::
  ...
  corresponding xref:/Histogram_Command.adoc[Histogram Command].
...
[NOTE]
====
This command is similar to xref:/Frequency_Command.adoc[Frequency
Command] and xref:/Histogram_Command.adoc[Histogram Command]. Articles about
