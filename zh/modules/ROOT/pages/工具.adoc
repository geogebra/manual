...
GeoGebra
xref:/Category__工具.adoc[*工具*]可讓您透過指向裝置（例如：滑鼠）產生新的xref:/物件.adoc[物件]。點選**xref:/工具列.adoc[工具列]**上面的圖示就可以開始使用這些工具。

[NOTE]
====
所有xref:/Category__工具.adoc[*工具*]都有相對應的xref:/Category__指令.adoc[*指令*]，適合用於更複雜的作圖。
...
每個**xref:/工具列.adoc[工具列]**上都有數個「抽屜式」的**工具箱**，包含單個或多個相關xref:/Category__工具.adoc[*工具*]。您可透過以下方式打開**工具箱**：
...
若想了解更多資訊，請參閱我們的 xref:/Category__工具.adoc[GeoGebra
