...
* I motsetning til kommandoane xref:/Manual__Faktorar_Kommando.adoc[Faktorar] og
xref:/Manual__Faktoriser_Kommando.adoc[Faktoriser] tillet CFaktor også komplekse
faktorar.
