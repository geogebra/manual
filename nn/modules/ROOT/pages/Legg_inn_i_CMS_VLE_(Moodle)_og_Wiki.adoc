...
Eit anna val er å laste opp arbeidsarket til https://www.geogebra.org/[*GeoGebra*], som du no enkelt kan gjere gjennom
GeoGebra ved å gå til xref:/Filmeny.adoc[Ful -> Del...]. https://www.geogebra.org/[*GeoGebra*] vil då gi deg ein kode som
du kan bruke.
...
Sjå xref:/En__Tutorial__Main_Page.adoc[en:Tutorial:Main Page] for detaljar.
