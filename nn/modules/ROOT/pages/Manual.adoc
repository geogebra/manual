...
xref:/Verktøy.adoc[verktøy] eller xref:/Kommandoar.adoc[kommandoar]. xref:/Opplæring__Hovudside.adoc[Opplæringssidene] kan
...
* xref:/Kategori__Verktøy.adoc[Liste over verktøy]

=== Kommandoar

* xref:/Kommandoar.adoc[Om kommandoar]
* xref:/Kategori__Kommandoar.adoc[Liste over kommandoar]
...
* lagre den i xref:/Referanse__Fil_Format.adoc[GeoGebra sitt filformat]
