...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssida] og last ned deb-fila.
...
ned frå https://www.geogebra.org/cms/nb[heimesida]. Framgangsmetoden for dette er vist under xref:/.adoc[Detaljert
framgangsmetode].
...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssida] og vel *Mac OS X*.
...
Gå til https://www.geogebra.org/cms/nb/download[nedlastingssida] og vel *Windows*.
...
Opne Chrome og gå til https://www.geogebra.org/cms/nb/download/[nedlastingssida]. Vel *GeoGebra Chrome App*.
...
Gå til https://www.geogebra.org/cms/nb/download/[nedlastingssida] og vel *Java Webstart*.
...
Du kan og opne utgåva for nettbrett ved å surfe på nettbrettet til https://www.geogebra.org/cms/nb/[Geogebras nettside]
