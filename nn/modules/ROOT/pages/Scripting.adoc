...
* JavaScript lyttere (sjå xref:/Referanse__Javascript.adoc[Referanse:Javascript])
...
* _a_ er ein heiltallig xref:/Glidar_verktøy.adoc[glidar] med verdiar frå 1 til
3
* `++liste1 = {"rød", "grøn", "blå"}++`
...
xref:/Referanse__Javascript.adoc[Referanse:Javascript].
...
på sida: xref:/Referanse__Javascript.adoc[Referanse:Javascript].
