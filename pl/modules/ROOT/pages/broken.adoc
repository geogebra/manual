 ...
 ** xref:commands/ElementLosowy.adoc[commands/ElementLosowy]
 ** xref:commands/LosowaCałkowita.adoc[commands/LosowaCałkowita]
 ** xref:commands/LosowaDwumianowy.adoc[commands/LosowaDwumianowy]
 ** xref:commands/LosowaNormalny.adoc[commands/LosowaNormalny]
 ** xref:commands/Polecenia_Specyficzne_dla_Widoku_CAS.adoc[commands/Polecenia_Specyficzne_dla_Widoku_CAS]
 ** xref:commands/Prawdopodobieństwo_Polecenia.adoc[commands/Prawdopodobieństwo_Polecenia]
