...
Zobacz także polecenie xref:/commands/UdowodnijSzczegółowo.adoc[UdowodnijSzczegółowo] oraz xref:/Wartości_boolowskie.adoc[artykuł o wartościcha boolowskich]
