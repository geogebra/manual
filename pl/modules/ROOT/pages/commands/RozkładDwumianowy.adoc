...
RozkładDwumianowy( <Liczba Prób>, <Prawdopodobieństwo Sukcesu>, <Wartość Zmiennej>, <Czy Skumulowany> )::
  Niech _X_ będzie zmienną losową o rozkładzie dwumianowym, a _v_ wartością zmiennej.
