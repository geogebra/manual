...
* Wybierając trzy istniejące punkty lub klikając trzy położenia w _Widoku Grafiki_. Utworzy kąt, którego wierzchołkiem będzie drugi z punktów, a jego ramiona będą przechodzić przez pozostałe dwa punkty.
