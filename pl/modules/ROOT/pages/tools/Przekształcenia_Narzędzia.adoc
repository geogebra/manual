...
xref:/Narzędzia.adoc[Narzędzia] przekształceń w GeoGebra Classic są domyślnie pogrupowane pod ikoną 
image:Tool_Reflect_Object_in_Line.gif[Tool Reflect Object in Line.gif,width=32,height=32] (trzecia od prawej) w xref:/Pasek_Narzędzi.adoc[pasku narzędzi].
