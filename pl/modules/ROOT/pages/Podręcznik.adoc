...
funkcji xref:/Narzędzia.adoc[narzędzia] lub xref:/Polecenia.adoc[polecenia]. xref:/Tutorial__Strona_główna.adoc[Przewodnik]
...
* xref:/Ślad.adoc[Ślad]
* xref:/Zaawansowane_funkcje.adoc[Zaawansowane funkcje]
* xref:/Skrypty.adoc[Skrypty]
=== Narzędzia

* xref:/Narzędzia.adoc[Informacje o narzędziach]
* xref:/Kategoria__Narzędzia.adoc[Lista narzędzi]

=== Polecenia

* xref:/Polecenia.adoc[O poleceniach]
* xref:/Kategoria__Polecenia.adoc[Lista poleceń]
...
* xref:/Menedżer_narzędzi_dialogowych.adoc[Menedżer narzędzi dialogowych]
...
* xref:/Okno_podglądu_wydruku.adoc[Okno podglądu wydruku]
...
* zapisać ją w xref:/En__Reference__File_Format.adoc[pliku formatu GeoGebry]
...
https://www.geogebra.org[GeoGebra]xref:/En__Manual__Main_Page.adoc[en:Manual:Main Page]
