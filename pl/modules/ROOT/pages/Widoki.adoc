...
[cols=",,",]
|===
|xref:/Widoki.adoc[image:40px-Menu_view_algebra.svg.png[Menu view algebra.svg,width=40,height=40]]
xref:/Widoki.adoc[_Wykresy_] |xref:/Widoki.adoc[image:40px-Perspectives_geometry.svg.png[Perspectives
geometry.svg,width=40,height=40]] xref:/Widoki.adoc[_Geometria_]
|xref:/Widoki.adoc[image:40px-Menu_view_spreadsheet.svg.png[Menu view spreadsheet.svg,width=40,height=40]]
xref:/Widoki.adoc[_Arkusz_]

|xref:/Widoki.adoc[image:40px-Menu_view_cas.svg.png[Menu view cas.svg,width=40,height=40]]
xref:/Widoki.adoc[_CAS_] |xref:/Widoki.adoc[image:40px-Perspectives_algebra_3Dgraphics.svg.png[Perspectives
algebra 3Dgraphics.svg,width=40,height=40]] xref:/Widoki.adoc[_Grafika 3D_]
|xref:/Widoki.adoc[image:40px-Menu_view_probability.svg.png[Menu view probability.svg,width=40,height=40]]
xref:/Widoki.adoc[_Prawdopodobieństwo_]
|===
