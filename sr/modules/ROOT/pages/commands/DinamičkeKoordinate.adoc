...
DinamičkeKoordinate[ <Tačka A>, <Number X>, <Number Y> ]::
  ...
  _A_ nije xref:/Object_Properties.adoc[vidljiva] a pomeranje se vrši mišem.
...
image:Tool_Move.gif[Tool Move.gif,width=32,height=32] xref:/Move_Tool.adoc[Move
...
Sada kucajte u xref:/Liniju_unosa.adoc[Liniju
...
* Definišimo A=(1,2). Sada kucajte u xref:/Liniju_unosa.adoc[Liniju unosa]:
...
kucajte u xref:/Liniju_koda.adoc[Liniju
