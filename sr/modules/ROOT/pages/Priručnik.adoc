...
ili xref:/Naredbe.adoc[naredbe]. xref:/Uputstvo__Glavna_stranica.adoc[Tutorijali] vas mogu voditi kroz vaše prve konstrukcije.
...
* xref:/Категорија__Alati.adoc[List of tools]

=== Naredbe

* xref:/Naredbe.adoc[About commands]
* xref:/Категорија__Naredbe.adoc[List of commands]
...
* sačuvati u xref:/En__Reference__File_Format.adoc[GeoGebra formatu]
...
* postaviti konstrukciju na https://www.geogebra.org[GeoGebra]
